 ...
 * without mappings there even when VPOX_WITH_RAW_MODE is not defined.
 *
 ...
 */
#if defined(IN_RING0) \
  || (   !defined(VPOX_WITH_RAW_MODE) \
      && (   HC_ARCH_BITS != 32 \
          || !defined(VPOX_WITH_64_BITS_GUESTS) \
         ) \
     )
...
/** @def VPOX_STRICT_PGM_HANDLER_VIRTUAL
 * Enables some extra assertions for virtual handlers (mainly phys2virt related).
 */
#ifdef VPOX_STRICT
# define VPOX_STRICT_PGM_HANDLER_VIRTUAL
#endif

/** @def VPOX_WITH_NEW_LAZY_PAGE_ALLOC
 * Enables the experimental lazy page allocation code. */
#ifdef DOXYGEN_RUNNING
# define VPOX_WITH_NEW_LAZY_PAGE_ALLOC
#endif

/** @def VPOX_WITH_REAL_WRITE_MONITORED_PAGES
...
#define VPOX_WITH_REAL_WRITE_MONITORED_PAGES

/** @def VPOX_WITH_PGM_NEM_MODE
 * Enabled the NEM memory management mode in PGM.  See PGM::fNemMode for
 * details. */
#ifdef DOXYGEN_RUNNING
# define VPOX_WITH_PGM_NEM_MODE
#endif
 ...
 * @todo Move PGM_PTFLAGS_* and PGM_PDFLAGS_* to VPox/vmm/pgm.h. */
...
#if defined(VPOX_STRICT) && 0 /** @todo triggers in pgmRZDynMapGCPageV2Inlined */
...
#if defined(__GNUC__) && defined(VPOX_STRICT)
...
typedef struct PGMREGMMIO2RANGE
{
    ...
    RTR3PTR                             pvR3;
#if defined(VPOX_WITH_RAM_IN_KERNEL) && !defined(VPOX_WITH_LINEAR_HOST_PHYS_MEM)
...
#endif
    /** The chunk map. */
#if defined(VPOX_WITH_2X_4GB_ADDR_SPACE) || defined(VPOX_WITH_RAM_IN_KERNEL)
...
#if defined(VPOX_WITH_RAM_IN_KERNEL) || defined(DOXYGEN_RUNNING)
...
/** @} */
#endif /* VPOX_WITH_RAM_IN_KERNEL || DOXYGEN_RUNNING */
...
#elif defined(VPOX_STRICT) || 1 /* temporarily going strict here */
...
#ifdef VPOX_WITH_STATISTICS /** @todo move this chunk to the heap. */
    /** @name Statistics
     * @{ */
...
DECLCALLBACK(VPOXSTRICTRC) pgmR3PoolClearAllRendezvous(PVM pVM, PVMCPU pVCpu, void *fpvFlushRemTbl);
...
# if defined(VPOX_STRICT) && HC_ARCH_BITS == 64 && defined(IN_RING3)
