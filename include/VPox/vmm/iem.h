...
#ifndef VPOX_INCLUDED_vmm_iem_h
#define VPOX_INCLUDED_vmm_iem_h
...
VMM_INT_DECL(VPOXSTRICTRC)  IEMExecVmxVirtApicAccessMsr(PVMCPUCC pVCpu, uint32_t idMsr, uint64_t *pu64Val, bool fWrite);
...
VMM_INT_DECL(VPOXSTRICTRC)  IEMExecVmxVmexit(PVMCPUCC pVCpu, uint32_t uExitReason, uint64_t uExitQual);
