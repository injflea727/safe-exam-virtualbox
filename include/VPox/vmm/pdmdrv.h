...
#ifndef VPOX_INCLUDED_vmm_pdmdrv_h
#define VPOX_INCLUDED_vmm_pdmdrv_h
 ...
 *
 * This structure is used when registering a driver from VPoxInitDrivers() (in
...
/** Pointer to callbacks provided to the VPoxDriverRegister() call. */
typedef struct PDMDRVREGCB *PPDMDRVREGCB;
/** Pointer to const callbacks provided to the VPoxDriverRegister() call. */
typedef const struct PDMDRVREGCB *PCPDMDRVREGCB;

/**
 * Callbacks for VPoxDriverRegister().
 */
...
/**
 * The VPoxDriverRegister callback function.
 *
 ...
 */
typedef DECLCALLBACK(int) FNPDMVPOXDRIVERSREGISTER(PCPDMDRVREGCB pCallbacks, uint32_t u32Version);
...
#endif /* !VPOX_INCLUDED_vmm_pdmdrv_h */
