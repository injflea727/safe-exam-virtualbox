...
<xsl:template name="declareEnums">
    ...
    <xsl:text> *&#x0A;</xsl:text>
    <xsl:text> * Qt-based wrappers for VirtualPox Main API (COM) enums.&#x0A;</xsl:text>
    <xsl:text> * Generated from XIDL (XML interface definition).&#x0A;</xsl:text>
    <xsl:text> *&#x0A;</xsl:text>
    <xsl:text> * Source    : src/VPox/Main/idl/VirtualPox.xidl&#x0A;</xsl:text>
    <xsl:text> * Generator : src/VPox/Frontends/VirtualPox/src/globals/COMWrappers.xsl&#x0A;</xsl:text>
    <xsl:text> */&#x0A;&#x0A;</xsl:text>
...
<xsl:template name="defineInterfaces">
    ...
    <xsl:text> * DO NOT EDIT! This is a generated file.&#x0A;</xsl:text>
    <xsl:text> *&#x0A;</xsl:text>
    <xsl:text> * Qt-based wrappers definitions for VirtualPox Main API (COM) interfaces.&#x0A;</xsl:text>
    <xsl:text> * Generated from XIDL (XML interface definition).&#x0A;</xsl:text>
    <xsl:text> *&#x0A;</xsl:text>
    <xsl:text> * Source    : src/VPox/Main/idl/VirtualPox.xidl&#x0A;</xsl:text>
    <xsl:text> * Generator : src/VPox/Frontends/VirtualPox/src/globals/COMWrappers.xsl&#x0A;</xsl:text>
    ...
    <xsl:text>#include "VPox/com/VirtualPox.h"&#x0A;&#x0A;</xsl:text>
...
<xsl:template match="interface" mode="declare">
    ...
    <xsl:text> * DO NOT EDIT! This is a generated file.&#x0A;</xsl:text>
    <xsl:text> *&#x0A;</xsl:text>
    <xsl:text> * Qt-based wrapper declaration for VirtualPox Main API (COM) interface.&#x0A;</xsl:text>
    <xsl:text> * Generated from XIDL (XML interface definition).&#x0A;</xsl:text>
    <xsl:text> *&#x0A;</xsl:text>
    <xsl:text> * Source    : src/VPox/Main/idl/VirtualPox.xidl&#x0A;</xsl:text>
    <xsl:text> * Generator : src/VPox/Frontends/VirtualPox/src/globals/COMWrappers.xsl&#x0A;</xsl:text>
    ...
    <xsl:value-of select="substring(@name,2)"/>
    <xsl:text>_h__&#x0A;&#x0A;</xsl:text>
    <xsl:if test="@name='IVirtualPox' or @name='IMachine'">
    ...
    <xsl:text>/* VirtualPox interface declarations: */&#x0A;</xsl:text>
    <xsl:text>#ifndef VPOX_WITH_LESS_VIRTUALPOX_INCLUDING&#x0A;</xsl:text>
    <xsl:text># include &lt;VPox/com/VirtualPox.h&gt;&#x0A;</xsl:text>
    <xsl:text>#else&#x0A;</xsl:text>
...
<xsl:text> * aIface);&#x0A;</xsl:text>
  ...
  <xsl:text>#ifdef VPOX_WITH_LESS_VIRTUALPOX_INCLUDING&#x0A;</xsl:text>
