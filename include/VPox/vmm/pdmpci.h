...
#ifndef VPOX_INCLUDED_vmm_pdmpci_h
#define VPOX_INCLUDED_vmm_pdmpci_h
...
typedef struct PDMIPCIRAWUP
{
     ...
     * This apporach is taken, as calling VPox code from an asyncronous R0
...
#endif /* !VPOX_INCLUDED_vmm_pdmpci_h */
