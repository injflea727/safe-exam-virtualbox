...
BIOS_COPYRIGHT  equ     'Oracle VM VirtualPox BIOS'
...
if VPOX_BIOS_CPU ge 80386 ; (Impossible to do on 16-bit CPUs.)
...
if VPOX_BIOS_CPU lt 80386 ;; @todo fix loopy code below
                ;; get RTC seconds
                mov     al, 0
                out     CMOS_ADDR, al
