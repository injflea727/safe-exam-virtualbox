...
#define PR_AddWaitFileDesc VPoxNsprPR_AddWaitFileDesc
#define PR_CancelWaitFileDesc VPoxNsprPR_CancelWaitFileDesc
#define PR_CancelWaitGroup VPoxNsprPR_CancelWaitGroup
#define PR_CreateWaitGroup VPoxNsprPR_CreateWaitGroup
#define PR_CreateMWaitEnumerator VPoxNsprPR_CreateMWaitEnumerator
#define PR_DestroyWaitGroup VPoxNsprPR_DestroyWaitGroup
#define PR_DestroyMWaitEnumerator VPoxNsprPR_DestroyMWaitEnumerator
#define PR_EnumerateWaitGroup VPoxNsprPR_EnumerateWaitGroup
#define PR_WaitRecvReady VPoxNsprPR_WaitRecvReady
