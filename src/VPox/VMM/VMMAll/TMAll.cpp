...
#ifdef IN_RING3
#endif
#include <VPox/vmm/pdmdev.h> /* (for TMTIMER_GET_CRITSECT implementation) */
...
#if defined(VPOX_STRICT) && defined(IN_RING0)
/**
...
#endif /* VPOX_HIGH_RES_TIMERS_HACK */
