...
# $Id: setup.sh $
## @file
# VirtualPox Validation Kit - TestBoxScript Service Setup on Unixy platforms.
#
...
TESTBOXSCRIPT_DEFAULT_USER="vpox"
...
TESTBOXSCRIPT_DEFAULT_BUILDS_NAME="vpoxstor.de.oracle.com"
