...
#ifndef VPOX_INCLUDED_com_ptr_h
#define VPOX_INCLUDED_com_ptr_h
...
public:
     ...
     *
     *  @note Win32: when VPOX_COM_OUTOFPROC_MODULE is defined, the created
    ...
    HRESULT createObject()
    {
        HRESULT hrc;
#ifndef VPOX_WITH_XPCOM
# ifdef VPOX_COM_OUTOFPROC_MODULE
