...
/** @file
 * VPox Qt GUI - UIPopupCenter class implementation.
 */
...
void UIPopupCenter::cannotAttachUSBDevice(QWidget *pParent, const CVirtualPoxErrorInfo &comErrorInfo,
...
void UIPopupCenter::cannotDetachUSBDevice(QWidget *pParent, const CVirtualPoxErrorInfo &comErrorInfo,
                                          const QString &strDevice, const QString &strMachineName)
{
    alertWithDetails(pParent, "cannotDetachUSBDevice",
                     QApplication::translate("UIMessageCenter",
...
void UIPopupCenter::remindAboutGuestAdditionsAreNotActive(QWidget *pParent)
{
    alert(pParent, "remindAboutGuestAdditionsAreNotActive",
          QApplication::translate("UIMessageCenter", "<p>The VirtualPox Guest Additions do not appear to be available on this virtual machine, "
...
void UIPopupCenter::cannotOpenMedium(QWidget *pParent, const CVirtualPox &comVPox, UIMediumDeviceType /* enmType */, const QString &strLocation)
{
