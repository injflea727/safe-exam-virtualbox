...
Message::Message(uint32_t uMsg, uint32_t cParms, VPOXHGCMSVCPARM aParms[])
    : m_uMsg(0)
    , m_cParms(0)
    , m_paParms(NULL)
{
 ...
 */
int Message::GetData(uint32_t uMsg, uint32_t cParms, VPOXHGCMSVCPARM aParms[]) const
{
    if (m_uMsg != uMsg)
    {
...
int Message::GetParmU32(uint32_t uParm, uint32_t *pu32Info) const
{
    ...
    AssertReturn(m_paParms[uParm].type == VPOX_HGCM_SVC_PARM_32BIT, VERR_INVALID_PARAMETER);
...
int Message::GetParmU64(uint32_t uParm, uint64_t *pu64Info) const
{
    ...
    AssertReturn(uParm < m_cParms, VERR_INVALID_PARAMETER);
    AssertReturn(m_paParms[uParm].type == VPOX_HGCM_SVC_PARM_64BIT, VERR_INVALID_PARAMETER);
...
int Message::GetParmPtr(uint32_t uParm, void **ppvAddr, uint32_t *pcbSize) const
{
    ...
    AssertReturn(uParm < m_cParms, VERR_INVALID_PARAMETER);
    AssertReturn(m_paParms[uParm].type == VPOX_HGCM_SVC_PARM_PTR, VERR_INVALID_PARAMETER);
 ...
 */
/* static */
int Message::CopyParms(PVPOXHGCMSVCPARM paParmsDst, uint32_t cParmsDst,
 ...
 */
int Message::initData(uint32_t uMsg, uint32_t cParms, VPOXHGCMSVCPARM aParms[])
{
    ...
    if (cParms)
    {
        m_paParms = (VPOXHGCMSVCPARM*)RTMemAllocZ(sizeof(VPOXHGCMSVCPARM) * m_cParms);
        if (m_paParms)
        {
