...
<!--
    ...
    websrv-php.xsl:
        XSLT stylesheet that generates vpoxServiceWrappers.php from
        VirtualPox.xidl. This PHP file represents our
  ...
  <xsl:choose>
    ...
    <xsl:when test="$type='$unknown'">
      <xsl:call-template name="emitObject">
        <xsl:with-param name="type">VPox_ManagedObject</xsl:with-param>
        <xsl:with-param name="value" select="$value" />
        <xsl:with-param name="safearray" select="$safearray"/>
      </xsl:call-template>
   </xsl:when>
...
<xsl:template name="interface">
   ...
   <xsl:text>
/**
 * Generated VPoxWebService Interface Wrapper
 */
</xsl:text>
   <xsl:choose>
      <xsl:when test="($extends = '$unknown') or ($extends = '$errorinfo')">
         <xsl:value-of select="concat('class ', $ifname, ' extends VPox_ManagedObject&#10;{&#10;')" />
      </xsl:when>
...
<xsl:template name="collection">
   ...
   <xsl:text>
/**
 * Generated VPoxWebService Managed Object Collection
 */</xsl:text>
class <xsl:value-of select="$ifname"/>Collection extends VPox_ManagedObjectCollection
{
...
<xsl:template name="interfacestruct">
   ...
   <xsl:text>
/**
 * Generated VPoxWebService Struct
 */</xsl:text>
class <xsl:value-of select="$ifname"/> extends VPox_Struct
{
...
<xsl:template name="structcollection">
   ...
   <xsl:text>
/**
 * Generated VPoxWebService Struct Collection
 */</xsl:text>
class <xsl:value-of select="$ifname"/>Collection extends VPox_StructCollection
{
    protected $_interfaceName = "<xsl:value-of select="$ifname"/>";
}
</xsl:template>
...
<xsl:template name="enum">
  <xsl:text>
/**
 * Generated VPoxWebService ENUM
 */</xsl:text>
class <xsl:value-of select="@name"/> extends VPox_Enum
{
...
<xsl:template name="enumcollection">
   ...
   <xsl:text>
/**
 * Generated VPoxWebService Enum Collection
 */</xsl:text>
class <xsl:value-of select="$ifname"/>Collection extends VPox_EnumCollection
{
    protected $_interfaceName = "<xsl:value-of select="$ifname"/>";
}
</xsl:template>
 ...
 *
 * This file is autogenerated from VirtualPox.xidl, DO NOT EDIT!
 */

class VPox_ManagedObject
{
    ...
    {
        if (is_subclass_of($class, 'VPox_ManagedObject'))
        {
            return new $class($this->connection, $this->handle);
        }
        throw new Exception('Cannot cast VPox_ManagedObject to non-child class VPox_ManagedObject');
    }
...
abstract class VPox_Collection implements ArrayAccess, Iterator, Countable
{
...
class VPox_ManagedObjectCollection extends VPox_Collection
{
    protected $_interfaceName = 'VPox_ManagedObject';

    // Result is undefined if this is called AFTER any call to VPox_Collection::offsetSet or VPox_Collection::offsetUnset
    public function setInterfaceName($interface)
    {
        if (!is_subclass_of($interface, 'VPox_ManagedObject'))
        {
            throw new Exception('Cannot set collection interface to non-child class of VPox_ManagedObject');
        }
...
abstract class VPox_StructCollection extends VPox_Collection
{
...
abstract class VPox_EnumCollection extends VPox_Collection
{
}
...
<xsl:text>
/**
 * VirtualPox COM result codes
 */
class VirtualPox_COM_result_codes
{
</xsl:text>
