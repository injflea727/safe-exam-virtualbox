...
#define PR_SetError VPoxNsprPR_SetError
#define PR_SetErrorText VPoxNsprPR_SetErrorText
#define PR_GetError VPoxNsprPR_GetError
#define PR_GetOSError VPoxNsprPR_GetOSError
#define PR_GetErrorTextLength VPoxNsprPR_GetErrorTextLength
#define PR_GetErrorText VPoxNsprPR_GetErrorText
#define PR_ErrorToString VPoxNsprPR_ErrorToString
#define PR_ErrorToName VPoxNsprPR_ErrorToName
#define PR_ErrorLanguages VPoxNsprPR_ErrorLanguages
#define PR_ErrorInstallTable VPoxNsprPR_ErrorInstallTable
#define PR_ErrorInstallCallback VPoxNsprPR_ErrorInstallCallback
