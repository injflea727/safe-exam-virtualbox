...
#define PR_snprintf VPoxNsprPR_snprintf
#define PR_vsnprintf VPoxNsprPR_vsnprintf
#define PR_smprintf VPoxNsprPR_smprintf
#define PR_smprintf_free VPoxNsprPR_smprintf_free
#define PR_sprintf_append VPoxNsprPR_sprintf_append
#define PR_sxprintf VPoxNsprPR_sxprintf
#define PR_fprintf VPoxNsprPR_fprintf
#define PR_vsmprintf VPoxNsprPR_vsmprintf
#define PR_vsprintf_append VPoxNsprPR_vsprintf_append
#define PR_vsxprintf VPoxNsprPR_vsxprintf
#define PR_vfprintf VPoxNsprPR_vfprintf
#define PR_sscanf VPoxNsprPR_sscanf
