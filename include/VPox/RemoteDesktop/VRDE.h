/** @file
 * VPox Remote Desktop Extension (VRDE) - Public APIs.
 */
...
#ifndef VPOX_INCLUDED_RemoteDesktop_VRDE_h
#define VPOX_INCLUDED_RemoteDesktop_VRDE_h
 ...
 * VirtualPox Remote Desktop Extension (VRDE) interface that lets to use
 ...
 * This is an opaque pointer for VirtualPox.
...
#define VRDE_USB_XFER_ERR   (12) /* VPox protocol error. */
...
typedef struct _VRDECALLBACKS_1
{
     ...
     * Currently not used because VirtualPox makes sure that the framebuffer is available
...
#endif /* !VPOX_INCLUDED_RemoteDesktop_VRDE_h */
