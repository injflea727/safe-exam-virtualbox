...
public:
     ...
     */
    static UnattendedInstaller *createInstance(VPOXOSTYPE enmOsType, const Utf8Str &strGuestOsType,
    ...
    /**
     * Whether the VPox guest additions ISO is needed or not.
     *
    ...
    /**
     * Whether the VPox validation kit ISO is needed or not.
     *
     * The default implementation always returns false when a VISO is used, see
     * UnattendedInstaller::addFilesToAuxVisoVectors.
     */
...
protected:
     ...
     * content to '/vpoxadditions', and validation kit ISO to '/vpoxvalidationkit'.
     *
     * @returns COM status code.
...
public:
    UnattendedLinuxInstaller(Unattended *pParent,
                             const char *pszMainScriptTemplateName, const char *pszPostScriptTemplateName,
                             const char *pszMainScriptFilename,     const char *pszPostScriptFilename = "vpoxpostinstall.sh")
        : UnattendedInstaller(pParent,
