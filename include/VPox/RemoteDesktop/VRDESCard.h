/** @file
 * VPox Remote Desktop Extension (VRDE) - SmartCard interface.
 */
...
#ifndef VPOX_INCLUDED_RemoteDesktop_VRDESCard_h
#define VPOX_INCLUDED_RemoteDesktop_VRDESCard_h
...
#endif /* !VPOX_INCLUDED_RemoteDesktop_VRDESCard_h */
