...
#ifndef VPOX_INCLUDED_SRC_Storage_VDInternal_h
#define VPOX_INCLUDED_SRC_Storage_VDInternal_h
 ...
 */
#if !defined(VPOX_HDD_NO_DYNAMIC_BACKENDS) && !defined(RT_ARCH_X86) && !defined(RT_ARCH_AMD64)
# define VPOX_HDD_NO_DYNAMIC_BACKENDS
#endif
...
#endif /* !VPOX_INCLUDED_SRC_Storage_VDInternal_h */
