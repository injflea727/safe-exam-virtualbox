/* $Id: VPoxGuestR3LibVideo.cpp $ */
/** @file
 * VPoxGuestR3Lib - Ring-3 Support Library for VirtualPox guest additions, Video.
 */
...
#include <VPox/log.h>
#include <VPox/HostServices/GuestPropertySvc.h>  /* For Save and RetrieveVideoMode */
...
#define VIDEO_PROP_PREFIX "/VirtualPox/GuestAdd/Vbgl/Video/"
                                              ...
                                              bool fAck)
{
    ...
    /* NEEDS TESTING: test below with current Additions on VPox 4.1 or older. */
                                                   ...
                                                   bool fAck)
{
    ...
    AssertReturn(cDisplaysIn > 0 && cDisplaysIn <= 64 /* VPOX_VIDEO_MAX_SCREENS */, VERR_INVALID_PARAMETER);
...
{
#if defined(VPOX_WITH_GUEST_PROPS)
    int rc;
