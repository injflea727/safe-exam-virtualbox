/** @file
 * DIS - The VirtualPox Disassembler.
 */
...
#ifndef VPOX_INCLUDED_dis_h
#define VPOX_INCLUDED_dis_h
...
/** @defgroup grp_dis   VPox Disassembler
 * @{ */
 ...
 *
 * @returns VPox status code, bytes in DISSTATE::abInstr and byte count in
