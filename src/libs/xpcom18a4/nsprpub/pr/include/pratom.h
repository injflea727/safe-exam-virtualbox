...
#define PR_AtomicDecrement VPoxNsprPR_AtomicDecrement
#define PR_AtomicIncrement VPoxNsprPR_AtomicIncrement
#define PR_AtomicAdd VPoxNsprPR_AtomicAdd
#define PR_AtomicSet VPoxNsprPR_AtomicSet
#define PR_CreateStack VPoxNsprPR_CreateStack
#define PR_StackPush VPoxNsprPR_StackPush
#define PR_StackPop VPoxNsprPR_StackPop
#define PR_DestroyStack VPoxNsprPR_DestroyStack
