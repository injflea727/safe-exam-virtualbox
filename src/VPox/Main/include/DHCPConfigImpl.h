/* $Id: DHCPConfigImpl.h $ */
/** @file
 * VirtualPox Main - IDHCPConfig, IDHCPConfigGlobal, IDHCPConfigGroup, IDHCPConfigIndividual header.
 */
...
protected:
    ...
    /** The DHCP server parent (weak).   */
    VirtualPox * const          m_pVirtualPox;
private:
    /** For setError and such. */
    VirtualPoxBase * const      m_pHack;

protected:
    /** @name Constructors and destructors.
     * @{ */
    DHCPConfig(DHCPConfigScope_T a_enmScope, VirtualPoxBase *a_pHack)
        : m_enmScope(a_enmScope), m_secMinLeaseTime(0), m_secDefaultLeaseTime(0), m_secMaxLeaseTime(0), m_OptionMap()
        , m_pParent(NULL), m_pVirtualPox(NULL), m_pHack(a_pHack)
    {}
    DHCPConfig();
    virtual ~DHCPConfig()
    {}
    HRESULT i_initWithDefaults(VirtualPox *a_pVirtualPox, DHCPServer *a_pParent);
    HRESULT i_initWithSettings(VirtualPox *a_pVirtualPox, DHCPServer *a_pParent, const settings::DHCPConfig &rConfig);
    /** @} */
...
public:
    ...
    HRESULT initWithDefaults(VirtualPox *a_pVirtualPox, DHCPServer *a_pParent);
    HRESULT initWithSettings(VirtualPox *a_pVirtualPox, DHCPServer *a_pParent, const settings::DHCPConfig &rConfig);
    void    uninit();
    /** @} */
...
public:
    ...
    HRESULT initWithDefaults(VirtualPox *a_pVirtualPox, DHCPServer *a_pParent, const com::Utf8Str &a_rName);
    HRESULT initWithSettings(VirtualPox *a_pVirtualPox, DHCPServer *a_pParent, const settings::DHCPGroupConfig &a_rSrc);
    void    uninit();
    /** @} */
...
public:
    ...
    HRESULT initWithMachineIdAndSlot(VirtualPox *a_pVirtualPox, DHCPServer *a_pParent, com::Guid const &a_idMachine,
                                     ULONG a_uSlot, uint32_t a_uMACAddressVersion);
    HRESULT initWithMACAddress(VirtualPox *a_pVirtualPox, DHCPServer *a_pParent, PCRTMAC a_pMACAddress);
    HRESULT initWithSettingsAndMachineIdAndSlot(VirtualPox *a_pVirtualPox, DHCPServer *a_pParent,
                                                const settings::DHCPIndividualConfig &rData, com::Guid const &a_idMachine,
                                                ULONG a_uSlot, uint32_t a_uMACAddressVersion);
    HRESULT initWithSettingsAndMACAddress(VirtualPox *a_pVirtualPox, DHCPServer *a_pParent,
