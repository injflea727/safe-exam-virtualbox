...
/** @file
 * VPox Qt GUI - UINetworkReply stuff implementation.
 */
...
#ifndef VPOX_GUI_IN_TST_SSL_CERT_DOWNLOADS
# include "UICommon.h"
# include "VPoxUtils.h"
...
#endif /* !VPOX_GUI_IN_TST_SSL_CERT_DOWNLOADS */
...
#ifdef VPOX_GUI_IN_TST_SSL_CERT_DOWNLOADS
public:
...
/* static */
const QString UINetworkReplyPrivateThread::s_strCertificateFileName = QString("vpox-ssl-cacertificate.crt");
...
int UINetworkReplyPrivateThread::applyProxyRules()
{
    ...
    const CSystemProperties comProperties = uiCommon().virtualPox().GetSystemProperties();
...
#else /* VPOX_GUI_IN_TST_SSL_CERT_DOWNLOADS */
                                                              ...
                                                              PRTERRINFOSTATIC pStaticErrInfo)
{
    ...
    /*
     * Try get the roots.zip from symantec (or virtualpox.org) first.
     */
