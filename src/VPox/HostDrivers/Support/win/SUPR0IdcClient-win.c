...
/** @file
 * VirtualPox Support Driver - IDC Client Lib, Windows Specific Code.
 */
...
*********************************************************************************************************************************/
/** NT Device name. */
#define DEVICE_NAME_NT   L"\\Device\\VPoxDrv"
...
int VPOXCALL supR0IdcNativeCall(PSUPDRVIDCHANDLE pHandle, uint32_t uReq, PSUPDRVIDCREQHDR pReq)
{
