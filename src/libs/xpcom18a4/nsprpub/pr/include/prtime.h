...
#define PR_Now VPoxNsprPR_Now
#define PR_ExplodeTime VPoxNsprPR_ExplodeTime
#define PR_ImplodeTime VPoxNsprPR_ImplodeTime
#define PR_NormalizeTime VPoxNsprPR_NormalizeTime
#define PR_LocalTimeParameters VPoxNsprPR_LocalTimeParameters
#define PR_GMTParameters VPoxNsprPR_GMTParameters
#define PR_USPacificTimeParameters VPoxNsprPR_USPacificTimeParameters
#define PR_ParseTimeString VPoxNsprPR_ParseTimeString
#define PR_FormatTime VPoxNsprPR_FormatTime
#define PR_FormatTimeUSEnglish VPoxNsprPR_FormatTimeUSEnglish
