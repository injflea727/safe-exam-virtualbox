/* $Id: VPoxUtils-darwin.h $ */
/** @file
 * VPox Qt GUI - Declarations of utility classes and functions for handling Darwin specific tasks.
 */
...
#ifndef FEQT_INCLUDED_SRC_platform_darwin_VPoxUtils_darwin_h
#define FEQT_INCLUDED_SRC_platform_darwin_VPoxUtils_darwin_h
...
#endif /* !FEQT_INCLUDED_SRC_platform_darwin_VPoxUtils_darwin_h */
