 ...
 * 'VPoxManage debugvm' command.
 * Debug logging still uses the common Log* macros from VPox.
...
#define VPOX_DSOUND_MAX_EVENTS 3
 ...
 *
 * @return  VPox status code. VERR_NOT_AVAILABLE if unable to determine or the
                                                       ...
                                                       void *pvBuf, uint32_t cbBuf, uint32_t *pcbRead)
{
    ...
    *pcbRead = cbRead;
    ...
    {
        RTFILE hFile;
        int rc2 = RTFileOpen(&hFile, VPOX_AUDIO_DEBUG_DUMP_PCM_DATA_PATH "dsoundCapture.pcm",
...
# ifdef VPOX_WITH_AUDIO_CALLBACKS
