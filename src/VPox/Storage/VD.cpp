...
/**
 * VPox parent read descriptor, used internally for compaction.
 */
 ...
 *
 * @returns VPox status code, only valid if pIoCtxRc is not NULL, treat as void
 *          function otherwise.
 ...
 * for it to complete.
 *
 * @returns VPox status code of the completed request.
 ...
 * @param   pVDIfsOperation Pointer to the per-operation VD interface list.
 */
VPOXDDU_DECL(int) VDCompact(PVDISK pDisk, unsigned nImage,
                            PVDINTERFACE pVDIfsOperation)
{
    int rc = VINF_SUCCESS;
    int rc2;
 ...
 */
VPOXDDU_DECL(int) VDRead(PVDISK pDisk, uint64_t uOffset, void *pvBuf,
                         size_t cbRead)
{
    int rc = VINF_SUCCESS;
    int rc2;
 ...
 * @param   cbWrite         Number of bytes to write.
 */
VPOXDDU_DECL(int) VDWrite(PVDISK pDisk, uint64_t uOffset, const void *pvBuf,
                          size_t cbWrite)
{
    int rc = VINF_SUCCESS;
    int rc2;
 ...
 */
VPOXDDU_DECL(int) VDGetPCHSGeometry(PVDISK pDisk, unsigned nImage,
 ...
 */
VPOXDDU_DECL(int) VDSetPCHSGeometry(PVDISK pDisk, unsigned nImage,
                                    PCVDGEOMETRY pPCHSGeometry)
{
    int rc = VINF_SUCCESS;
    int rc2;
 ...
 */
VPOXDDU_DECL(int) VDGetLCHSGeometry(PVDISK pDisk, unsigned nImage,
 ...
 */
VPOXDDU_DECL(int) VDSetLCHSGeometry(PVDISK pDisk, unsigned nImage,
                                    PCVDGEOMETRY pLCHSGeometry)
{
    int rc = VINF_SUCCESS;
    int rc2;
 ...
 */
VPOXDDU_DECL(int) VDGetVersion(PVDISK pDisk, unsigned nImage,
                               unsigned *puVersion)
{
    int rc = VINF_SUCCESS;
    int rc2;
 ...
 */
VPOXDDU_DECL(int) VDBackendInfoSingle(PVDISK pDisk, unsigned nImage,
 ...
 */
VPOXDDU_DECL(int) VDGetImageFlags(PVDISK pDisk, unsigned nImage,
 ...
 */
VPOXDDU_DECL(int) VDGetOpenFlags(PVDISK pDisk, unsigned nImage,
 ...
 * @param   uOpenFlags      Image file open mode, see VD_OPEN_FLAGS_* constants.
 */
VPOXDDU_DECL(int) VDSetOpenFlags(PVDISK pDisk, unsigned nImage,
                                 unsigned uOpenFlags)
{
    int rc;
    int rc2;
 ...
 */
VPOXDDU_DECL(int) VDGetFilename(PVDISK pDisk, unsigned nImage,
 ...
 */
VPOXDDU_DECL(int) VDGetComment(PVDISK pDisk, unsigned nImage,
 ...
 */
VPOXDDU_DECL(int) VDSetComment(PVDISK pDisk, unsigned nImage,
 ...
 */
VPOXDDU_DECL(int) VDGetParentUuid(PVDISK pDisk, unsigned nImage,
                                  PRTUUID pUuid)
{
    int rc = VINF_SUCCESS;
    int rc2;
 ...
 */
VPOXDDU_DECL(int) VDSetParentUuid(PVDISK pDisk, unsigned nImage,
                                  PCRTUUID pUuid)
{
    int rc;
    int rc2;
...
VPOXDDU_DECL(int) VDAsyncRead(PVDISK pDisk, uint64_t uOffset, size_t cbRead,
                              PCRTSGBUF pcSgBuf,
                              PFNVDASYNCTRANSFERCOMPLETE pfnComplete,
                              void *pvUser1, void *pvUser2)
{
...
VPOXDDU_DECL(int) VDAsyncWrite(PVDISK pDisk, uint64_t uOffset, size_t cbWrite,
                               PCRTSGBUF pcSgBuf,
                               PFNVDASYNCTRANSFERCOMPLETE pfnComplete,
                               void *pvUser1, void *pvUser2)
{
...
VPOXDDU_DECL(int) VDAsyncFlush(PVDISK pDisk, PFNVDASYNCTRANSFERCOMPLETE pfnComplete,
                               void *pvUser1, void *pvUser2)
{
    int rc;
    int rc2;
