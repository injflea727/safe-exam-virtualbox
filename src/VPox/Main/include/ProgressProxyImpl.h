...
/** @file
 * IProgress implementation for Machine::LaunchVMProcess in VPoxSVC.
 */
...
{
public:
    VIRTUALPOXBASE_ADD_ERRORINFO_SUPPORT(ProgressProxy, IProgress)
    ...
    BEGIN_COM_MAP(ProgressProxy)
        ...
        VPOX_TWEAK_INTERFACE_ENTRY(IProgress)
    END_COM_MAP()
    ...
    STDMETHOD(COMGETTER(ErrorInfo))(IVirtualPoxErrorInfo **aErrorInfo);
