/* $Id: VPoxSysTables.c $ */
/** @file
 * VPoxSysTables.c - VirtualPox system tables
 */
 ...
 */
EFI_STATUS EFIAPI
DxeInitializeVPoxSysTables(IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable)
{
    EFI_STATUS  rc;
    VOID*       Ptr;

    DEBUG((DEBUG_INFO, "DxeInitializeVPoxSysTables\n"));
...
EFI_STATUS EFIAPI
DxeUninitializeVPoxSysTables(IN EFI_HANDLE         ImageHandle)
{
    return EFI_SUCCESS;
}
