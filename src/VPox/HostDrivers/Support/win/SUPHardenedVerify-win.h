...
/** @file
 * VirtualPox Support Library/Driver - Hardened Verification, Windows.
 */
...
#ifndef VPOX_INCLUDED_SRC_Support_win_SUPHardenedVerify_win_h
#define VPOX_INCLUDED_SRC_Support_win_SUPHardenedVerify_win_h
 ...
 * either result in host BSOD or VPox application malfunction.  Here the current
 * shit list:
 ...
 * @{ */
/** The signing certificate must be the same as the one the VirtualPox build
 * was signed with. */
...
#endif /* !VPOX_INCLUDED_SRC_Support_win_SUPHardenedVerify_win_h */
