...
#ifndef VPOX_INCLUDED_HostServices_VPoxClipboardExt_h
#define VPOX_INCLUDED_HostServices_VPoxClipboardExt_h
...
#define VPOX_CLIPBOARD_EXT_FN_SET_CALLBACK         (0)
#define VPOX_CLIPBOARD_EXT_FN_FORMAT_ANNOUNCE      (1)
#define VPOX_CLIPBOARD_EXT_FN_DATA_READ            (2)
#define VPOX_CLIPBOARD_EXT_FN_DATA_WRITE           (3)
/** Registers a new clipboard area.
 *  Uses the SHCLEXTAREAPARMS struct. */
#define VPOX_CLIPBOARD_EXT_FN_AREA_REGISTER        (4)
/** Unregisters an existing clipboard area.
 *  Uses the SHCLEXTAREAPARMS struct. */
#define VPOX_CLIPBOARD_EXT_FN_AREA_UNREGISTER      (5)
/** Attaches to an existing clipboard area.
 *  Uses the SHCLEXTAREAPARMS struct. */
#define VPOX_CLIPBOARD_EXT_FN_AREA_ATTACH          (6)
/** Detaches from an existing clipboard area.
 *  Uses the SHCLEXTAREAPARMS struct. */
#define VPOX_CLIPBOARD_EXT_FN_AREA_DETACH          (7)
...
#endif /* !VPOX_INCLUDED_HostServices_VPoxClipboardExt_h */
