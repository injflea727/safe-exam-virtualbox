...
/** @file
 * VPoxGuest - Combine a bunch of OS agnostic sources into one compile unit.
 */
...
//#undef LOG_GROUP
#include "VPoxGuestR0LibGenericRequest.c"
#undef LOG_GROUP
#include "VPoxGuestR0LibHGCMInternal.c"
//#undef LOG_GROUP
#include "VPoxGuestR0LibInit.c"
//#undef LOG_GROUP
#include "VPoxGuestR0LibPhysHeap.c"
#undef LOG_GROUP
#include "VPoxGuestR0LibVMMDev.c"
#undef LOG_GROUP
...
#undef LOG_GROUP
#include "VPox/log-vpox.c"
#undef LOG_GROUP
#include "VPox/logbackdoor.c"
