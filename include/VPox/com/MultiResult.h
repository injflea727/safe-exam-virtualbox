...
#ifndef VPOX_INCLUDED_com_MultiResult_h
#define VPOX_INCLUDED_com_MultiResult_h
 ...
 * switch to turn on multi-error mode for VirtualPoxBase::setError() and
 * VirtualPoxBase::setWarning() calls.
 *
 ...
 * object in the IVirtualPoxErrorInfo::next attribute of the new error
 * object being set.
 *
 ...
 * IVirtualPoxErrorInfo::next attribute of the first error points to, and so
 * on, up to the first error or warning occurred which is the last in the
 * chain. See IVirtualPoxErrorInfo documentation for more info.
 *
...
#endif /* !VPOX_INCLUDED_com_MultiResult_h */
