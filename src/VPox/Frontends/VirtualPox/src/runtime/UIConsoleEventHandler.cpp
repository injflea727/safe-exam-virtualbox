...
/** @file
 * VPox Qt GUI - UIConsoleEventHandler class implementation.
 */
...
signals:
    ...
    void sigUSBDeviceStateChange(CUSBDevice device, bool fAttached, CVirtualPoxErrorInfo error);
...
void UIConsoleEventHandlerProxy::prepareListener()
{
    ...
    eventTypes
        << KVPoxEventType_OnMousePointerShapeChanged
        << KVPoxEventType_OnMouseCapabilityChanged
        << KVPoxEventType_OnCursorPositionChanged
        << KVPoxEventType_OnKeyboardLedsChanged
        << KVPoxEventType_OnStateChanged
        << KVPoxEventType_OnAdditionsStateChanged
        << KVPoxEventType_OnNetworkAdapterChanged
        << KVPoxEventType_OnStorageDeviceChanged
        << KVPoxEventType_OnMediumChanged
        << KVPoxEventType_OnVRDEServerChanged
        << KVPoxEventType_OnVRDEServerInfoChanged
        << KVPoxEventType_OnRecordingChanged
        << KVPoxEventType_OnUSBControllerChanged
        << KVPoxEventType_OnUSBDeviceStateChanged
        << KVPoxEventType_OnSharedFolderChanged
        << KVPoxEventType_OnCPUExecutionCapChanged
        << KVPoxEventType_OnGuestMonitorChanged
        << KVPoxEventType_OnRuntimeError
        << KVPoxEventType_OnCanShowWindow
        << KVPoxEventType_OnShowWindow
        << KVPoxEventType_OnAudioAdapterChanged
        << KVPoxEventType_OnClipboardModeChanged
        << KVPoxEventType_OnDnDModeChanged;
