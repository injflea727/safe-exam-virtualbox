...
#define XPT_NewHeader VPoxNsxpXPT_NewHeader
#define XPT_NewStringZ VPoxNsxpXPT_NewStringZ
#define XPT_NewAnnotation VPoxNsxpXPT_NewAnnotation
#define XPT_SizeOfHeaderBlock VPoxNsxpXPT_SizeOfHeaderBlock
#define XPT_NewInterfaceDescriptor VPoxNsxpXPT_NewInterfaceDescriptor
#define XPT_FillInterfaceDirectoryEntry VPoxNsxpXPT_FillInterfaceDirectoryEntry
#define XPT_FillMethodDescriptor VPoxNsxpXPT_FillMethodDescriptor
#define XPT_FreeHeader VPoxNsxpXPT_FreeHeader
#define XPT_ParseVersionString VPoxNsxpXPT_ParseVersionString
#define XPT_DestroyInterfaceDirectoryEntry VPoxNsxpXPT_DestroyInterfaceDirectoryEntry
#define XPT_FillParamDescriptor VPoxNsxpXPT_FillParamDescriptor
#define XPT_FreeInterfaceDescriptor VPoxNsxpXPT_FreeInterfaceDescriptor
#define XPT_InterfaceDescriptorAddConsts VPoxNsxpXPT_InterfaceDescriptorAddConsts
#define XPT_InterfaceDescriptorAddMethods VPoxNsxpXPT_InterfaceDescriptorAddMethods
#define XPT_InterfaceDescriptorAddTypes VPoxNsxpXPT_InterfaceDescriptorAddTypes
#define XPT_GetInterfaceIndexByName VPoxNsxpXPT_GetInterfaceIndexByName
#define XPT_NewString VPoxNsxpXPT_NewString
#define XPT_SizeOfHeader VPoxNsxpXPT_SizeOfHeader
