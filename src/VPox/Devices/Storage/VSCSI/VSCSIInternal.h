...
#ifndef VPOX_INCLUDED_SRC_Storage_VSCSI_VSCSIInternal_h
#define VPOX_INCLUDED_SRC_Storage_VSCSI_VSCSIInternal_h
...
#endif /* !VPOX_INCLUDED_SRC_Storage_VSCSI_VSCSIInternal_h */
