/* $Id: vpoxweb.h $ */
/** @file
 * vpoxweb.h - header file for "real" web server code.
 */
...
#ifndef MAIN_INCLUDED_SRC_webservice_vpoxweb_h
#define MAIN_INCLUDED_SRC_webservice_vpoxweb_h
...
class WebServiceSession
{
    ...
    private:
        ...
        WebServiceSessionPrivate    *_pp;               // opaque data struct (defined in vpoxweb.cpp)
        bool                        _fDestructing;
...
#endif /* !MAIN_INCLUDED_SRC_webservice_vpoxweb_h */
