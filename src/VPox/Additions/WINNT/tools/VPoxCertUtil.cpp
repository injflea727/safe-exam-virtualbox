/* $Id: VPoxCertUtil.cpp $ */
/** @file
 * VPoxCertUtil - VPox Certificate Utility - Windows Only.
 */
...
static RTEXITCODE cmdRemoveTrustedPublisher(int argc, char **argv)
{
    ...
    while ((rc = RTGetOpt(&GetState, &ValueUnion)))
    {
        ...
        {
            case 'h':
                RTPrintf("Usage: VPoxCertUtil remove-trusted-publisher [--root <root-cert>] <trusted-cert>\n");
                break;
...
static RTEXITCODE cmdAddTrustedPublisher(int argc, char **argv)
{
    ...
    while ((rc = RTGetOpt(&GetState, &ValueUnion)))
    {
        ...
        {
            case 'h':
                RTPrintf("Usage: VPoxCertUtil add-trusted-publisher [--root <root-cert>] <trusted-cert>\n");
                break;
