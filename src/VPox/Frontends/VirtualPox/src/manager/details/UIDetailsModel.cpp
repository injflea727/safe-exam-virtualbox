...
/** @file
 * VPox Qt GUI - UIDetailsModel class implementation.
 */
...
void UIDetailsModel::loadDetailsOptions(DetailsElementType enmType /* = DetailsElementType_Invalid */)
{
    ...
    if (enmType == DetailsElementType_General || enmType == DetailsElementType_Invalid)
    {
        ...
        foreach (const QString &strOption, gEDataManager->vpoxManagerDetailsPaneElementOptions(DetailsElementType_General))
        {
    ...
    if (enmType == DetailsElementType_System || enmType == DetailsElementType_Invalid)
    {
        ...
        foreach (const QString &strOption, gEDataManager->vpoxManagerDetailsPaneElementOptions(DetailsElementType_System))
        {
    ...
    if (enmType == DetailsElementType_Display || enmType == DetailsElementType_Invalid)
    {
        ...
        foreach (const QString &strOption, gEDataManager->vpoxManagerDetailsPaneElementOptions(DetailsElementType_Display))
        {
    ...
    if (enmType == DetailsElementType_Storage || enmType == DetailsElementType_Invalid)
    {
        ...
        foreach (const QString &strOption, gEDataManager->vpoxManagerDetailsPaneElementOptions(DetailsElementType_Storage))
        {
    ...
    if (enmType == DetailsElementType_Audio || enmType == DetailsElementType_Invalid)
    {
        ...
        foreach (const QString &strOption, gEDataManager->vpoxManagerDetailsPaneElementOptions(DetailsElementType_Audio))
        {
    ...
    if (enmType == DetailsElementType_Network || enmType == DetailsElementType_Invalid)
    {
        ...
        foreach (const QString &strOption, gEDataManager->vpoxManagerDetailsPaneElementOptions(DetailsElementType_Network))
        {
    ...
    if (enmType == DetailsElementType_Serial || enmType == DetailsElementType_Invalid)
    {
        ...
        foreach (const QString &strOption, gEDataManager->vpoxManagerDetailsPaneElementOptions(DetailsElementType_Serial))
        {
    ...
    if (enmType == DetailsElementType_USB || enmType == DetailsElementType_Invalid)
    {
        ...
        foreach (const QString &strOption, gEDataManager->vpoxManagerDetailsPaneElementOptions(DetailsElementType_USB))
        {
    ...
    if (enmType == DetailsElementType_SF || enmType == DetailsElementType_Invalid)
    {
        ...
        foreach (const QString &strOption, gEDataManager->vpoxManagerDetailsPaneElementOptions(DetailsElementType_SF))
        {
    ...
    if (enmType == DetailsElementType_UI || enmType == DetailsElementType_Invalid)
    {
        ...
        foreach (const QString &strOption, gEDataManager->vpoxManagerDetailsPaneElementOptions(DetailsElementType_UI))
        {
    ...
    if (enmType == DetailsElementType_Description || enmType == DetailsElementType_Invalid)
    {
        ...
        foreach (const QString &strOption, gEDataManager->vpoxManagerDetailsPaneElementOptions(DetailsElementType_Description))
        {
...
void UIDetailsModel::saveDetailsOptions()
{
    ...
    if (iEnumIndex != -1)
    {
        ...
        for (int iKeyIndex = 0; iKeyIndex < metaEnum.keyCount(); ++iKeyIndex)
        {
            ...
            /* Save options: */
            if (!fDefault)
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_General, options);
            else
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_General, QStringList());
        }
    }
    ...
    if (iEnumIndex != -1)
    {
        ...
        for (int iKeyIndex = 0; iKeyIndex < metaEnum.keyCount(); ++iKeyIndex)
        {
            ...
            /* Save options: */
            if (!fDefault)
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_System, options);
            else
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_System, QStringList());
        }
    }
    ...
    if (iEnumIndex != -1)
    {
        ...
        for (int iKeyIndex = 0; iKeyIndex < metaEnum.keyCount(); ++iKeyIndex)
        {
            ...
            /* Save options: */
            if (!fDefault)
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Display, options);
            else
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Display, QStringList());
        }
    }
    ...
    if (iEnumIndex != -1)
    {
        ...
        for (int iKeyIndex = 0; iKeyIndex < metaEnum.keyCount(); ++iKeyIndex)
        {
            ...
            /* Save options: */
            if (!fDefault)
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Storage, options);
            else
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Storage, QStringList());
        }
    }
    ...
    if (iEnumIndex != -1)
    {
        ...
        for (int iKeyIndex = 0; iKeyIndex < metaEnum.keyCount(); ++iKeyIndex)
        {
            ...
            /* Save options: */
            if (!fDefault)
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Audio, options);
            else
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Audio, QStringList());
        }
    }
    ...
    if (iEnumIndex != -1)
    {
        ...
        for (int iKeyIndex = 0; iKeyIndex < metaEnum.keyCount(); ++iKeyIndex)
        {
            ...
            /* Save options: */
            if (!fDefault)
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Network, options);
            else
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Network, QStringList());
        }
    }
    ...
    if (iEnumIndex != -1)
    {
        ...
        for (int iKeyIndex = 0; iKeyIndex < metaEnum.keyCount(); ++iKeyIndex)
        {
            ...
            /* Save options: */
            if (!fDefault)
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Serial, options);
            else
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Serial, QStringList());
        }
    }
    ...
    if (iEnumIndex != -1)
    {
        ...
        for (int iKeyIndex = 0; iKeyIndex < metaEnum.keyCount(); ++iKeyIndex)
        {
            ...
            /* Save options: */
            if (!fDefault)
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_USB, options);
            else
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_USB, QStringList());
        }
    }
    ...
    if (iEnumIndex != -1)
    {
        ...
        for (int iKeyIndex = 0; iKeyIndex < metaEnum.keyCount(); ++iKeyIndex)
        {
            ...
            /* Save options: */
            if (!fDefault)
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_SF, options);
            else
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_SF, QStringList());
        }
    }
    ...
    if (iEnumIndex != -1)
    {
        ...
        for (int iKeyIndex = 0; iKeyIndex < metaEnum.keyCount(); ++iKeyIndex)
        {
            ...
            /* Save options: */
            if (!fDefault)
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_UI, options);
            else
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_UI, QStringList());
        }
    }
    ...
    if (iEnumIndex != -1)
    {
        ...
        for (int iKeyIndex = 0; iKeyIndex < metaEnum.keyCount(); ++iKeyIndex)
        {
            ...
            /* Save options: */
            if (!fDefault)
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Description, options);
            else
                gEDataManager->setVPoxManagerDetailsPaneElementOptions(DetailsElementType_Description, QStringList());
        }
    }
}
