...
#ifndef VPOX_INCLUDED_vmm_dbgftrace_h
#define VPOX_INCLUDED_vmm_dbgftrace_h
 ...
 * @remarks The user of these macros is responsible of including VPox/vmm/vm.h.
 * @{
 */
/**
...
#endif /* !VPOX_INCLUDED_vmm_dbgftrace_h */
