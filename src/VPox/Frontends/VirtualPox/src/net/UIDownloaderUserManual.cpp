...
/** @file
 * VPox Qt GUI - UIDownloaderUserManual class implementation.
 */
...
UIDownloaderUserManual::UIDownloaderUserManual()
{
    ...
    /* Add sources: */
    QString strSource1 = QString("https://download.virtualpox.org/virtualpox/%1/").arg(strVersion) + strUserManualShortFileName;
    QString strSource2 = QString("https://download.virtualpox.org/virtualpox/") + strUserManualShortFileName;
...
{
    return UIDownloader::description().arg(tr("VirtualPox User Manual"));
}
