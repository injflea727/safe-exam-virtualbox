...
/** @file
 * VPox Qt GUI - UIExtraDataManager class declaration.
 */
...
signals:
    ...
    /** Notifies about VirtualPox Manager / Details pane categories change. */
    void sigDetailsCategoriesChange();
    /** Notifies about VirtualPox Manager / Details pane options change. */
...
public:
    ...
    /** @name Settings: Proxy
      * @{ */
        /** Returns VPox proxy settings. */
        QString proxySettings();
        /** Defines VPox proxy @a strSettings. */
    ...
    /** @name VirtualPox Manager
      * @{ */
        ...
        /** Returns last selected tool set of VirtualPox Manager. */
        QList<UIToolType> toolsPaneLastItemsChosen();
        /** Defines last selected tool @a set of VirtualPox Manager. */
        ...
        /** Returns VirtualPox Manager / Details pane options for certain @a enmElementType. */
        QStringList vpoxManagerDetailsPaneElementOptions(DetailsElementType enmElementType);
        /** Defines VirtualPox Manager / Details pane @a options for certain @a enmElementType. */
        void setVPoxManagerDetailsPaneElementOptions(DetailsElementType enmElementType, const QStringList &options);
    /** @} */
    ...
    /** @name Virtual Machine
      * @{ */
        /** Returns whether machine should be shown in VirtualPox Manager Chooser-pane. */
        bool showMachineInVirtualPoxManagerChooser(const QUuid &uID);
        /** Returns whether machine should be shown in VirtualPox Manager Details-pane. */
        bool showMachineInVirtualPoxManagerDetails(const QUuid &uID);
...
#ifdef VPOX_GUI_WITH_EXTRADATA_MANAGER_UI
    /** @name VirtualPox: Extra-data Manager window
      * @{ */
