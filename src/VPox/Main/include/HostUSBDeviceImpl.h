...
/** @file
 * VirtualPox IHostUSBDevice COM interface implementation.
 */
...
typedef enum
{
     ...
     * Next VPox: CapturingForVM, CapturingForProxy.
     */
     ...
     *
     * Next Host: PhysDetached.
     * Next VPox: HeldByProxy or AttachingToVM on success,
     ...
     *            No filters.
     * Next VPox: PhysDetached (timeout), HeldByProxy (failure).
     */
     ...
     *
     * Next Host: PhysDetachingFromVM.
     * Next VPox: UsedByGuest, HeldByProxy (failure).
     */
     ...
     * Next VPox: ReleasingToHost, HeldByProxy.
     */
    kHostUSBDeviceState_DetachingFromVM,

    /** The device has been physically removed while a VM used it.
     *
     * This is the device state while VPoxSVC is doing IPC to the client (VM) telling it
     * to detach it.
     *
     * Next Host: None.
     * Next VPox: PhysDetached
     */
