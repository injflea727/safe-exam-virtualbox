...
#ifndef VPOX_INCLUDED_dbus_h
#define VPOX_INCLUDED_dbus_h
...
#define VPOX_DBUS_GENERATE_HEADER

#include <VPox/dbus-calls.h>

#undef VPOX_DBUS_GENERATE_HEADER

#endif /* !VPOX_INCLUDED_dbus_h */
