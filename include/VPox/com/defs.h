...
#ifndef VPOX_INCLUDED_com_defs_h
#define VPOX_INCLUDED_com_defs_h
...
#error "VPOX_WITH_XPCOM must be defined on a platform other than Windows!"
...
#ifdef RT_OS_WINDOWS
#define VPOX_SCRIPTABLE_IMPL(iface)                                          \
    public ATL::IDispatchImpl<iface, &IID_##iface, &LIBID_VirtualPox,        \
                              kTypeLibraryMajorVersion, kTypeLibraryMinorVersion>

#define VPOX_SCRIPTABLE_DISPATCH_IMPL(iface)                                 \
...
#endif /* !VPOX_INCLUDED_com_defs_h */
