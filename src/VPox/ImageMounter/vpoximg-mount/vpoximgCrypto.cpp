/* $Id: vpoximgCrypto.cpp $ */

/** @file
 * vpoximgCypto.cpp - Disk Image Flattening FUSE Program.
 */
...
void vpoxImageCryptoSetup(VDISKCRYPTOSETTINGS *pSettings, const char *pszCipher,
                                        ...
                                        bool fCreateKeyStore)
{
    ...
    pSettings->vdIfCfg.pfnAreKeysValid = vpoximgVdCryptoConfigAreKeysValid;
    pSettings->vdIfCfg.pfnQuerySize    = vpoximgVdCryptoConfigQuerySize;
    pSettings->vdIfCfg.pfnQuery        = vpoximgVdCryptoConfigQuery;
    pSettings->vdIfCfg.pfnQueryBytes   = NULL;

    pSettings->vdIfCrypto.pfnKeyRetain                = vpoximgVdCryptoKeyRetain;
    pSettings->vdIfCrypto.pfnKeyRelease               = vpoximgVdCryptoKeyRelease;
    pSettings->vdIfCrypto.pfnKeyStorePasswordRetain   = vpoximgVdCryptoKeyStorePasswordRetain;
    pSettings->vdIfCrypto.pfnKeyStorePasswordRelease  = vpoximgVdCryptoKeyStorePasswordRelease;
    pSettings->vdIfCrypto.pfnKeyStoreSave             = vpoximgVdCryptoKeyStoreSave;
    pSettings->vdIfCrypto.pfnKeyStoreReturnParameters = vpoximgVdCryptoKeyStoreReturnParameters;

    int rc = VDInterfaceAdd(&pSettings->vdIfCfg.Core,
                             "vpoximgVdInterfaceCfgCrypto",
    ...
    rc = VDInterfaceAdd(&pSettings->vdIfCrypto.Core,
                         "vpoximgVdInterfaceCrypto",
                         VDINTERFACETYPE_CRYPTO, pSettings,
                         sizeof(VDINTERFACECRYPTO), &pSettings->vdFilterIfaces);
    AssertRC(rc);
}

DECLCALLBACK(bool) vpoximgVdCryptoConfigAreKeysValid(void *pvUser, const char *pszzValid)
{
...
DECLCALLBACK(int) vpoximgVdCryptoConfigQuerySize(void *pvUser, const char *pszName, size_t *pcbValue)
{
...
DECLCALLBACK(int) vpoximgVdCryptoConfigQuery(void *pvUser, const char *pszName,
...
DECLCALLBACK(int) vpoximgVdCryptoKeyRetain(void *pvUser, const char *pszId,
...
DECLCALLBACK(int) vpoximgVdCryptoKeyRelease(void *pvUser, const char *pszId)
{
    VDISKCRYPTOSETTINGS *pSettings = (VDISKCRYPTOSETTINGS *)pvUser;
    NOREF(pszId);
    AssertPtrReturn(pSettings, VERR_GENERAL_FAILURE);
...
DECLCALLBACK(int) vpoximgVdCryptoKeyStorePasswordRetain(void *pvUser, const char *pszId, const char **ppszPassword)
{
    VDISKCRYPTOSETTINGS *pSettings = (VDISKCRYPTOSETTINGS *)pvUser;
    AssertPtrReturn(pSettings, VERR_GENERAL_FAILURE);
...
DECLCALLBACK(int) vpoximgVdCryptoKeyStorePasswordRelease(void *pvUser, const char *pszId)
{
    VDISKCRYPTOSETTINGS *pSettings = (VDISKCRYPTOSETTINGS *)pvUser;
    AssertPtrReturn(pSettings, VERR_GENERAL_FAILURE);
    NOREF(pszId);
...
DECLCALLBACK(int) vpoximgVdCryptoKeyStoreSave(void *pvUser, const void *pvKeyStore, size_t cbKeyStore)
{
    VDISKCRYPTOSETTINGS *pSettings = (VDISKCRYPTOSETTINGS *)pvUser;
    AssertPtrReturn(pSettings, VERR_GENERAL_FAILURE);
...
DECLCALLBACK(int) vpoximgVdCryptoKeyStoreReturnParameters(void *pvUser, const char *pszCipher,
