...
char vbebios_copyright[]        = "VirtualPox VESA BIOS";
char vbebios_vendor_name[]      = VPOX_VENDOR;
char vbebios_product_name[]     = VPOX_PRODUCT " VBE Adapter";
char vbebios_product_revision[] = VPOX_PRODUCT " Version " VPOX_VERSION_STRING;

char vbebios_info_string[]    = "VirtualPox VBE Display Adapter enabled\r\n\r\n";
char no_vbebios_info_string[] = "No VirtualPox VBE support available!\r\n\r\n";

#ifdef VGA_DEBUG
char msg_vbe_init[] = "VirtualPox Version " VPOX_VERSION_STRING " VBE Display Adapter\r\n";
#endif
