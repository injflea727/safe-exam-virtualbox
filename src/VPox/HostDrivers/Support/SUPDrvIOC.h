/* $Id: SUPDrvIOC.h $ */
/** @file
 * VirtualPox Support Driver - IOCtl definitions.
 */
...
#ifndef VPOX_INCLUDED_SRC_Support_SUPDrvIOC_h
#define VPOX_INCLUDED_SRC_Support_SUPDrvIOC_h
...
# define SUP_NT_STATUS_IS_VPOX(a_rcNt)          ( ((uint32_t)(a_rcNt) & 0xffff0000) == SUP_NT_STATUS_BASE )
# define SUP_NT_STATUS_TO_VPOX(a_rcNt)          ( (int)((uint32_t)(a_rcNt) | UINT32_C(0xffff0000)) )

/** NT device name for system access. */
# define SUPDRV_NT_DEVICE_NAME_SYS              L"\\Device\\VPoxDrv"
/** NT device name for user access. */
# define SUPDRV_NT_DEVICE_NAME_USR              L"\\Device\\VPoxDrvU"
# ifdef VPOX_WITH_HARDENING
/** NT device name for hardened stub access. */
#  define SUPDRV_NT_DEVICE_NAME_STUB            L"\\Device\\VPoxDrvStub"
/** NT device name for getting error information for failed VPoxDrv or
 * VPoxDrvStub open. */
#  define SUPDRV_NT_DEVICE_NAME_ERROR_INFO      L"\\Device\\VPoxDrvErrorInfo"
# endif
...
typedef struct SUPREQHDR
{
    ...
    uint32_t        fFlags;
    /** The VPox status code of the operation, out direction only. */
    int32_t         rc;
} SUPREQHDR;
...
#endif /* !VPOX_INCLUDED_SRC_Support_SUPDrvIOC_h */
