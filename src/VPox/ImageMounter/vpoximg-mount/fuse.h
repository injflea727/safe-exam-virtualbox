...
#ifndef VPOX_INCLUDED_SRC_vpoximg_mount_fuse_h
#define VPOX_INCLUDED_SRC_vpoximg_mount_fuse_h
...
#define VPOX_FUSE_GENERATE_HEADER

#include "fuse-calls.h"

#undef VPOX_FUSE_GENERATE_HEADER

RT_C_DECLS_END

#endif /* !VPOX_INCLUDED_SRC_vpoximg_mount_fuse_h */
