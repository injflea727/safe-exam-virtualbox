...
/** @file
 * VirtualPox Support Library - Darwin specific parts.
 */
...
*********************************************************************************************************************************/
/** System device name. */
#define DEVICE_NAME_SYS "/dev/vpoxdrv"
/** User device name. */
#define DEVICE_NAME_USR "/dev/vpoxdrvu"
/** The IOClass key of the service (see SUPDrv-darwin.cpp / Info.plist). */
#define IOCLASS_NAME    "org_virtualpox_SupDrv"
...
/**
 * Opens the IOKit service, instantiating org_virtualpox_SupDrvClient.
 *
 * @returns VPox status code.
 */
