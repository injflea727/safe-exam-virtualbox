...
/** @file
 * VPox Qt GUI - UIFileManager class implementation.
 */
...
void UIFileManager::prepareGuestListener()
{
    if (m_comGuest.isOk())
    {
        ...
        eventTypes << KVPoxEventType_OnGuestSessionRegistered;
...
void UIFileManager::prepareListener(ComObjPtr<UIMainEventListenerImpl> &QtListener,
                                                ...
                                                CEventSource comEventSource, QVector<KVPoxEventType>& eventTypes)
{
