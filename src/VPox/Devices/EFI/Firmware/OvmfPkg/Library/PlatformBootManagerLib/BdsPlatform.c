...
#ifndef VPOX /* @todo Our graphics controller is started in PlatformBdsConnectSequence(). */
  //
  // Logo show
  //
  BootLogoEnableLogo ();
...
#ifdef VPOX /* @todo Our graphics controller is started in PlatformBdsConnectSequence(). */
  //
  // Logo show
  //
  BootLogoEnableLogo ();
