...
static DECLCALLBACK(int) drvACPIPoller(PPDMDRVINS pDrvIns, PPDMTHREAD pThread)
{
    ...
    while (pThread->enmState == PDMTHREADSTATE_RUNNING)
    {
        ...
        PDMACPIBATCAPACITY enmBatteryRemainingCapacity; /* total remaining capacity of vpox batt */
        uint32_t u32BatteryPresentRate;         /* total present (dis)charging rate of vpox batt */
