...
#ifndef VPOX_INCLUDED_vmm_vm_h
#define VPOX_INCLUDED_vmm_vm_h
...
#  error "Compile job does not include VMM_COMMON_DEFS from src/VPox/Config.kmk - make sure you really need to include this file!"
# endif
...
# include <VPox/sup.h>
#else
# pragma D depends_on library vpox-types.d
 ...
 *
 * Run 'kmk run-struct-tests' (from src/VPox/VMM if you like) after updating!
 */
...
typedef struct VM
{
    ...
    union
    {
        ...
        struct CPUM s;
#endif
#ifdef VPOX_INCLUDED_vmm_cpum_h
    ...
    union
    {
        ...
        struct DBGF s;
#endif
#ifdef VPOX_INCLUDED_vmm_dbgf_h
