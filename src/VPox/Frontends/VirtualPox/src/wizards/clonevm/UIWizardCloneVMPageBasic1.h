...
/** @file
 * VPox Qt GUI - UIWizardCloneVMPageBasic1 class declaration.
 */
...
protected:
    ...
    QString      m_strGroup;
    /** Full, non-native path of the clone machines setting file. Generated by CVirtualPox::ComposeMachineFilename(...) */
