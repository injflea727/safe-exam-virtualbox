/* $Id: SUPSvcGrant.cpp $ */
/** @file
 * VirtualPox Support Service - The Grant Service.
 */
 ...
 *
 * @returns VINF_SUCCESS, VPox error code on internal error.
 *
 * @param   pThis           Pointer to the grant service instance data.
 ...
 *
 * @returns VINF_SUCCESS on success, VPox error code on internal error.
 *
 * @param   pThis           Pointer to the grant service instance data.
 ...
 *
 * @returns VINF_SUCCESS on normal exit, VPox error status on failure.
 * @param   hThread         The thread handle.
