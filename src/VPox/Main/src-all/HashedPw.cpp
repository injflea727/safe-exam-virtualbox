 ...
 */
bool VPoxIsPasswordHashed(RTCString const *a_pstrPassword)
{
    /* prefix */
 ...
 *                              input and output.
 */
void VPoxHashPassword(RTCString *a_pstrPassword)
{
    AssertReturnVoid(!VPoxIsPasswordHashed(a_pstrPassword));
