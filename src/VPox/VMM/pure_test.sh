...
kmk KBUILD_TYPE=release VPoxVMM VMMR0 VMMGC
size ${BINDIR}/VMMR0.r0 ${BINDIR}/VMMGC.gc ${BINDIR}/VPoxVMM.${DLLEXT} > pt-baseline.txt
...
do
    ...
    kmk KBUILD_TYPE=release VPoxVMM VMMR0 VMMGC
    size ${BINDIR}/VMMR0.r0 ${BINDIR}/VMMGC.gc ${BINDIR}/VPoxVMM.${DLLEXT} > "pt-${name}.txt"
