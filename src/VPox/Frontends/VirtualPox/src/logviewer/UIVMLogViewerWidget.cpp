...
/** @file
 * VPox Qt GUI - UIVMLogViewerWidget class implementation.
 */
...
bool UIVMLogViewerWidget::createLogViewerPages()
{
    ...
    unsigned cMaxLogs = sys.GetLogHistoryCount() + 1 /*VPox.log*/ + 1 /*VPoxHardening.log*/; /** @todo Add api for getting total possible log count! */
