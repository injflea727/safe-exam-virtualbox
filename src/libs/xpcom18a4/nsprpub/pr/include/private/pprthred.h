...
#define PR_AttachThread VPoxNsprPR_AttachThread
#define PR_DetachThread VPoxNsprPR_DetachThread
#define PR_GetThreadID VPoxNsprPR_GetThreadID
#define PR_SetThreadDumpProc VPoxNsprPR_SetThreadDumpProc
#define PR_GetThreadAffinityMask VPoxNsprPR_GetThreadAffinityMask
#define PR_SetThreadAffinityMask VPoxNsprPR_SetThreadAffinityMask
#define PR_SetCPUAffinityMask VPoxNsprPR_SetCPUAffinityMask
#define PR_ShowStatus VPoxNsprPR_ShowStatus
#define PR_SetThreadRecycleMode VPoxNsprPR_SetThreadRecycleMode
#define PR_CreateThreadGCAble VPoxNsprPR_CreateThreadGCAble
#define PR_AttachThreadGCAble VPoxNsprPR_AttachThreadGCAble
#define PR_SetThreadGCAble VPoxNsprPR_SetThreadGCAble
#define PR_ClearThreadGCAble VPoxNsprPR_ClearThreadGCAble
#define PR_SuspendAll VPoxNsprPR_SuspendAll
#define PR_ResumeAll VPoxNsprPR_ResumeAll
#define PR_GetSP VPoxNsprPR_GetSP
#define PR_GetGCRegisters VPoxNsprPR_GetGCRegisters
#define GetExecutionEnvironment VPoxNsprGetExecutionEnvironment
#define SetExecutionEnvironment VPoxNsprSetExecutionEnvironment
#define PR_EnumerateThreads VPoxNsprPR_EnumerateThreads
#define PR_ThreadScanStackPointers VPoxNsprPR_ThreadScanStackPointers
#define PR_ScanStackPointers VPoxNsprPR_ScanStackPointers
#define PR_GetStackSpaceLeft VPoxNsprPR_GetStackSpaceLeft
#define PR_NewNamedMonitor VPoxNsprPR_NewNamedMonitor
#define PR_TestAndLock VPoxNsprPR_TestAndLock
#define PR_TestAndEnterMonitor VPoxNsprPR_TestAndEnterMonitor
#define PR_GetMonitorEntryCount VPoxNsprPR_GetMonitorEntryCount
#define PR_CTestAndEnterMonitor VPoxNsprPR_CTestAndEnterMonitor
#define PR_Mac_WaitForAsyncNotify VPoxNsprPR_Mac_WaitForAsyncNotify
#define PR_Mac_PostAsyncNotify VPoxNsprPR_Mac_PostAsyncNotify
#define PR_OS2_SetFloatExcpHandler VPoxNsprPR_OS2_SetFloatExcpHandler
#define PR_OS2_UnsetFloatExcpHandler VPoxNsprPR_OS2_UnsetFloatExcpHandler
#define PR_XLock VPoxNsprPR_XLock
#define PR_XUnlock VPoxNsprPR_XUnlock
#define PR_XIsLocked VPoxNsprPR_XIsLocked
#define PR_XWait VPoxNsprPR_XWait
#define PR_XNotify VPoxNsprPR_XNotify
#define PR_XNotifyAll VPoxNsprPR_XNotifyAll
