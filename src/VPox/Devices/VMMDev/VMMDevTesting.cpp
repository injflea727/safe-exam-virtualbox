 ...
 *
 * To enable: VPoxManage setextradata vmname VPoxInternal/Devices/VMMDev/0/Config/TestingEnabled  1
 */
 ...
 */
static DECLCALLBACK(VPOXSTRICTRC) vmmdevTestingMmioWrite(PPDMDEVINS pDevIns, void *pvUser, RTGCPHYS off, void const *pv, unsigned cb)
{
    RT_NOREF_PV(pvUser);
 ...
 */
static DECLCALLBACK(VPOXSTRICTRC) vmmdevTestingMmioRead(PPDMDEVINS pDevIns, void *pvUser, RTGCPHYS off, void *pv, unsigned cb)
{
    RT_NOREF_PV(pvUser);
