...
/** @file
 * VPox Qt GUI - UIActionPoolManager class implementation.
 */
...
protected:
    ...
    virtual void retranslateUi() /* override */
    {
        ...
        setStatusTip(QApplication::translate("UIActionPool", "Import an appliance into VirtualPox"));
...
protected:
    ...
    virtual void retranslateUi() /* override */
    {
        ...
        setStatusTip(QApplication::translate("UIActionPool", "Export one or more VirtualPox virtual machines as an appliance"));
        setToolTip(simplifyText(text()) + (shortcut().isEmpty() ? QString() : QString(" (%1)").arg(shortcut().toString())));
    }
};
...
protected:
    ...
    virtual void retranslateUi() /* override */
    {
        ...
        setStatusTip(QApplication::translate("UIActionPool", "Show the VirtualPox Machine Definition files in Finder"));
#elif defined(VPOX_WS_WIN)
        setName(QApplication::translate("UIActionPool", "S&how in Explorer"));
        setStatusTip(QApplication::translate("UIActionPool", "Show the VirtualPox Machine Definition files in Explorer"));
#else
        setName(QApplication::translate("UIActionPool", "S&how in File Manager"));
        setStatusTip(QApplication::translate("UIActionPool", "Show the VirtualPox Machine Definition files in the File Manager"));
#endif
    }
};
...
protected:
    ...
    virtual void retranslateUi() /* override */
    {
        ...
        setStatusTip(QApplication::translate("UIActionPool", "Create alias files to the VirtualPox Machine Definition files on your desktop"));
#else
        setName(QApplication::translate("UIActionPool", "Cr&eate Shortcut on Desktop"));
        setStatusTip(QApplication::translate("UIActionPool", "Create shortcut files to the VirtualPox Machine Definition files on your desktop"));
#endif
    }
};
