...
*********************************************************************************************************************************/
typedef struct VPOXGUESTCTRL_BUFFER_VALUE
{
    char *pszValue;
} VPOXGUESTCTRL_BUFFER_VALUE, *PVPOXGUESTCTRL_BUFFER_VALUE;
typedef std::map< RTCString, VPOXGUESTCTRL_BUFFER_VALUE > GuestBufferMap;
typedef std::map< RTCString, VPOXGUESTCTRL_BUFFER_VALUE >::iterator GuestBufferMapIter;
typedef std::map< RTCString, VPOXGUESTCTRL_BUFFER_VALUE >::const_iterator GuestBufferMapIterConst;
