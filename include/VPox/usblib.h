/** @file
 * USBLib - Library for wrapping up the VPoxUSB functionality. (DEV,HDrv,Main)
 */
...
#ifndef VPOX_INCLUDED_usblib_h
#define VPOX_INCLUDED_usblib_h
