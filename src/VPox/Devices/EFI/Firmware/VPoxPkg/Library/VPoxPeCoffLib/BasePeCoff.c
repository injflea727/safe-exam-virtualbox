  ...
  )
{
  ...
  UINTN                 Size;
#ifndef VPOX /* VPox: 64-bit VS2010 say wrong type / loss of data. */
  UINTN                 Offset = 0;
#else
  UINT32                Offset = 0;
#endif
...
extern VOID EFIAPI VPoxPeCoffLoaderMoveImageExtraAction(IN PHYSICAL_ADDRESS OldBase, IN PHYSICAL_ADDRESS NewBase);
  ...
  )
{
  ...
  VPoxPeCoffLoaderMoveImageExtraAction(ImageBase, VirtImageBase);
