/* @file
 * VPox Remote Desktop Extension (VRDE) - raw TSMF dynamic channel interface.
 */
...
#ifndef VPOX_INCLUDED_RemoteDesktop_VRDETSMF_h
#define VPOX_INCLUDED_RemoteDesktop_VRDETSMF_h
...
#endif /* !VPOX_INCLUDED_RemoteDesktop_VRDETSMF_h */
