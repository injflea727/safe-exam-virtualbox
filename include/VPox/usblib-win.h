/** @file
 * USBLib - Library for wrapping up the VPoxUSB functionality, Windows flavor.
 * (DEV,HDrv,Main)
 */
...
#ifndef VPOX_INCLUDED_usblib_win_h
#define VPOX_INCLUDED_usblib_win_h
...
DEFINE_GUID(GUID_CLASS_VPOXUSB, 0x873fdf, 0xCAFE, 0x80EE, 0xaa, 0x5e, 0x0, 0xc0, 0x4f, 0xb1, 0x72, 0xb);

#define USBFLT_SERVICE_NAME              "\\\\.\\VPoxUSBFlt"
#define USBFLT_NTDEVICE_NAME_STRING      L"\\Device\\VPoxUSBFlt"
#define USBFLT_SYMBOLIC_NAME_STRING      L"\\DosDevices\\VPoxUSBFlt"

#define USBMON_SERVICE_NAME_W              L"VPoxUSBMon"
#define USBMON_DEVICE_NAME               "\\\\.\\VPoxUSBMon"
#define USBMON_DEVICE_NAME_NT            L"\\Device\\VPoxUSBMon"
#define USBMON_DEVICE_NAME_DOS           L"\\DosDevices\\VPoxUSBMon"
...
#endif /* !VPOX_INCLUDED_usblib_win_h */
