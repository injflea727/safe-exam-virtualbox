...
/** @file
 * VirtualPox Support Library - Verification of Hardened Installation.
 */
...
static SUPINSTFILE const    g_aSupInstallFiles[] =
{
    ...
    {   kSupIFT_Dll,  kSupID_AppPrivArch,       false, "VPoxDDR0.r0" },

#ifdef VPOX_WITH_RAW_MODE
    {   kSupIFT_Rc,   kSupID_AppPrivArch,       false, "VMMRC.rc" },
    {   kSupIFT_Rc,   kSupID_AppPrivArch,       false, "VPoxDDRC.rc" },
#endif

    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "VPoxRT" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "VPoxVMM" SUPLIB_DLL_SUFF },
#if HC_ARCH_BITS == 32
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "VPoxREM32" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "VPoxREM64" SUPLIB_DLL_SUFF },
#endif
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "VPoxDD" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "VPoxDD2" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "VPoxDDU" SUPLIB_DLL_SUFF },
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "VPoxVMMPreload" SUPLIB_EXE_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxVMMPreload" SUPLIB_DLL_SUFF },

//#ifdef VPOX_WITH_DEBUGGER_GUI
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "VPoxDbg" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "VPoxDbg3" SUPLIB_DLL_SUFF },
//#endif

//#ifdef VPOX_WITH_SHARED_CLIPBOARD
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxSharedClipboard" SUPLIB_DLL_SUFF },
//#endif
//#ifdef VPOX_WITH_SHARED_FOLDERS
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxSharedFolders" SUPLIB_DLL_SUFF },
//#endif
//#ifdef VPOX_WITH_DRAG_AND_DROP
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxDragAndDropSvc" SUPLIB_DLL_SUFF },
//#endif
//#ifdef VPOX_WITH_GUEST_PROPS
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxGuestPropSvc" SUPLIB_DLL_SUFF },
//#endif
//#ifdef VPOX_WITH_GUEST_CONTROL
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxGuestControlSvc" SUPLIB_DLL_SUFF },
//#endif
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxHostChannel" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxSharedCrOpenGL" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxOGLhostcrutil" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxOGLhosterrorspu" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxOGLrenderspu" SUPLIB_DLL_SUFF },

    {   kSupIFT_Exe,  kSupID_AppBin,             true, "VPoxManage" SUPLIB_EXE_SUFF },

#ifdef VPOX_WITH_MAIN
    {   kSupIFT_Exe,  kSupID_AppBin,            false, "VPoxSVC" SUPLIB_EXE_SUFF },
 #ifdef RT_OS_WINDOWS
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "VPoxC" SUPLIB_DLL_SUFF },
 #else
    {   kSupIFT_Exe,  kSupID_AppPrivArch,       false, "VPoxXPCOMIPCD" SUPLIB_EXE_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "VPoxXPCOM" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArchComp,   false, "VPoxXPCOMIPCC" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArchComp,   false, "VPoxC" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArchComp,   false, "VPoxSVCM" SUPLIB_DLL_SUFF },
    {   kSupIFT_Data, kSupID_AppPrivArchComp,   false, "VPoxXPCOMBase.xpt" },
 #endif
#endif

    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "VRDPAuth" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "VPoxAuth" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "VPoxVRDP" SUPLIB_DLL_SUFF },

//#ifdef VPOX_WITH_HEADLESS
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "VPoxHeadless" SUPLIB_EXE_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxHeadless" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxVideoRecFB" SUPLIB_DLL_SUFF },
//#endif

//#ifdef VPOX_WITH_QTGUI
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "VirtualPox" SUPLIB_EXE_SUFF },
# ifdef RT_OS_DARWIN
    {   kSupIFT_Exe,  kSupID_AppMacHelper,       true, "VirtualPoxVM" SUPLIB_EXE_SUFF },
# else
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "VirtualPoxVM" SUPLIB_EXE_SUFF },
# endif
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VirtualPoxVM" SUPLIB_DLL_SUFF },
...
# if !defined(RT_OS_DARWIN) && !defined(RT_OS_WINDOWS) && !defined(RT_OS_OS2)
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "VPoxKeyboard" SUPLIB_DLL_SUFF },
# endif
//#endif

//#ifdef VPOX_WITH_VPOXSDL
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "VPoxSDL" SUPLIB_EXE_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxSDL" SUPLIB_DLL_SUFF },
//#endif

//#ifdef VPOX_WITH_WEBSERVICES
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "vpoxwebsrv" SUPLIB_EXE_SUFF },
//#endif

#ifdef RT_OS_LINUX
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "VPoxTunctl" SUPLIB_EXE_SUFF },
#endif

//#ifdef VPOX_WITH_NETFLT
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "VPoxNetDHCP" SUPLIB_EXE_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxNetDHCP" SUPLIB_DLL_SUFF },
//#endif

//#ifdef VPOX_WITH_LWIP_NAT
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "VPoxNetNAT" SUPLIB_EXE_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "VPoxNetNAT" SUPLIB_DLL_SUFF },
//#endif
...
static int supR3HardenedMakePath(SUPINSTDIR enmDir, char *pszDst, size_t cchDst, bool fFatal, PCSUPINSTFILE pFile)
{
    ...
    switch (enmDir)
    {
        ...
        case kSupID_AppMacHelper:
            ...
            if (RT_SUCCESS(rc))
            {
                /* Up one level from the VirtualPox.app/Contents/MacOS directory: */
...
{
# if defined(VPOX_WITH_HARDENING) && !defined(IN_SUP_R3_STATIC) /* Latter: Not in VPoxCpuReport and friends. */
                                      ...
                                      bool fLeaveOpen, uint32_t fMainFlags)
{
     ...
     * Note! On darwin we have a hack in place for VirtualPoxVM helper app
     *       to share VirtualPox.dylib with the VirtualPox app.  This ASSUMES
 ...
 *
 * @returns VPox status code, error buffer filled on failure.
...
# ifdef VPOX_WITH_HARDENING
        ...
        if (   pszSuffix
            ...
            &&                   pszSuffix[3]  == '\0' )
            fFlags |= SUPHNTVI_F_RC_IMAGE;
#  ifndef IN_SUP_R3_STATIC /* Not in VPoxCpuReport and friends. */
 ...
 *
 * @returns VPox status code. Will not bitch on failure since the
