...
#ifndef VPOX_INCLUDED_SRC_VMMDev_VMMDevState_h
#define VPOX_INCLUDED_SRC_VMMDev_VMMDevState_h
#ifndef RT_WITHOUT_PRAGMA_ONCE
# pragma once
#endif

#include <VPoxVideo.h>  /* For VBVA definitions. */
...
typedef struct DISPLAYCHANGEDATA
{
    ...
    DISPLAYCHANGEREQUEST aRequests[VPOX_VIDEO_MAX_SCREENS];
} DISPLAYCHANGEDATA;
...
typedef struct VMMDEVFACILITYSTATUSENTRY
{
    ...
    VPoxGuestFacilityType       enmFacility;
    /** The status (may contain values other than the defined ones). */
    VPoxGuestFacilityStatus     enmStatus;
...
#endif /* !VPOX_WITHOUT_TESTING_FEATURES */
...
typedef struct VMMDEVR3
{
    ...
    /** List of pending HGCM requests (VPOXHGCMCMD). */
...
#define VMMDEV_SAVED_STATE_VERSION_VPOX_30                      11

#endif /* !VPOX_INCLUDED_SRC_VMMDev_VMMDevState_h */
