...
;   VPoxManage setextradata bs-test1 VPoxInternal/Devices/VMMDev/0/Config/TestingEnabled  1
;   VPoxManage setextradata bs-test1 VPoxInternal/Devices/VMMDev/0/Config/TestingMMIO  1
;
...
%include "VPox/VMMDevTesting.mac"
