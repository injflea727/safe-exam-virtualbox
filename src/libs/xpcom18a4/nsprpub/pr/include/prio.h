...
#define PR_GetInheritedFD VPoxNsprPR_GetInheritedFD
#define PR_SetFDInheritable VPoxNsprPR_SetFDInheritable
#define PR_Access VPoxNsprPR_Access
#define PR_Open VPoxNsprPR_Open
#define PR_Read VPoxNsprPR_Read
#define PR_Write VPoxNsprPR_Write
#define PR_Seek VPoxNsprPR_Seek
#define PR_Seek64 VPoxNsprPR_Seek64
#define PR_Poll VPoxNsprPR_Poll
#define PR_NewPollableEvent VPoxNsprPR_NewPollableEvent
#define PR_SetPollableEvent VPoxNsprPR_SetPollableEvent
#define PR_WaitForPollableEvent VPoxNsprPR_WaitForPollableEvent
#define PR_DestroyPollableEvent VPoxNsprPR_DestroyPollableEvent
#define PR_Close VPoxNsprPR_Close
#define PR_GetSpecialFD VPoxNsprPR_GetSpecialFD
#define PR_Connect VPoxNsprPR_Connect
#define PR_OpenTCPSocket VPoxNsprPR_OpenTCPSocket
#define PR_SetSocketOption VPoxNsprPR_SetSocketOption
#define PR_Bind VPoxNsprPR_Bind
#define PR_Listen VPoxNsprPR_Listen
#define PR_Accept VPoxNsprPR_Accept
#define PR_AcceptRead VPoxNsprPR_AcceptRead
#define PR_OpenDir VPoxNsprPR_OpenDir
#define PR_ReadDir VPoxNsprPR_ReadDir
#define PR_CloseDir VPoxNsprPR_CloseDir
#define PR_CreatePipe VPoxNsprPR_CreatePipe
#define PR_GetDescType VPoxNsprPR_GetDescType
#define PR_GetSpecialFD VPoxNsprPR_GetSpecialFD
#define PR_GetUniqueIdentity VPoxNsprPR_GetUniqueIdentity
#define PR_GetNameForIdentity VPoxNsprPR_GetNameForIdentity
#define PR_GetLayersIdentity VPoxNsprPR_GetLayersIdentity
#define PR_GetIdentitiesLayer VPoxNsprPR_GetIdentitiesLayer
#define PR_GetDefaultIOMethods VPoxNsprPR_GetDefaultIOMethods
#define PR_CreateIOLayerStub VPoxNsprPR_CreateIOLayerStub
#define PR_CreateIOLayer VPoxNsprPR_CreateIOLayer
#define PR_PushIOLayer VPoxNsprPR_PushIOLayer
#define PR_PopIOLayer VPoxNsprPR_PopIOLayer
#define PR_OpenFile VPoxNsprPR_OpenFile
#define PR_Writev VPoxNsprPR_Writev
#define PR_Delete VPoxNsprPR_Delete
#define PR_Rename VPoxNsprPR_Rename
#define PR_GetFileInfo VPoxNsprPR_GetFileInfo
#define PR_GetFileInfo64 VPoxNsprPR_GetFileInfo64
#define PR_GetOpenFileInfo VPoxNsprPR_GetOpenFileInfo
#define PR_GetOpenFileInfo64 VPoxNsprPR_GetOpenFileInfo64
#define PR_Available VPoxNsprPR_Available
#define PR_Available64 VPoxNsprPR_Available64
#define PR_Sync VPoxNsprPR_Sync
#define PR_MkDir VPoxNsprPR_MkDir
#define PR_MakeDir VPoxNsprPR_MakeDir
#define PR_RmDir VPoxNsprPR_RmDir
#define PR_NewUDPSocket VPoxNsprPR_NewUDPSocket
#define PR_NewTCPSocket VPoxNsprPR_NewTCPSocket
#define PR_OpenUDPSocket VPoxNsprPR_OpenUDPSocket
#define PR_OpenTCPSocket VPoxNsprPR_OpenTCPSocket
#define PR_ConnectContinue VPoxNsprPR_ConnectContinue
#define PR_GetConnectStatus VPoxNsprPR_GetConnectStatus
#define PR_Shutdown VPoxNsprPR_Shutdown
#define PR_Recv VPoxNsprPR_Recv
#define PR_Send VPoxNsprPR_Send
#define PR_RecvFrom VPoxNsprPR_RecvFrom
#define PR_SendTo VPoxNsprPR_SendTo
#define PR_TransmitFile VPoxNsprPR_TransmitFile
#define PR_SendFile VPoxNsprPR_SendFile
#define PR_NewTCPSocketPair VPoxNsprPR_NewTCPSocketPair
#define PR_GetSockName VPoxNsprPR_GetSockName
#define PR_GetPeerName VPoxNsprPR_GetPeerName
#define PR_GetSocketOption VPoxNsprPR_GetSocketOption
#define PR_CreateFileMap VPoxNsprPR_CreateFileMap
#define PR_GetMemMapAlignment VPoxNsprPR_GetMemMapAlignment
#define PR_MemMap VPoxNsprPR_MemMap
#define PR_MemUnmap VPoxNsprPR_MemUnmap
#define PR_CloseFileMap VPoxNsprPR_CloseFileMap
#define PR_CreatePipe VPoxNsprPR_CreatePipe
