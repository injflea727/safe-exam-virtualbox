...
/** @file
 * VirtualPox Support Library - Solaris specific parts.
 */
...
#define DEVICE_NAME_SYS       "/devices/pseudo/vpoxdrv@0:vpoxdrv"
/** Solaris device link - user. */
#define DEVICE_NAME_USR       "/devices/pseudo/vpoxdrv@0:vpoxdrvu"
/** Solaris device link - system (non-global zone). */
#define DEVICE_NAME_SYS_ZONE  "/dev/vpoxdrv"
/** Solaris device link - user (non-global zone). */
#define DEVICE_NAME_USR_ZONE  "/dev/vpoxdrvu"
