...
<!-- target namespace; this must match the xmlns:vpox in stylesheet opening tags! -->
<xsl:variable name="G_targetNamespace"
              select='"http://www.virtualpox.org/"' />
...
<!-- schema type to use for object references; while it is theoretically
     possible to use a self-defined type (e.g. some vpoxObjRef type that's
