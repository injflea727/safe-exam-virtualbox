 ...
 *
 * VirtualPox 0.0 thru 6.0 implemented a mode of guest code execution that
 ...
 *
 * A future VirtualPox version may reintroduce a new kind of raw-mode for
 ...
 *
 *  - Only 64-bit mode code (no problem since VirtualPox requires a 64-bit host
