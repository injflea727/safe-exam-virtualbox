/* $Id: mount.vpoxsf.c $ */
/** @file
 * VirtualPox Guest Additions for Linux - mount(8) helper.
 *
...
static int usage(char *argv0)
{
    printf("Usage: %s [OPTIONS] NAME MOUNTPOINT\n"
           "Mount the VirtualPox shared folder NAME from the host system to MOUNTPOINT.\n"
           "\n"
...
main(int argc, char **argv)
{
     ...
     */
    err = mount(pszSharedFolder, pszMountPoint, "vpoxsf", opts.fFlags, szOpts);
    saved_errno = errno;
