...
#ifndef GA_INCLUDED_SRC_WINNT_VPoxCredProv_VPoxCredProvCredential_h
#define GA_INCLUDED_SRC_WINNT_VPoxCredProv_VPoxCredProvCredential_h
...
class VPoxCredProvCredential : public ICredentialProviderCredential
{
public:

    VPoxCredProvCredential(void);

    virtual ~VPoxCredProvCredential(void);
...
private:
    ...
    PRTUTF16                              m_apwszFields[VPOXCREDPROV_NUM_FIELDS];
...
#endif /* !GA_INCLUDED_SRC_WINNT_VPoxCredProv_VPoxCredProvCredential_h */
