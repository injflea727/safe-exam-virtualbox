...
#define PR_CreateAlarm VPoxNsprPR_CreateAlarm
#define PR_DestroyAlarm VPoxNsprPR_DestroyAlarm
#define PR_SetAlarm VPoxNsprPR_SetAlarm
#define PR_ResetAlarm VPoxNsprPR_ResetAlarm
