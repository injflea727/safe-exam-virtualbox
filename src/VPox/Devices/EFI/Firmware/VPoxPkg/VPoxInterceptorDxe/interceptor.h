 ...
 */
#define TBL_ENTRY(a,b, ign, return_type, params_num, params) static return_type EFIAPI CONCAT(VPOXINTERCEPTOR,b)(PARAMETER(params_num)params);
#include SERVICE_H
#undef TBL_ENTRY
...
do {                                    \
    ...
    ORIG_SERVICE->b = CONCAT(VPOXINTERCEPTOR, b);      \
}while (0);
#include SERVICE_H
#undef TBL_ENTRY
    return EFI_SUCCESS;
