/* $Id: VPox-CodingGuidelines.cpp $ */
/** @file
 * VPox - Coding Guidelines.
 */
...
/** @page pg_vpox_guideline                 VPox Coding Guidelines
 *
 * The compulsory sections of these guidelines are to be followed in all of the
 * VPox sources.  Please note that local guidelines in parts of the VPox source
 * tree may promote the optional ones to compulsory status.  The VPox tree also
 * contains some 3rd party sources where it is good to follow the local coding
 * style while keeping these guidelines in mind.
 *
 * Contents:
 *      - @ref sec_vpox_guideline_compulsory
 *          - @ref sec_vpox_guideline_compulsory_sub64
 *          - @ref sec_vpox_guideline_compulsory_cppmain
 *          - @ref sec_vpox_guideline_compulsory_cppqtgui
 *          - @ref sec_vpox_guideline_compulsory_xslt
 *          - @ref sec_vpox_guideline_compulsory_doxygen
 *          - @ref sec_vpox_guideline_compulsory_guest
 *      - @ref sec_vpox_guideline_optional
 *          - @ref sec_vpox_guideline_optional_layout
 *          - @ref sec_vpox_guideline_optional_prefix
 *          - @ref sec_vpox_guideline_optional_misc
 *      - @ref sec_vpox_guideline_warnings
 *          - @ref sec_vpox_guideline_warnings_signed_unsigned_compare
 *      - @ref sec_vpox_guideline_svn
 *
 * Local guidelines overrides:
 *      - src/VPox/VMM/:            @ref pg_vmm_guideline (src/VPox/VMM/Docs-CodingGuidelines.cpp)
 *      - src/VPox/ValidationKit/:  @ref pg_validationkit_guideline  (src/VPox/ValidationKit/ValidationKitCodingGuidelines.cpp)
 *      - src/VPox/Runtime/:        All of @ref sec_vpox_guideline_optional is mandatory.
 *      - src/VPox/Main/:           @ref sec_vpox_guideline_compulsory_cppmain
 *      - src/VPox/Frontends/VirtualPox/: @ref sec_vpox_guideline_compulsory_cppqtgui
 *
 *
 * @section sec_vpox_guideline_compulsory       Compulsory
 *
 * <ul>
 *
 ...
 *        changing it (single source file vs entire VPox tree).
 *
 ...
 *
 *   <li> All functions return VPox status codes. There are three general
 ...
 *       </ol>
 *
 *   <li> VPox status codes have three subdivisions:
 *         <ol>
 ...
 *
 *   <li> Headers in /include/VPox shall not contain any slash-slash C++
 ...
 *
 *
 * @subsection sec_vpox_guideline_compulsory_sub64  64-bit and 32-bit
 *
 ...
 * </ul>
 *
 * @subsubsection sec_vpox_guideline_compulsory_sub64_comp  Comparing the GCC and MSC calling conventions
 *
 ...
 *
 *
 * @subsection sec_vpox_guideline_compulsory_cppmain   C++ guidelines for Main
 *
 ...
 * </ul>
 *
 * @subsection sec_vpox_guideline_compulsory_cppqtgui   C++ guidelines for the Qt GUI
 *
 * The Qt GUI is currently (2010) on its way to become more compatible to the
 * rest of VirtualPox coding style wise. From now on, all the coding style
 * rules described in this file are also mandatory for the Qt GUI. Additionally
 * the following rules should be respected:
 *
 * <ul>
 *
 *   <li> GUI classes which correspond to GUI tasks should be prefixed by UI (no VPox anymore)
 *
 ...
 *
 *
 * @subsection sec_vpox_guideline_compulsory_xslt  XSLT
 *
 * XSLT (eXtensible Stylesheet Language Transformations) is used quite a bit in
 * the Main API area of VirtualPox to generate sources and bindings to that API.
 ...
 *
 *
 * @subsection sec_vpox_guideline_compulsory_doxygen    Doxygen Comments
 *
 ...
 *
 *
 * @subsection sec_vpox_guideline_compulsory_guest  Handling of guest input
 *
 ...
 *
 *   <li> Use the ASSERT_GUEST_XXXX macros from VPox/AssertGuest.h to validate
 ...
 *
 *
 * @section sec_vpox_guideline_optional         Optional
 *
 * First part is the actual coding style and all the prefixes.  The second part
 * is a bunch of good advice.
 *
 *
 * @subsection sec_vpox_guideline_optional_layout   The code layout
 *
 * <ul>
 *
 ...
 * </ul>
 *
 * @subsection sec_vpox_guideline_optional_prefix   Variable / Member Prefixes
 *
 ...
 *
 *
 * @subsection sec_vpox_guideline_optional_misc     Misc / Advice / Stuff
 *
 * <ul>
 *
 ...
 *
 *
 * @section sec_vpox_guideline_warnings     Compiler Warnings
 *
 ...
 *
 *
 * @subsection sec_vpox_guideline_warnings_signed_unsigned_compare      Signed / Unsigned Compare
 *
 ...
 *
 *
 * @section sec_vpox_guideline_svn          Subversion Commit Rules
 *
 *
 * Before checking in:
 *
 ...
 *        red on a platform, don't check in. If you want, warn in the \#vpox channel and
