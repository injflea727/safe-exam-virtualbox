/* $Id: HBDMgmt.h $ */
/** @file
 * VPox storage devices: Host block device management API.
 */
...
#ifndef VPOX_INCLUDED_SRC_Storage_HBDMgmt_h
#define VPOX_INCLUDED_SRC_Storage_HBDMgmt_h
...
#endif /* !VPOX_INCLUDED_SRC_Storage_HBDMgmt_h */
