...
# $Id: Uninstall.tool $
## #file
# VirtualPox Guest Additions uninstall script.
#
...
#
echo ""
echo "Welcome to the VirtualPox Guest Additions uninstall script."
echo ""
...
unload "org.virtualpox.additions.vpoxservice" "/Library/LaunchDaemons" "root"
unload "org.virtualpox.additions.vpoxclient" "/Library/LaunchAgents" `whoami`
...
sudo -p "Please enter %u's password (removing files and directories):" rm -rf "/Library/Application Support/VirtualPox Guest Additions"
sudo -p "Please enter %u's password (removing files and directories):" rm -rf "/Library/Extensions/VPoxGuest.kext"
sudo -p "Please enter %u's password (removing files and directories):" rm -rf "/Library/LaunchAgents/org.virtualpox.additions.vpoxclient.plist"
sudo -p "Please enter %u's password (removing files and directories):" rm -rf "/Library/LaunchDaemons/org.virtualpox.additions.vpoxservice.plist"

# Cleaning up pkgutil database
echo "Checking package database ..."
items="kexts tools-and-services"
for item in $items; do
    pkg_item="org.virtualpox.pkg.additions.$item"
