...
#ifndef VPOX_INCLUDED_err_h
#define VPOX_INCLUDED_err_h
...
/** @defgroup grp_err       VPox Error Codes
 * @{
 */
 ...
 * Returned by pfnInit in VPoxService to indicated a non-fatal error that
...
/** This VirtualPox build does not support raw-mode. */
...
#define VERR_SSM_INTEGRITY_VPOX_VERSION         (-1820)
...
/** @name VPox Remote Desktop Protocol (VRDP) Status Codes
 * @{
 */
...
/** The VMMR0.r0 module version does not match VPoxVMM.dll/so/dylib.
 * If you just upgraded VirtualPox, please terminate all VMs and make sure
 * that neither VPoxNetDHCP nor VPoxNetNAT is running.  Then try again.
 * If this error persists, try re-installing VirtualPox. */
#define VERR_VMM_R0_VERSION_MISMATCH        (-2704)
/** The VMMRC.rc module version does not match VPoxVMM.dll/so/dylib.
 ...
 * to this VPox version. Either mixing incompatible versions or
 ...
 *
 * If you have upgraded VirtualPox recently, please make sure you have
 * terminated all VMs and upgraded any extension packs.  If this error
 * persists, try re-installing VirtualPox. */
...
/** @name VPox HDD Container (VD) Status Codes
 * @{
 */
/** Invalid image type. */
...
/** @name VPox Guest Library (VBGL) Status Codes
 * @{
 */
...
/** IOCtl to VPoxGuest driver failed. */
#define VERR_VBGL_IOCTL_FAILED                      (-3302)
/** @} */


/** @name VPox USB (VUSB) Status Codes
 * @{
 */
...
/** The VM process was denied access to vpoxdrv because someone have managed to
...
/** The process trying to open VPoxDrv is not a budding VM process (1). */
#define VERR_SUPDRV_NOT_BUDDING_VM_PROCESS_1        (-3748)
/** The process trying to open VPoxDrv is not a budding VM process (2). */
...
/** CPU was incorrectly left in VMX root mode; incompatible with VirtualPox */
...
/** @name VPox Disassembler Status Codes
 * @{
 */
...
/** @name VPox Webservice Status Codes
 * @{
 */
...
/** @name VPox Video HW Acceleration command status
 * @{
 */
...
/** @name VPox COM error codes
 *
 * @remarks Global::vpoxStatusCodeToCOM and Global::vpoxStatusCodeFromCOM uses
...
/** The base of the VirtualPox COM status codes (the lower value)
 * corresponding 1:1 to VPOX_E_XXX.  This is the lowest value. */
#define VERR_COM_VPOX_LOWEST                        (-4699)
/** Object corresponding to the supplied arguments does not exist. */
#define VERR_COM_OBJECT_NOT_FOUND                   (VERR_COM_VPOX_LOWEST + 1)
/** Current virtual machine state prevents the operation. */
#define VERR_COM_INVALID_VM_STATE                   (VERR_COM_VPOX_LOWEST + 2)
/** Virtual machine error occurred attempting the operation. */
#define VERR_COM_VM_ERROR                           (VERR_COM_VPOX_LOWEST + 3)
/** File not accessible or erroneous file contents. */
#define VERR_COM_FILE_ERROR                         (VERR_COM_VPOX_LOWEST + 4)
/** IPRT error. */
#define VERR_COM_IPRT_ERROR                         (VERR_COM_VPOX_LOWEST + 5)
/** Pluggable Device Manager error. */
#define VERR_COM_PDM_ERROR                          (VERR_COM_VPOX_LOWEST + 6)
/** Current object state prohibits operation. */
#define VERR_COM_INVALID_OBJECT_STATE               (VERR_COM_VPOX_LOWEST + 7)
/** Host operating system related error. */
#define VERR_COM_HOST_ERROR                         (VERR_COM_VPOX_LOWEST + 8)
/** Requested operation is not supported. */
#define VERR_COM_NOT_SUPPORTED                      (VERR_COM_VPOX_LOWEST + 9)
/** Invalid XML found. */
#define VERR_COM_XML_ERROR                          (VERR_COM_VPOX_LOWEST + 10)
/** Current session state prohibits operation. */
#define VERR_COM_INVALID_SESSION_STATE              (VERR_COM_VPOX_LOWEST + 11)
/** Object being in use prohibits operation. */
#define VERR_COM_OBJECT_IN_USE                      (VERR_COM_VPOX_LOWEST + 12)
/** Returned by callback methods which does not need to be called
 * again because the client does not actually make use of them. */
#define VERR_COM_DONT_CALL_AGAIN                    (VERR_COM_VPOX_LOWEST + 13)
/** @} */

/** @name VPox VMMDev Status codes
 * @{
 */
...
/** @name VPox async I/O manager Status Codes
 * @{
 */
...
/** @name VPox Virtual SCSI Status Codes
 * @{
 */
 ...
 * disabled for the VirtualPox VM processes.
...
/** Stub process not found so it cannot be revalidated when vpoxdrv is opened
 * by the VM process. */
#define VERR_SUP_VP_STUB_NOT_FOUND                  (-5669)
/** Error opening the stub process for revalidation when vpoxdrv is opened by
 *  the VM process. */
#define VERR_SUP_VP_STUB_OPEN_ERROR                 (-5670)
/** Stub process thread not found during revalidation upon vpoxdrv opening by
 * the VM process. */
#define VERR_SUP_VP_STUB_THREAD_NOT_FOUND           (-5671)
/** Error opening the stub process thread for revalidation when vpoxdrv is
...
/** @name VPox Extension Pack Status Codes
 * @{
 */
/** The host is not supported. Uninstall the extension pack.
 * Returned by the VPOXEXTPACKREG::pfnInstalled. */
#define VERR_EXTPACK_UNSUPPORTED_HOST_UNINSTALL     (-6000)
/** The VirtualPox version is not supported by one of the extension packs.
 *
 * You have probably upgraded VirtualPox recently.  Please upgrade the
 * extension packs to versions compatible with this VirtualPox release.
 */
#define VERR_EXTPACK_VPOX_VERSION_MISMATCH          (-6001)
/** @} */


/** @name VPox Guest Control Status Codes
 * @{
 */
...
/** @name VPox Drag and Drop Status Codes
 * @{
 */
/** Guest side reported an error. */
