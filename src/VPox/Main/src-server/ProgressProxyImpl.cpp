...
/** @file
 * IProgress implementation for Machine::openRemoteSession in VPoxSVC.
 */
        ...
        else
        {
            ...
            if (fCompleted)
            {
                ...
                else
                {
                    ...
                    ComPtr<IVirtualPoxErrorInfo> ptrErrorInfo;
...
STDMETHODIMP ProgressProxy::COMGETTER(ErrorInfo)(IVirtualPoxErrorInfo **aErrorInfo)
{
    /* Not proxied since we EXPECT a normal completion notification call. */
