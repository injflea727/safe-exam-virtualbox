/* $Id: UIDetailsSet.cpp $ */
/** @file
 * VPox Qt GUI - UIDetailsSet class implementation.
 */
...
void UIDetailsSet::prepareConnections()
{
    ...
    connect(gVPoxEvents, &UIVirtualPoxEventHandler::sigMachineStateChange, this, &UIDetailsSet::sltMachineStateChange);
    connect(gVPoxEvents, &UIVirtualPoxEventHandler::sigMachineDataChange, this, &UIDetailsSet::sltMachineAttributesChange);
    connect(gVPoxEvents, &UIVirtualPoxEventHandler::sigSessionStateChange, this, &UIDetailsSet::sltMachineAttributesChange);
    connect(gVPoxEvents, &UIVirtualPoxEventHandler::sigSnapshotTake, this, &UIDetailsSet::sltMachineAttributesChange);
    connect(gVPoxEvents, &UIVirtualPoxEventHandler::sigSnapshotDelete, this, &UIDetailsSet::sltMachineAttributesChange);
    connect(gVPoxEvents, &UIVirtualPoxEventHandler::sigSnapshotChange, this, &UIDetailsSet::sltMachineAttributesChange);
    connect(gVPoxEvents, &UIVirtualPoxEventHandler::sigSnapshotRestore, this, &UIDetailsSet::sltMachineAttributesChange);
