...
#if defined(VPOX_AUDIO_MIX_BUFFER_TESTCASE) && !defined(RT_STRICT)
...
#elif defined(VPOX_AUDIO_TESTCASE_VERBOSE) /* Warning: VPOX_AUDIO_TESTCASE_VERBOSE will generate huge logs! */
