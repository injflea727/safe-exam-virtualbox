...
#ifndef VPOX_INCLUDED_vmm_gvmm_h
#define VPOX_INCLUDED_vmm_gvmm_h
 ...
 */
#ifdef IN_GVMM_R0
# define GVMMR0DECL(type)    DECLEXPORT(type) VPOXCALL
#else
# define GVMMR0DECL(type)    DECLIMPORT(type) VPOXCALL
#endif
...
#endif /* !VPOX_INCLUDED_vmm_gvmm_h */
