 ...
 *  extracted from the VirtualPox XML Schema (VirtualPox-settings-*.xsd).
 ...
 *  DO NOT EDIT.
 *
 *  This header is automatically generated from the VirtualPox XML Settings
 ...
 *  DO NOT EDIT.
 *
 *  This source is automatically generated from the VirtualPox XML Settings
