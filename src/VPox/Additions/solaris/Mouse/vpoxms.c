/* $Id: vpoxms.c $ */
/** @file
 * VirtualPox Guest Additions Mouse Driver for Solaris.
 */
...
/** The module name. */
#define DEVICE_NAME              "vpoxms"
/** The module description as seen in 'modinfo'. */
#define DEVICE_DESC              "VPoxMouseIntegr"
...
/**
 * Notification callback, called when the VPoxGuest mouse pointer is moved.
...
{
    RTTEST hTest;
    int rc = RTTestInitAndCreate("tstVPoxGuest-solaris", &hTest);
    if (rc)
        return rc;
    RTTestBanner(hTest);
    test_init(hTest);
