...
/** @file
 * VPox Console VRDE Server Helper class and implementation of IVRDEServerInfo
 */
...
#include <VPox/RemoteDesktop/VRDEImage.h>
#include <VPox/RemoteDesktop/VRDEMousePtr.h>
#include <VPox/RemoteDesktop/VRDESCard.h>
#include <VPox/RemoteDesktop/VRDETSMF.h>
#define VRDE_VIDEOIN_WITH_VRDEINTERFACE /* Get the VRDE interface definitions. */
#include <VPox/RemoteDesktop/VRDEVideoIn.h>
#include <VPox/RemoteDesktop/VRDEInput.h>
