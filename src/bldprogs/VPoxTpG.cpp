/* $Id: VPoxTpG.cpp $ */
/** @file
 * VPox Build Tool - VPox Tracepoint Generator.
 */
...
static enum
{
    kVPoxTpGAction_Nothing,
    kVPoxTpGAction_GenerateHeader,
    kVPoxTpGAction_GenerateWrapperHeader,
    kVPoxTpGAction_GenerateObject
}                           g_enmAction                 = kVPoxTpGAction_Nothing;
...
static RTEXITCODE generateAssembly(PSCMSTREAM pStrm)
{
    ...
    RTListForEach(&g_ProviderHead, pProvider, VTGPROVIDER, ListEntry)
    {
        RTListForEach(&pProvider->ProbeHead, pProbe, VTGPROBE, ListEntry)
        {
            ScmStreamPrintf(pStrm,
                            "\n"
                            "VTG_GLOBAL VTGProbeStub_%s_%s, function; (VPOXTPGPROBELOC pVTGProbeLoc",
                            pProvider->pszName, pProbe->pszMangledName);
            RTListForEach(&pProbe->ArgHead, pArg, VTGARG, ListEntry)
            {
...
#define MY_STRMATCH(a_sz)  (cchType == sizeof(a_sz) - 1 && !memcmp(a_sz, pszType, sizeof(a_sz) - 1))
    ...
    RTMsgError("Don't know '%s' - please change or fix VPoxTpG", pszType);
    g_cTypeErrors++;
            ...
            )
        {
            ...
            else
            {
                ...
                if (!strcmp(pArg->pszTracerType, "struct CPUMCTX *")|| !strcmp(pArg->pszTracerType, "PCPUMCTX"))
                    ...
                    pArg->pszArgPassingFmt = ", VPoxTpG-Is-Buggy!!";
            }
        }
        else
        {
...
static RTEXITCODE parseArguments(int argc,  char **argv)
{
    ...
    enum
    {
        kVPoxTpGOpt_32Bit = 1000,
        kVPoxTpGOpt_64Bit,
        kVPoxTpGOpt_GenerateWrapperHeader,
        kVPoxTpGOpt_Assembler,
        kVPoxTpGOpt_AssemblerFmtOpt,
        kVPoxTpGOpt_AssemblerFmtVal,
        kVPoxTpGOpt_AssemblerOutputOpt,
        kVPoxTpGOpt_AssemblerOption,
        kVPoxTpGOpt_Pic,
        kVPoxTpGOpt_ProbeFnName,
        kVPoxTpGOpt_ProbeFnImported,
        kVPoxTpGOpt_ProbeFnNotImported,
        kVPoxTpGOpt_Host32Bit,
        kVPoxTpGOpt_Host64Bit,
        kVPoxTpGOpt_RawModeContext,
        kVPoxTpGOpt_Ring0Context,
        kVPoxTpGOpt_Ring0ContextAgnostic,
        kVPoxTpGOpt_Ring3Context,
        kVPoxTpGOpt_End
    };
    ...
    static RTGETOPTDEF const s_aOpts[] =
    {
        ...
        { "-32",                                kVPoxTpGOpt_32Bit,                      RTGETOPT_REQ_NOTHING },
        { "-64",                                kVPoxTpGOpt_64Bit,                      RTGETOPT_REQ_NOTHING },
        ...
        /* our stuff */
        { "--generate-wrapper-header",          kVPoxTpGOpt_GenerateWrapperHeader,      RTGETOPT_REQ_NOTHING },
        { "--assembler",                        kVPoxTpGOpt_Assembler,                  RTGETOPT_REQ_STRING  },
        { "--assembler-fmt-opt",                kVPoxTpGOpt_AssemblerFmtOpt,            RTGETOPT_REQ_STRING  },
        { "--assembler-fmt-val",                kVPoxTpGOpt_AssemblerFmtVal,            RTGETOPT_REQ_STRING  },
        { "--assembler-output-opt",             kVPoxTpGOpt_AssemblerOutputOpt,         RTGETOPT_REQ_STRING  },
        { "--assembler-option",                 kVPoxTpGOpt_AssemblerOption,            RTGETOPT_REQ_STRING  },
        { "--pic",                              kVPoxTpGOpt_Pic,                        RTGETOPT_REQ_NOTHING },
        { "--probe-fn-name",                    kVPoxTpGOpt_ProbeFnName,                RTGETOPT_REQ_STRING  },
        { "--probe-fn-imported",                kVPoxTpGOpt_ProbeFnImported,            RTGETOPT_REQ_NOTHING },
        { "--probe-fn-not-imported",            kVPoxTpGOpt_ProbeFnNotImported,         RTGETOPT_REQ_NOTHING },
        { "--host-32-bit",                      kVPoxTpGOpt_Host32Bit,                  RTGETOPT_REQ_NOTHING },
        { "--host-64-bit",                      kVPoxTpGOpt_Host64Bit,                  RTGETOPT_REQ_NOTHING },
        { "--raw-mode-context",                 kVPoxTpGOpt_RawModeContext,             RTGETOPT_REQ_NOTHING },
        { "--ring-0-context",                   kVPoxTpGOpt_Ring0Context,               RTGETOPT_REQ_NOTHING },
        { "--ring-0-context-agnostic",          kVPoxTpGOpt_Ring0ContextAgnostic,       RTGETOPT_REQ_NOTHING },
        { "--ring-3-context",                   kVPoxTpGOpt_Ring3Context,               RTGETOPT_REQ_NOTHING },
    ...
    while ((rc = RTGetOpt(&GetOptState, &ValueUnion)) != 0)
    {
        switch (rc)
        {
            ...
            case 'G':
                if (   g_enmAction != kVPoxTpGAction_Nothing
                    && g_enmAction != kVPoxTpGAction_GenerateObject)
            ...
            case 'h':
                ...
                {
                    if (   g_enmAction != kVPoxTpGAction_Nothing
                        && g_enmAction != kVPoxTpGAction_GenerateHeader)
                ...
                {
                    /* --help or similar */
                    RTPrintf("VirtualPox Tracepoint Generator\n"
                             "\n"
                             "Usage: %s [options]\n"
                             "\n"
                             "Options:\n", RTProcShortName());
            ...
            case VINF_GETOPT_NOT_OPTION:
                if (g_enmAction == kVPoxTpGAction_GenerateObject)
             ...
             * Our options.
             */
            case kVPoxTpGOpt_GenerateWrapperHeader:
                if (   g_enmAction != kVPoxTpGAction_Nothing
                    && g_enmAction != kVPoxTpGAction_GenerateWrapperHeader)
                    return RTMsgErrorExit(RTEXITCODE_SYNTAX, "--generate-wrapper-header does not mix with -h or -G");
                g_enmAction = kVPoxTpGAction_GenerateWrapperHeader;
                break;

            case kVPoxTpGOpt_Assembler:
                g_pszAssembler = ValueUnion.psz;
                break;

            case kVPoxTpGOpt_AssemblerFmtOpt:
                g_pszAssemblerFmtOpt = ValueUnion.psz;
                break;

            case kVPoxTpGOpt_AssemblerFmtVal:
                g_pszAssemblerFmtVal = ValueUnion.psz;
                break;

            case kVPoxTpGOpt_AssemblerOutputOpt:
                g_pszAssemblerOutputOpt = ValueUnion.psz;
                break;

            case kVPoxTpGOpt_AssemblerOption:
            ...
            case kVPoxTpGOpt_Pic:
                g_fPic = true;
                break;

            case kVPoxTpGOpt_ProbeFnName:
                g_pszProbeFnName = ValueUnion.psz;
                break;

            case kVPoxTpGOpt_ProbeFnImported:
                g_fProbeFnImported = true;
                break;

            case kVPoxTpGOpt_ProbeFnNotImported:
                g_fProbeFnImported = false;
                break;

            case kVPoxTpGOpt_Host32Bit:
                g_cHostBits = 32;
                break;

            case kVPoxTpGOpt_Host64Bit:
                g_cHostBits = 64;
                break;

            case kVPoxTpGOpt_RawModeContext:
                g_fTypeContext = VTG_TYPE_CTX_RC;
                g_pszContextDefine = "IN_RC";
                g_pszContextDefine2 = NULL;
                break;

            case kVPoxTpGOpt_Ring0Context:
                g_fTypeContext = VTG_TYPE_CTX_R0;
                g_pszContextDefine = "IN_RING0";
                g_pszContextDefine2 = NULL;
                break;

            case kVPoxTpGOpt_Ring0ContextAgnostic:
                g_fTypeContext = VTG_TYPE_CTX_R0;
                g_pszContextDefine = "IN_RING0_AGNOSTIC";
                g_pszContextDefine2 = "IN_RING0";
                break;

            case kVPoxTpGOpt_Ring3Context:
...
int main(int argc, char **argv)
{
    ...
    if (rcExit == RTEXITCODE_SUCCESS)
    {
        ...
        if (rcExit == RTEXITCODE_SUCCESS)
        {
             ...
             * Take action.
             */
            if (g_enmAction == kVPoxTpGAction_GenerateHeader)
                rcExit = generateFile(g_pszOutput, "header", generateHeader);
            else if (g_enmAction == kVPoxTpGAction_GenerateWrapperHeader)
