...
#define  VPOXGUEST_VIDEO_NAME    "VPoxVideo"

/** The video inf file name */
#define  VPOXGUEST_VIDEO_INF_NAME    "VPoxVideo.inf"
...
BOOL installVideoDriver(TCHAR* szDriverDir)
{
  ...
  wsprintf(DeviceInstallParams.DriverPath,
           TEXT("%ws\\%ws"),
           szDriverDir, TEXT(VPOXGUEST_VIDEO_INF_NAME));
...
{
    printf("Installs VirtualPox Guest Additions for Windows NT 4.0\n\n");
    printf("Syntax: %s [/i|/u]\n", programName);
