...
#ifndef VPOX_INCLUDED_GuestHost_GuestControl_h
#define VPOX_INCLUDED_GuestHost_GuestControl_h
 ...
 * @{
 */
#define OUTPUT_HANDLE_ID_STDOUT_DEPRECATED  0 /**< Needed for VPox hosts < 4.1.0. */
...
/** @name Internal tools built into VPoxService which are used in order
 *        to accomplish tasks host<->guest.
 * @{
 */
#define VPOXSERVICE_TOOL_CAT        "vpox_cat"
#define VPOXSERVICE_TOOL_LS         "vpox_ls"
#define VPOXSERVICE_TOOL_RM         "vpox_rm"
#define VPOXSERVICE_TOOL_MKDIR      "vpox_mkdir"
#define VPOXSERVICE_TOOL_MKTEMP     "vpox_mktemp"
#define VPOXSERVICE_TOOL_STAT       "vpox_stat"
/** @} */

/** Special process exit codes for "vpox_cat". */
typedef enum VPOXSERVICETOOLBOX_CAT_EXITCODE
{
    VPOXSERVICETOOLBOX_CAT_EXITCODE_ACCESS_DENIED = RTEXITCODE_END,
    VPOXSERVICETOOLBOX_CAT_EXITCODE_FILE_NOT_FOUND,
    VPOXSERVICETOOLBOX_CAT_EXITCODE_PATH_NOT_FOUND,
    VPOXSERVICETOOLBOX_CAT_EXITCODE_SHARING_VIOLATION,
    VPOXSERVICETOOLBOX_CAT_EXITCODE_IS_A_DIRECTORY,
    /** The usual 32-bit type hack. */
    VPOXSERVICETOOLBOX_CAT_32BIT_HACK = 0x7fffffff
} VPOXSERVICETOOLBOX_CAT_EXITCODE;

/** Special process exit codes for "vpox_stat". */
typedef enum VPOXSERVICETOOLBOX_STAT_EXITCODE
{
    VPOXSERVICETOOLBOX_STAT_EXITCODE_ACCESS_DENIED = RTEXITCODE_END,
    VPOXSERVICETOOLBOX_STAT_EXITCODE_FILE_NOT_FOUND,
    VPOXSERVICETOOLBOX_STAT_EXITCODE_PATH_NOT_FOUND,
    VPOXSERVICETOOLBOX_STAT_EXITCODE_NET_PATH_NOT_FOUND,
    VPOXSERVICETOOLBOX_STAT_EXITCODE_INVALID_NAME,
    /** The usual 32-bit type hack. */
    VPOXSERVICETOOLBOX_STAT_32BIT_HACK = 0x7fffffff
} VPOXSERVICETOOLBOX_STAT_EXITCODE;
...
#endif /* !VPOX_INCLUDED_GuestHost_GuestControl_h */
