...
#ifndef VPOX_INCLUDED_SRC_vpoximg_mount_vpoximgCrypto_h
#define VPOX_INCLUDED_SRC_vpoximg_mount_vpoximgCrypto_h
...
#endif /* !VPOX_INCLUDED_SRC_vpoximg_mount_vpoximgCrypto_h */
