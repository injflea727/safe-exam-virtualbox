...
#ifndef GA_INCLUDED_3D_WIN_VPoxGaHwSVGA_h
#define GA_INCLUDED_3D_WIN_VPoxGaHwSVGA_h
...
/*
 * VPOXGAHWINFOSVGA contains information about the virtual hardware, which is neede dy the user mode
 ...
 *
 * VPOXGAHWINFOSVGA struct goes both to 32 and 64 bit user mode binaries, take care of alignment.
 */
#pragma pack(1)
typedef struct VPOXGAHWINFOSVGA
{
    uint32_t cbInfoSVGA;
...
#endif /* !GA_INCLUDED_3D_WIN_VPoxGaHwSVGA_h */
