/* $Id: VPoxManageHostonly.cpp $ */
/** @file
 * VPoxManage - Implementation of hostonlyif command.
 */
...
#if defined(VPOX_WITH_NETFLT) && !defined(RT_OS_SOLARIS)
static RTEXITCODE handleCreate(HandlerArg *a)
{
     ...
     */
    ComPtr<IHost> host;
    CHECK_ERROR2I_RET(a->virtualPox, COMGETTER(Host)(host.asOutParam()), RTEXITCODE_FAILURE);
