...
#ifndef VPOX_INCLUDED_com_AutoLock_h
#define VPOX_INCLUDED_com_AutoLock_h
...
# define VPOX_WITH_MAIN_LOCK_VALIDATION
 ...
 * LockHandle classes.
 */
enum VPoxLockingClass
{
    LOCKCLASS_NONE = 0,
    LOCKCLASS_WEBSERVICE = 1,               // highest order: webservice locks
    LOCKCLASS_VIRTUALPOXOBJECT = 2,         // highest order within Main itself: VirtualPox object lock
    LOCKCLASS_HOSTOBJECT = 3,               // Host object lock
    LOCKCLASS_LISTOFMACHINES = 4,           // list of machines in VirtualPox object
    ...
    LOCKCLASS_LISTOFMEDIA = 8,              // list of media (hard disks, DVDs, floppies) in VirtualPox object
    LOCKCLASS_LISTOFOTHEROBJECTS = 9,       // any other list of objects
    LOCKCLASS_OTHEROBJECT = 10,             // any regular object member variable lock
    LOCKCLASS_PROGRESSLIST = 11,            // list of progress objects in VirtualPox; no other object lock
 ...
 */
bool AutoLockHoldsLocksInClass(VPoxLockingClass lockClass);
...
#ifdef VPOX_WITH_MAIN_LOCK_VALIDATION
...
{
public:
    RWLockHandle(VPoxLockingClass lockClass);
...
{
public:
    WriteLockHandle(VPoxLockingClass lockClass);
 ...
 * practice means any VirtualPoxBase derivative), it autoamtically requests
...
#endif /* !VPOX_INCLUDED_com_AutoLock_h */
