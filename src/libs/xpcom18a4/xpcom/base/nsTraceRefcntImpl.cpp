...
#if defined(_WIN32)
#include <windows.h>
#elif defined(linux) && !defined(VPOX) && defined(__GLIBC__) && (defined(__i386) || defined(PPC))
#include <setjmp.h>
...
#elif (defined(linux) && !defined(VPOX) && defined(__GLIBC__) && (defined(__i386) || defined(PPC))) || (defined(__sun) && (defined(__sparc) || defined(sparc) || defined(__i386) || defined(i386)))
