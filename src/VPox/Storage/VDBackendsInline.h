...
#ifndef VPOX_INCLUDED_SRC_Storage_VDBackendsInline_h
#define VPOX_INCLUDED_SRC_Storage_VDBackendsInline_h
...
#endif /* !VPOX_INCLUDED_SRC_Storage_VDBackendsInline_h */
