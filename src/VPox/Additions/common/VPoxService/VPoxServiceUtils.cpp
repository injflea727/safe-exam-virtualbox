/* $Id: VPoxServiceUtils.cpp $ */
/** @file
 * VPoxServiceUtils - Some utility functions.
 */
 ...
 * logging.
 *
 * @returns VPox status code. Errors will be logged.
 *
 * @param   u32ClientId     The HGCM client ID for the guest property session.
 ...
 *
 * @returns VPox status code.  The output buffer is always valid and the status
