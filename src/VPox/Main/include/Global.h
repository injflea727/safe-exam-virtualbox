/* $Id: Global.h $ */
/** @file
 * VirtualPox COM API - Global Declarations and Definitions.
 */
...
#define VPOXOSHINT_NONE                 0
#define VPOXOSHINT_64BIT                RT_BIT(0)
#define VPOXOSHINT_HWVIRTEX             RT_BIT(1)
#define VPOXOSHINT_IOAPIC               RT_BIT(2)
#define VPOXOSHINT_EFI                  RT_BIT(3)
#define VPOXOSHINT_PAE                  RT_BIT(4)
#define VPOXOSHINT_USBHID               RT_BIT(5)
#define VPOXOSHINT_HPET                 RT_BIT(6)
#define VPOXOSHINT_USBTABLET            RT_BIT(7)
#define VPOXOSHINT_RTCUTC               RT_BIT(8)
#define VPOXOSHINT_ACCEL2D              RT_BIT(9)
#define VPOXOSHINT_ACCEL3D              RT_BIT(10)
#define VPOXOSHINT_FLOPPY               RT_BIT(11)
#define VPOXOSHINT_NOUSB                RT_BIT(12)
#define VPOXOSHINT_TFRESET              RT_BIT(13)
#define VPOXOSHINT_USB3                 RT_BIT(14)
#define VPOXOSHINT_X2APIC               RT_BIT(15)

/** The VPoxVRDP kludge extension pack name.
 *
 * This is not a valid extension pack name (dashes are not allowed), and
 * hence will not conflict with real extension packs.
 */
#define VPOXVRDP_KLUDGE_EXTPACK_NAME    "Built-in-VPoxVRDP"
...
public:
    ...
    /**
     * Maps VPOXOSTYPE to the OS type which is used in VM configs.
     */
    static const char *OSTypeId(VPOXOSTYPE aOSType);
    ...
    /**
     * Try convert a COM status code to a VirtualPox status code (VPox/err.h).
     *
     * @returns VPox status code.
     * @param   aComStatus      COM status code.
     */
    static int vpoxStatusCodeFromCOM(HRESULT aComStatus);

    /**
     * Try convert a VirtualPox status code (VPox/err.h) to a COM status code.
     *
     * This is mainly intended for dealing with vpoxStatusCodeFromCOM() return
     * values.  If used on anything else, it won't be able to cope with most of the
     * input!
     *
     * @returns COM status code.
     * @param   aVPoxStatus      VPox status code.
     */
    static HRESULT vpoxStatusCodeToCOM(int aVPoxStatus);
};
