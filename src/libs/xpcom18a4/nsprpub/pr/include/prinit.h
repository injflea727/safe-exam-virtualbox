...
#define PR_Abort VPoxNsprPR_Abort
#define PR_Cleanup VPoxNsprPR_Cleanup
#define PR_DisableClockInterrupts VPoxNsprPR_DisableClockInterrupts
#define PR_EnableClockInterrupts VPoxNsprPR_EnableClockInterrupts
#define PR_BlockClockInterrupts VPoxNsprPR_BlockClockInterrupts
#define PR_UnblockClockInterrupts VPoxNsprPR_UnblockClockInterrupts
#define PR_Init VPoxNsprPR_Init
#define PR_Initialize VPoxNsprPR_Initialize
#define PR_Initialized VPoxNsprPR_Initialized
#define PR_VersionCheck VPoxNsprPR_VersionCheck
#define PR_SetConcurrency VPoxNsprPR_SetConcurrency
#define PR_SetFDCacheSize VPoxNsprPR_SetFDCacheSize
#define PR_ProcessExit VPoxNsprPR_ProcessExit
#define PR_CallOnce VPoxNsprPR_CallOnce
#define PR_CallOnceWithArg VPoxNsprPR_CallOnceWithArg
