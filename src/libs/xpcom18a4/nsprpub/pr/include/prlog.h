...
#define PR_NewLogModule VPoxNsprPR_NewLogModule
#define PR_SetLogFile VPoxNsprPR_SetLogFile
#define PR_SetLogBuffering VPoxNsprPR_SetLogBuffering
#define PR_LogPrint VPoxNsprPR_LogPrint
#define PR_LogFlush VPoxNsprPR_LogFlush
#define PR_Assert VPoxNsprPR_Assert
