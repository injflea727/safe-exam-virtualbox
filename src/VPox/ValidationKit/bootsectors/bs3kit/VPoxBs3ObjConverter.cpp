/* $Id: VPoxBs3ObjConverter.cpp $ */
/** @file
 * VirtualPox Validation Kit - Boot Sector 3 object file convert.
 */
...
{
    fprintf(stderr,
            "VPoxBs3ObjConverter: assertion failed in %s (%s:%u)!\n"
            "VPoxBs3ObjConverter: %s\n",
