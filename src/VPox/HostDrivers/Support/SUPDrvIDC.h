/* $Id: SUPDrvIDC.h $ */
/** @file
 * VirtualPox Support Driver - Inter-Driver Communication (IDC) definitions.
 */
...
#ifndef VPOX_INCLUDED_SRC_Support_SUPDrvIDC_h
#define VPOX_INCLUDED_SRC_Support_SUPDrvIDC_h
...
# ifdef IN_SUP_R0
extern DECLEXPORT(int) VPOXCALL SUPDrvDarwinIDC(uint32_t iReq, PSUPDRVIDCREQHDR pReq);
# else
extern DECLIMPORT(int) VPOXCALL SUPDrvDarwinIDC(uint32_t iReq, PSUPDRVIDCREQHDR pReq);
# endif

#elif defined(RT_OS_FREEBSD)
extern int VPOXCALL SUPDrvFreeBSDIDC(uint32_t iReq, PSUPDRVIDCREQHDR pReq);

#elif defined(RT_OS_LINUX)
extern int VPOXCALL SUPDrvLinuxIDC(uint32_t iReq, PSUPDRVIDCREQHDR pReq);

#elif defined(RT_OS_OS2)
/** @todo Port to OS/2. */

#elif defined(RT_OS_SOLARIS)
extern int VPOXCALL SUPDrvSolarisIDC(uint32_t iReq, PSUPDRVIDCREQHDR pReq);
 ...
 *
 * @returns VPox status code indicating the validity of the session, request and
...
#endif /* !VPOX_INCLUDED_SRC_Support_SUPDrvIDC_h */
