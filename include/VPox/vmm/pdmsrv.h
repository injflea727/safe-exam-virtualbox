...
#ifndef VPOX_INCLUDED_vmm_pdmsrv_h
#define VPOX_INCLUDED_vmm_pdmsrv_h
 ...
 * VPoxServicesRegister() (HC Ring-3). PDM will continue use till
...
/** Pointer to callbacks provided to the VPoxServiceRegister() call. */
typedef struct PDMSRVREGCB *PPDMSRVREGCB;

/**
 * Callbacks for VPoxServiceRegister().
 */
...
/**
 * The VPoxServicesRegister callback function.
 *
 ...
 */
typedef DECLCALLBACK(int) FNPDMVPOXSERVICESREGISTER(PPDMSRVREGCB pCallbacks, uint32_t u32Version);
...
#endif /* !VPOX_INCLUDED_vmm_pdmsrv_h */
