...
## @file
# VirtualPox Validation Kit - TestBoxScript Service Setup on Solaris.
#
...
MY_SVC_FMRI="svc:/system/virtualpox/testboxscript"
...
<service_bundle type='manifest' name='export'>
    <service name='system/virtualpox/testboxscript' type='service' version='1'>
...
EOF
    ...
    cat >> "${MY_SVC_TMP}" <<EOF
        ...
        <template>
            <common_name>
                <loctext xml:lang='C'>VirtualPox TestBox Script</loctext>
            </common_name>
        </template>
    </service>
</service_bundle>
