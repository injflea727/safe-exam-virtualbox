/* $Id: VPoxGuestR3LibGuestUser.cpp $ */
/** @file
 * VPoxGuestR3Lib - Ring-3 Support Library for VirtualPox guest additions,
                                           ...
                                           uint8_t *puDetails, uint32_t cbDetails)
{
    ...
    if (RT_SUCCESS(rc))
    {
         ...
         */
        uint32_t cbOffDynamic = RT_UOFFSETOF(VPoxGuestUserStatus, szUser);
