...
#ifndef VPOX_INCLUDED_SRC_bldprogs_scm_h
#define VPOX_INCLUDED_SRC_bldprogs_scm_h
...
typedef enum SCMLICENSE
{
    ...
    kScmLicense_OseGpl,             /**< VPox OSE GPL if public. */
    kScmLicense_OseDualGplCddl,     /**< VPox OSE dual GPL & CDDL if public. */
    kScmLicense_OseCddl,            /**< VPox OSE CDDL if public. */
...
#endif /* !VPOX_INCLUDED_SRC_bldprogs_scm_h */
