...
#ifndef VPOX_INCLUDED_SRC_testcase_tstDeviceInternal_h
#define VPOX_INCLUDED_SRC_testcase_tstDeviceInternal_h
...
typedef struct TSTDEVDUTINT
{
    ...
    TSTDEVDUTPCIREGION              aPciRegions[VPOX_PCI_NUM_REGIONS];
} TSTDEVDUTINT;
...
#endif /* !VPOX_INCLUDED_SRC_testcase_tstDeviceInternal_h */
