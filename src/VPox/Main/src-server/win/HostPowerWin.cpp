...
*   Global Variables                                                                                                             *
*********************************************************************************************************************************/
static WCHAR gachWindowClassName[] = L"VPoxPowerNotifyClass";


HostPowerServiceWin::HostPowerServiceWin(VirtualPox *aVirtualPox) : HostPowerService(aVirtualPox), mThread(NIL_RTTHREAD)
{
    mHwnd = 0;
