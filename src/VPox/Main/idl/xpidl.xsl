 ...
 *
 *  XPCOM IDL (XPIDL) definition for VirtualPox Main API (COM interfaces)
 *  generated from XIDL (XML interface definition).
 *
 *  Source    : src/VPox/Main/idl/VirtualPox.xidl
 *  Generator : src/VPox/Main/idl/xpidl.xsl
 */
...
<xsl:template match="library">
  <xsl:text>%{C++&#x0A;</xsl:text>
  <xsl:text>#ifndef VPOX_EXTERN_C&#x0A;</xsl:text>
  <xsl:text># ifdef __cplusplus&#x0A;</xsl:text>
  <xsl:text>#  define VPOX_EXTERN_C extern "C"&#x0A;</xsl:text>
  <xsl:text># else // !__cplusplus&#x0A;</xsl:text>
  <xsl:text>#  define VPOX_EXTERN_C extern&#x0A;</xsl:text>
  <xsl:text># endif // !__cplusplus&#x0A;</xsl:text>
  <xsl:text>#endif // !VPOX_EXTERN_C&#x0A;</xsl:text>
  <!-- result codes -->
...
<xsl:text>interface </xsl:text>
  ...
  <xsl:text>VPOX_EXTERN_C const nsID IID_</xsl:text>
  <xsl:value-of select="$name"/>
  <xsl:text>;&#x0A;</xsl:text>
  <xsl:text>%}&#x0A;&#x0A;</xsl:text>
  <!-- end -->
...
<xsl:template match="module/class">
  ...
  <xsl:text>// for compatibility with Win32&#x0A;</xsl:text>
  <xsl:text>VPOX_EXTERN_C const nsCID CLSID_</xsl:text>
  <xsl:value-of select="@name"/>
  <xsl:text>;&#x0A;</xsl:text>
  <xsl:text>%}&#x0A;&#x0A;</xsl:text>
</xsl:template>
...
%{C++
#ifndef VPOX_WITH_XPCOM_CPP_ENUM_HACK
%}
...
%{C++
      ...
      <xsl:text>#else /* VPOX_WITH_XPCOM_CPP_ENUM_HACK */
...
# endif
#endif /* VPOX_WITH_XPCOM_CPP_ENUM_HACK */
%}
...
<!-- Filters for switch off VPoxSDS definitions -->
