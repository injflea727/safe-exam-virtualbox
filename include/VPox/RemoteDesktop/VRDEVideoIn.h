/** @file
 * VPox Remote Desktop Extension (VRDE) - Video Input interface.
 */
...
#ifndef VPOX_INCLUDED_RemoteDesktop_VRDEVideoIn_h
#define VPOX_INCLUDED_RemoteDesktop_VRDEVideoIn_h
...
#ifdef VRDE_VIDEOIN_WITH_VRDEINTERFACE
/*
 * The application interface between VirtualPox and the VRDE server.
 */
...
#endif /* !VPOX_INCLUDED_RemoteDesktop_VRDEVideoIn_h */
