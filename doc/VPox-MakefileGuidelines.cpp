/* $Id: VPox-MakefileGuidelines.cpp $ */
/** @file
 * VPox - Makefile Guidelines.
 */
...
/** @page pg_vpox_makefile_guidelines      VPox Makefile Guidelines
 *
 ...
 *
 *
 * @section sec_vpox_makefile_guidelines_kbuild         kBuild
 *
 * kBuild is way older than VirtualPox, at least as a concept, but the
 * VirtualPox project was a push to get something done about it again.  It's
 ...
 *
 *
 * @section sec_vpox_makefile_guidelines_example        Example Makefiles
 *
 * Let me point to some good sample makefiles:
 *      - src/VPox/Additions/common/VPoxService/Makefile.kmk
 *      - src/VPox/Debugger/Makefile.kmk
 *      - src/VPox/Disassembler/Makefile.kmk
 *
 * And some bad ones:
 *      - src/lib/xpcom18a4/Makefile.kmk
 *      - src/recompiler/Makefile.kmk
 *      - src/VPox/Devices/Makefile.kmk
 *      - src/VPox/Main/Makefile.kmk
 *      - src/VPox/Runtime/Makefile.kmk
 *
 *
 * @section sec_vpox_makefile_guidelines                Guidelines
 *
 ...
 *
 *      - Template names starts with VPox and are camel cased, no
 *        underscores or other separators.  (Note this used to be all upper
 *        case, fixing this incomplete.)
 *
 *      - Makefile variables shall be prefixed with VPOX or VB to avoid clashes
 ...
 *
 *      - Always use templates (mytarget_TEMPLATE = VPoxSomething).
 *
 ...
 *        src/VPox/Debugger/Makefile.kmk. I.e. exactly one tab, the file name /
 ...
 *
 *
 * @section sec_vpox_makefile_guidelines_reminders      Helpful reminders
 *
 ...
 *
 *      - You can build individual targets: kmk VPoxRT
 *
