...
#ifndef VPOX_INCLUDED_vd_ifs_h
#define VPOX_INCLUDED_vd_ifs_h
...
typedef enum VDINTERFACETYPE
{
    ...
    /** Interface for I/O between the generic VPoxHDD code and the backend. Per-image (internal).
 ...
 *                          success.
 */
VPOXDDU_DECL(int) VDIfCreateVfsStream(PVDINTERFACEIO pVDIfsIo, void *pvStorage, uint32_t fFlags, PRTVFSIOSTREAM phVfsIos);
 ...
 */
VPOXDDU_DECL(int) VDIfCreateVfsFile(PVDINTERFACEIO pVDIfs, struct VDINTERFACEIOINT *pVDIfsInt, void *pvStorage,
 ...
 */
VPOXDDU_DECL(int) VDIfCreateFromVfsStream(RTVFSIOSTREAM hVfsIos, uint32_t fAccessMode, PVDINTERFACEIO *ppIoIf);
 ...
 *                          ignored.
 */
VPOXDDU_DECL(int) VDIfDestroyFromVfsStream(PVDINTERFACEIO pIoIf);
