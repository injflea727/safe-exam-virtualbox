...
#ifndef VPOX_WITHOUT_NS_ACCOUNTING
...
static DECLCALLBACK(VPOXSTRICTRC) tmR3CpuTickParavirtDisable(PVM pVM, PVMCPU pVCpu, void *pvData);
...
#ifndef VPOX_WITHOUT_NS_ACCOUNTING
# if defined(VPOX_WITH_STATISTICS) || defined(VPOX_WITH_NS_ACCOUNTING_STATS)
 ...
 *
 * @returns VPox status code, all errors are asserted.
 * @param   pVM         The cross context VM structure.
...
#endif /* !VPOX_WITHOUT_NS_ACCOUNTING */
 ...
 */
static DECLCALLBACK(VPOXSTRICTRC) tmR3CpuTickParavirtEnable(PVM pVM, PVMCPU pVCpuEmt, void *pvData)
{
 ...
 */
static DECLCALLBACK(VPOXSTRICTRC) tmR3CpuTickParavirtDisable(PVM pVM, PVMCPU pVCpuEmt, void *pvData)
{
