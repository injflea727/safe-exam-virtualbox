/** @file
 * DBGGUI - The VirtualPox Debugger GUI. (VPoxDbg)
 */
...
#ifndef VPOX_INCLUDED_dbggui_h
#define VPOX_INCLUDED_dbggui_h
...
/** @defgroup grp_dbggui    VirtualPox Debugger GUI
 * @ingroup grp_dbg
 * @{
 */
