...
/** @file
 * VPox Qt GUI - UIMachineSettingsSystem class implementation.
 */
...
void UIMachineSettingsSystem::prepareTabProcessor()
{
    ...
    const CSystemProperties properties = uiCommon().virtualPox().GetSystemProperties();
