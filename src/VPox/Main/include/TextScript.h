...
protected:
    ...
    VirtualPoxBase *mpSetError;

private: /* no default constructors for children. */
    AbstractScript() {}

public:
    AbstractScript(VirtualPoxBase *pSetError) : mpSetError(pSetError) {}
...
public:
    BaseTextScript(VirtualPoxBase *pSetError, const char *pszDefaultTemplateFilename, const char *pszDefaultFilename)
...
public:
    GeneralTextScript(VirtualPoxBase *pSetError, const char *pszDefaultTemplateFilename = NULL, const char *pszDefaultFilename = NULL)
