...
<!-- Whether to generate coclass and interfaces for VPoxSDS-->
 ...
 *
 *  MS IDL (MIDL) definition for VirtualPox Main API (COM interfaces)
 *  generated from XIDL (XML interface definition).
 *
 *  Source    : src/VPox/Main/idl/VirtualPox.xidl
 *  Generator : src/VPox/Main/idl/midl.xsl
 */
...
warning MIDL2460 : dual interface should be derived from IDispatch : IVirtualPoxErrorInfo [ Interface 'IVirtualPoxErrorInfo'  ]
    -->
...
<!-- Filters for switch on/off VPoxSDS definitions -->
