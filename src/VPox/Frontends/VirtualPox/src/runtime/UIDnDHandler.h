/* $Id: UIDnDHandler.h $ */
/** @file
 * VPox Qt GUI - UIDnDHandler class declaration..
 */
...
public:
    ...
    static KDnDAction          toVPoxDnDAction(Qt::DropAction action);
    static QVector<KDnDAction> toVPoxDnDActions(Qt::DropActions actions);
