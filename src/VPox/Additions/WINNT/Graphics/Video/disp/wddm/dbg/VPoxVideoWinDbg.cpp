...
#define VPOXVWD_VERSION_MAJOR 1
#define VPOXVWD_VERSION_MINOR 1

static EXT_API_VERSION g_VPoxVWDVersion = {
        VPOXVWD_VERSION_MAJOR,
        VPOXVWD_VERSION_MINOR,
...
DECLARE_API(help)
{
    dprintf("**** VirtualPox Video Driver debugging extension ****\n"
