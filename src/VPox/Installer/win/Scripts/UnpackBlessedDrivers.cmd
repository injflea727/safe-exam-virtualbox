...
set _MY_DRIVER_BASE_NAMES=VPoxSup VPoxNetAdp6 VPoxNetLwf VPoxUSB VPoxUSBMon
set _MY_GUEST_ADDITIONS_DRIVER_BASE_NAMES=VPoxVideo VPoxWddm VPoxGuest VPoxMouse
...
rem figure defaults here: if ".%_MY_OPT_INPUT%" == "." if exist "%_MY_OPT_BINDIR%\x86" set _MY_OPT_INPUT=VPoxDrivers-amd64.cab
rem figure defaults here: if ".%_MY_OPT_INPUT%" == "."       set _MY_OPT_INPUT=VPoxDrivers-x86.cab
