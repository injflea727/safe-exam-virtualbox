...
/** @file
 * VirtualPox Windows Guest Mesa3D - VMSVGA host object accounting.
 */
 ...
 */
static SVGAHOSTOBJECT *svgaHostObjectQuery(VPOXWDDM_EXT_VMSVGA *pSvga,
                                           AVLU32TREE *pAvlTree,
                                           uint32_t u32Key)
{
    KIRQL OldIrql;
                                      ...
                                      AVLU32TREE *pAvlTree)
{
    ...
    /* Delete the object. */
    VPOXWDDM_EXT_VMSVGA *pSvga = pHO->pSvga;
 ...
 * @return NT status.
 */
static NTSTATUS svgaHostObjectUnref(VPOXWDDM_EXT_VMSVGA *pSvga,
                                    AVLU32TREE *pAvlTree,
                                    uint32_t u32Key)
{
 ...
 * @return NT status.
 */
static NTSTATUS svgaHostObjectsProcessPending(VPOXWDDM_EXT_VMSVGA *pSvga)
{
    KIRQL OldIrql;
    SvgaHostObjectsLock(pSvga, &OldIrql);
 ...
 * @return NT status.
 */
static NTSTATUS svgaHostObjectInit(VPOXWDDM_EXT_VMSVGA *pSvga,
                                   SVGAHOSTOBJECT *pHO,
                                   uint32_t uType,
                                   uint32_t u32Key,
...
{
    VPOXWDDM_EXT_VMSVGA *pSvga = pSO->ho.pSvga;
