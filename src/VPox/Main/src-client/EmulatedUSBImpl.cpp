                               ...
                               void *pvObject)
{
    ...
    {
        LogFlowThisFunc(("%Rrc\n", vrc));
        hrc = pConsole->setErrorBoth(VPOX_E_IPRT_ERROR, vrc, "Init emulated USB webcam (%Rrc)", vrc);
    }
                           ...
                           const char *pszDriver)
{
    ...
    {
        LogFlowThisFunc(("%Rrc\n", vrc));
        hrc = pConsole->setErrorBoth(VPOX_E_VM_ERROR, vrc, "Attach emulated USB webcam (%Rrc)", vrc);
    }
                           ...
                           PUVM pUVM)
{
    ...
    {
        LogFlowThisFunc(("%Rrc\n", vrc));
        hrc = pConsole->setErrorBoth(VPOX_E_VM_ERROR, vrc, "Detach emulated USB webcam (%Rrc)", vrc);
    }
