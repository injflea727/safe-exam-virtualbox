...
# endif
# ifdef VPOX_PYXPCOM_VERSIONED
#  if   PY_VERSION_HEX >= 0x030a0000 && PY_VERSION_HEX < 0x030b0000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython3_10")
#   define initVPoxPython MANGLE_MODULE_INIT(PyInit_VPoxPython3_10)

#  elif   PY_VERSION_HEX >= 0x03090000 && PY_VERSION_HEX < 0x030a0000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython3_9")
#   define initVPoxPython MANGLE_MODULE_INIT(PyInit_VPoxPython3_9)

#  elif PY_VERSION_HEX >= 0x03080000 && PY_VERSION_HEX < 0x03090000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython3_8")
#   define initVPoxPython MANGLE_MODULE_INIT(PyInit_VPoxPython3_8)

#  elif PY_VERSION_HEX >= 0x03070000 && PY_VERSION_HEX < 0x03080000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython3_7")
#   define initVPoxPython MANGLE_MODULE_INIT(PyInit_VPoxPython3_7)

#  elif PY_VERSION_HEX >= 0x03060000 && PY_VERSION_HEX < 0x03070000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython3_6")
#   define initVPoxPython MANGLE_MODULE_INIT(PyInit_VPoxPython3_6)

#  elif PY_VERSION_HEX >= 0x03050000 && PY_VERSION_HEX < 0x03060000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython3_5")
#   define initVPoxPython MANGLE_MODULE_INIT(PyInit_VPoxPython3_5)

#  elif PY_VERSION_HEX >= 0x03040000 && PY_VERSION_HEX < 0x03050000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython3_4")
#   define initVPoxPython MANGLE_MODULE_INIT(PyInit_VPoxPython3_4)

#  elif PY_VERSION_HEX >= 0x03030000 && PY_VERSION_HEX < 0x03040000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython3_3")
#   define initVPoxPython MANGLE_MODULE_INIT(PyInit_VPoxPython3_3)

#  elif PY_VERSION_HEX >= 0x03020000 && PY_VERSION_HEX < 0x03030000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython3_2")
#   define initVPoxPython MANGLE_MODULE_INIT(PyInit_VPoxPython3_2)

#  elif PY_VERSION_HEX >= 0x03010000 && PY_VERSION_HEX < 0x03020000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython3_1")
#   define initVPoxPython MANGLE_MODULE_INIT(PyInit_VPoxPython3_1)

#  elif PY_VERSION_HEX >= 0x02080000 && PY_VERSION_HEX < 0x02090000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython2_8")
#   define initVPoxPython MANGLE_MODULE_INIT(initVPoxPython2_8)

#  elif PY_VERSION_HEX >= 0x02070000 && PY_VERSION_HEX < 0x02080000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython2_7")
#   define initVPoxPython MANGLE_MODULE_INIT(initVPoxPython2_7)

#  elif PY_VERSION_HEX >= 0x02060000 && PY_VERSION_HEX < 0x02070000
#   define MODULE_NAME    MANGLE_MODULE_NAME("VPoxPython2_6")
#   define initVPoxPython MANGLE_MODULE_INIT(initVPoxPython2_6)
#  else
#   error "Fix module versioning. This Python version is not recognized."
#  endif
# else
#  define MODULE_NAME 	  MANGLE_MODULE_NAME("VPoxPython")
#  if PY_MAJOR_VERSION <= 2
#   define initVPoxPython  MANGLE_MODULE_INIT(initVPoxPython)
#  else
#   define initVPoxPython  MANGLE_MODULE_INIT(PyInit_VPoxPython)
#  endif
# endif
#else
...
static nsresult deinitVPoxPython();
...
PyMODINIT_FUNC
# endif
initVPoxPython() { /* NOTE! This name is redefined at the top of the file! */
  static bool s_vpoxInited = false;
  if (!s_vpoxInited) {
    int rc = 0; /* Error handling in this code is NON-EXISTING. Sigh. */

# if defined(VPOX_PATH_APP_PRIVATE_ARCH) && defined(VPOX_PATH_SHARED_LIBS)
    rc = RTR3InitDll(RTR3INIT_FLAGS_UNOBTRUSIVE);
# else
    const char *home = getenv("VPOX_PROGRAM_PATH");
    if (home) {
