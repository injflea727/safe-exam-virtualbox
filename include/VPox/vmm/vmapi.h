...
#ifndef VPOX_INCLUDED_vmm_vmapi_h
#define VPOX_INCLUDED_vmm_vmapi_h
...
{
    /** The request returns a VPox status code. */
    VMREQFLAGS_VPOX_STATUS  = 0,
...
typedef struct VMREQ
{
    ...
    /** VPox status code for the completed request. */
...
#endif /* !VPOX_INCLUDED_vmm_vmapi_h */
