/* $Id: IOBufMgmt.h $ */
/** @file
 * VPox storage devices: I/O buffer management API.
 */
...
#ifndef VPOX_INCLUDED_SRC_Storage_IOBufMgmt_h
#define VPOX_INCLUDED_SRC_Storage_IOBufMgmt_h
...
#endif /* !VPOX_INCLUDED_SRC_Storage_IOBufMgmt_h */
