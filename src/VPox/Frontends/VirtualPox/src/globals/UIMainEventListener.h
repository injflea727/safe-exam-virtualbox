...
/** @file
 * VPox Qt GUI - UIMainEventListener class declaration.
 */
...
/* Other VPox includes: */
#include <VPox/com/listeners.h> /** @todo This drags in VirtualPox.h! It may be possible avoid it for XPCOM, but not COM due to VPoxEventType_T. */
...
signals:
    ...
    /** @name VirtualPox Extra-data related signals
      * @{ */
    ...
    /** @name VirtualPox Medium related signals
      * @{ */
    ...
    /** @name Console related signals
      * @{ */
        ...
        void sigUSBDeviceStateChange(CUSBDevice comDevice, bool fAttached, CVirtualPoxErrorInfo comError);
...
public:
    ...
    STDMETHOD(HandleEvent)(VPoxEventType_T enmType, IEvent *pEvent);
