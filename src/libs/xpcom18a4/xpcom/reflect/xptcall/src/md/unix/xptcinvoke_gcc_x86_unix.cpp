...
/* alignment here seems unimportant here; this was 16, now it's 2 which
   is what xptcstubs uses. */
	...
	".globl " SYMBOL_UNDERSCORE "VPoxNsxpXPTC_InvokeByIndex\n\t"
	".type  " SYMBOL_UNDERSCORE "VPoxNsxpXPTC_InvokeByIndex,@function\n"
	SYMBOL_UNDERSCORE "VPoxNsxpXPTC_InvokeByIndex:\n\t"
#else
...
#else
#ifdef VPOX_WITH_XPCOM_NAMESPACE_CLEANUP
	".size " SYMBOL_UNDERSCORE "VPoxNsxpXPTC_InvokeByIndex, . -" SYMBOL_UNDERSCORE "VPoxNsxpXPTC_InvokeByIndex\n\t"
#else
