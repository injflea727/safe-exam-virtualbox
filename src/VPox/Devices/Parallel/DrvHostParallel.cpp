...
/** @file
 * VirtualPox Host Parallel Port Driver.
 *
...
/** @def VPOX_WITH_WIN_PARPORT_SUP
 * Indicates whether to use the generic direct hardware access or host specific
 * code to access the parallel port.
 */
#if defined(DOXYGEN_RUNNING)
# define VPOX_WITH_WIN_PARPORT_SUP
#endif
#if defined(RT_OS_LINUX)
# undef VPOX_WITH_WIN_PARPORT_SUP
#elif defined(RT_OS_WINDOWS)
#else
# error "Not ported"
#endif

#if defined(VPOX_WITH_WIN_PARPORT_SUP) && defined(IN_RING0)
# include <iprt/asm-amd64-x86.h>
#endif

#if defined(VPOX_WITH_WIN_PARPORT_SUP) && defined(IN_RING3)
...
typedef struct DRVHOSTPARALLEL
{
    ...
    /** Device Handle */
    RTFILE                      hFileDevice;
#ifndef VPOX_WITH_WIN_PARPORT_SUP
...
#ifdef VPOX_WITH_WIN_PARPORT_SUP
    /** Data register. */
...
#endif /* VPOX_WITH_WIN_PARPORT_SUP */
...
# ifndef VPOX_WITH_WIN_PARPORT_SUP
    ...
    return rc;
# else  /* VPOX_WITH_WIN_PARPORT_SUP */
...
const PDMDRVREG g_DrvHostParallel =
{
    ...
    /* fFlags */
# if defined(VPOX_WITH_WIN_PARPORT_SUP)
