/* $Id: VPoxManageStorageController.cpp $ */
/** @file
 * VPoxManage - The storage controller related commands.
 */
...
RTEXITCODE handleStorageAttach(HandlerArg *a)
{
    ...
    /* get the virtualpox system properties */
    CHECK_ERROR_RET(a->virtualPox, COMGETTER(SystemProperties)(systemProperties.asOutParam()), RTEXITCODE_FAILURE);
    ...
    try
    {
        ...
        else
        {
            ...
            else if (!RTStrICmp(pszMedium, "iSCSI"))
            {
                ...
                CHECK_ERROR(a->virtualPox, CreateMedium(Bstr("iSCSI").raw(),
                                                        bstrISCSIMedium.raw(),
                                                        AccessMode_ReadWrite,
                                                        DeviceType_HardDisk,
                                                        pMedium2Mount.asOutParam()));
