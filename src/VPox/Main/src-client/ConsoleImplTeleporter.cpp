...
/** @file
 * VPox Console COM Class implementation, The Teleporter Part.
 */
...
*   Global Variables                                                                                                             *
*********************************************************************************************************************************/
static const char g_szWelcome[] = "VirtualPox-Teleporter-1.0\n";
                          ...
                          ULONG aMaxDowntime, ComPtr<IProgress> &aProgress)
{
    ...
    switch (mMachineState)
    {
        ...
        default:
            return setError(VPOX_E_INVALID_VM_STATE, tr("Invalid machine state: %s (must be Running or Paused)"),
