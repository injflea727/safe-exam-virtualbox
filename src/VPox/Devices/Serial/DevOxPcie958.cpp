...
#define OX958_PCI_MSIX_CAP_OFS          (OX958_PCI_MSI_CAP_OFS + VPOX_MSI_CAP_SIZE_64)
 ...
 */
static VPOXSTRICTRC ox958UartRegRead(PPDMDEVINS pDevIns, PDEVOX958 pThis, POX958UART pUart, POX958UARTCC pUartCC,
 ...
 */
static VPOXSTRICTRC ox958UartRegWrite(PPDMDEVINS pDevIns, PDEVOX958 pThis, POX958UART pUart, POX958UARTCC pUartCC,
 ...
 */
static DECLCALLBACK(VPOXSTRICTRC) ox958MmioRead(PPDMDEVINS pDevIns, void *pvUser, RTGCPHYS off, void *pv, unsigned cb)
{
    PDEVOX958    pThis   = PDMDEVINS_2_DATA(pDevIns, PDEVOX958);
 ...
 */
static DECLCALLBACK(VPOXSTRICTRC) ox958MmioWrite(PPDMDEVINS pDevIns, void *pvUser, RTGCPHYS off, void const *pv, unsigned cb)
{
    PDEVOX958    pThis   = PDMDEVINS_2_DATA(pDevIns, PDEVOX958);
    PDEVOX958CC  pThisCC = PDMDEVINS_2_DATA_CC(pDevIns, PDEVOX958CC);
    VPOXSTRICTRC rc      = VINF_SUCCESS;
...
# ifdef VPOX_WITH_MSI_DEVICES
    ...
    if (fMsiXSupported)
    {
        MsiReg.cMsixVectors    = VPOX_MSIX_MAX_ENTRIES;
...
const PDMDEVREG g_DeviceOxPcie958 =
{
    ...
    /* .cMaxPciDevices = */         1,
    /* .cMaxMsixVectors = */        VPOX_MSIX_MAX_ENTRIES,
