...
#ifndef VPOX_INCLUDED_SRC_Audio_DrvHostAudioDSoundMMNotifClient_h
#define VPOX_INCLUDED_SRC_Audio_DrvHostAudioDSoundMMNotifClient_h
...
#endif /* !VPOX_INCLUDED_SRC_Audio_DrvHostAudioDSoundMMNotifClient_h */
