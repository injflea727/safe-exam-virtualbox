...
#define PL_CompareStrings VPoxNsplPL_CompareStrings
#define PL_CompareValues VPoxNsplPL_CompareValues
#define PL_HashString VPoxNsplPL_HashString
#define PL_HashTableAdd VPoxNsplPL_HashTableAdd
#define PL_HashTableDestroy VPoxNsplPL_HashTableDestroy
#define PL_HashTableLookup VPoxNsplPL_HashTableLookup
#define PL_HashTableRemove VPoxNsplPL_HashTableRemove
#define PL_NewHashTable VPoxNsplPL_NewHashTable
#define PL_HashTableDump VPoxNsplPL_HashTableDump
#define PL_HashTableEnumerateEntries VPoxNsplPL_HashTableEnumerateEntries
#define PL_HashTableLookupConst VPoxNsplPL_HashTableLookupConst
#define PL_HashTableRawAdd VPoxNsplPL_HashTableRawAdd
#define PL_HashTableRawLookup VPoxNsplPL_HashTableRawLookup
#define PL_HashTableRawLookupConst VPoxNsplPL_HashTableRawLookupConst
#define PL_HashTableRawRemove VPoxNsplPL_HashTableRawRemove
