...
{
  public:
    HostPowerService(VirtualPox *aVirtualPox);
...
public:
    ...
    HostPowerServiceWin(VirtualPox *aVirtualPox);
...
public:
    ...
    HostPowerServiceLinux(VirtualPox *aVirtualPox);
...
public:
    ...
    HostPowerServiceDarwin(VirtualPox *aVirtualPox);
