...
/**
 * VPox internal struct. to passback to EMT rendezvous callback while enabling
 * the KVM wall-clock.
 */
 ...
 */
static DECLCALLBACK(VPOXSTRICTRC) gimR3KvmEnableWallClockCallback(PVM pVM, PVMCPU pVCpu, void *pvUser)
{
