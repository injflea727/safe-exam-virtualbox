/** @file
 * VPox Remote Desktop Extension (VRDE) - Graphics Orders Structures.
 */
...
#ifndef VPOX_INCLUDED_RemoteDesktop_VRDEOrders_h
#define VPOX_INCLUDED_RemoteDesktop_VRDEOrders_h
...
#endif /* !VPOX_INCLUDED_RemoteDesktop_VRDEOrders_h */
