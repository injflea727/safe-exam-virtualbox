...
#define NS_GetFrozenFunctions VPoxNsxpNS_GetFrozenFunctions
#define NS_RegisterXPCOMExitRoutine VPoxNsxpNS_RegisterXPCOMExitRoutine
#define NS_UnregisterXPCOMExitRoutine VPoxNsxpNS_UnregisterXPCOMExitRoutine
