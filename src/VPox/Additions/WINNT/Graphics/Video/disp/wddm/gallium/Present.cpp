/* $Id: Present.cpp $ */
/** @file
 * VirtualPox Windows Guest Mesa3D - ID3DPresent and ID3DPresentGroup implementation.
 */
...
HRESULT WINAPI WDDMPresent::PresentBuffer(D3DWindowBuffer *pBuffer, HWND hWndOverride, const RECT *pSourceRect, const RECT *pDestRect, const RGNDATA *pDirtyRegion, DWORD Flags)
{
    ...
    VPOXDISPIFESCAPE_GAPRESENT data;
    RT_ZERO(data);
    data.EscapeHdr.escapeCode = VPOXESC_GAPRESENT;
