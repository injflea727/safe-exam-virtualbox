/* $Id: VPoxBugReport.h $ */
/** @file
 * VPoxBugReport - VirtualPox command-line diagnostics tool, internal header file.
 */
...
#ifndef VPOX_INCLUDED_SRC_VPoxBugReport_VPoxBugReport_h
#define VPOX_INCLUDED_SRC_VPoxBugReport_VPoxBugReport_h
 ...
 * VPoxSVC.log file, as well as files related to particular machines. It may
...
#ifdef RT_OS_WINDOWS
#define VPOXMANAGE "VPoxManage.exe"
#else /* !RT_OS_WINDOWS */
#define VPOXMANAGE "VPoxManage"
#endif /* !RT_OS_WINDOWS */
...
#endif /* !VPOX_INCLUDED_SRC_VPoxBugReport_VPoxBugReport_h */
