...
#ifdef VPOX
      if (ShellCommandLineGetFlag(Package, L"-vpox")) {
        ShellPrintEx(-1, -1, L"Oracle(r) VirtualPox(tm) %d.%d.%d r%d\r\n", VPOX_VERSION_MAJOR, VPOX_VERSION_MINOR, VPOX_VERSION_BUILD, VPOX_REV);
      }
#endif
    }
