/* $Id: UIInformationPerformanceMonitor.cpp $ */
/** @file
 * VPox Qt GUI - UIInformationPerformanceMonitor class implementation.
 */
...
{
    m_performanceMonitor = uiCommon().virtualPox().GetPerformanceCollector();
