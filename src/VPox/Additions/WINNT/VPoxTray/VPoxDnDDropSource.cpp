/* $Id: VPoxDnDDropSource.cpp $ */
/** @file
 * VPoxDnDSource.cpp - IDropSource implementation.
 */
...
VPoxDnDDropSource::VPoxDnDDropSource(VPoxDnDWnd *pParent)
    : m_cRefs(1),
      m_pWndParent(pParent),
      m_dwCurEffect(0),
      m_enmActionCurrent(VPOX_DND_ACTION_IGNORE)
{
    LogFlowFuncEnter();
}

VPoxDnDDropSource::~VPoxDnDDropSource(void)
{
...
STDMETHODIMP_(ULONG) VPoxDnDDropSource::AddRef(void)
{
    return InterlockedIncrement(&m_cRefs);
}

STDMETHODIMP_(ULONG) VPoxDnDDropSource::Release(void)
{
...
STDMETHODIMP VPoxDnDDropSource::QueryInterface(REFIID iid, void **ppvObject)
{
 ...
 * @return  HRESULT
 */
STDMETHODIMP VPoxDnDDropSource::QueryContinueDrag(BOOL fEscapePressed, DWORD dwKeyState)
{
#if 1
 ...
 * @return  HRESULT
 */
STDMETHODIMP VPoxDnDDropSource::GiveFeedback(DWORD dwEffect)
{
