/* $Id: DevEFI.h $ */
/** @file
 * EFI for VirtualPox Common Definitions.
 *
 * WARNING: This header is used by both firmware and VPox device,
...
#ifndef VPOX_INCLUDED_SRC_EFI_DevEFI_h
#define VPOX_INCLUDED_SRC_EFI_DevEFI_h
...
#define VPOX_EFI_DEBUG_BUFFER   512
 ...
 *       SEC hands to PEI and the VPoxAutoScan PEIM reports. */
#define VPOX_EFI_TOP_OF_STACK   0x300000
...
#endif /* !VPOX_INCLUDED_SRC_EFI_DevEFI_h */
