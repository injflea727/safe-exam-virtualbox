/* $Id: SUPLibInternal.h $ */
/** @file
 * VirtualPox Support Library - Internal header.
 */
...
#ifndef VPOX_INCLUDED_SRC_Support_SUPLibInternal_h
#define VPOX_INCLUDED_SRC_Support_SUPLibInternal_h
...
/** @name Make the symbols in SUPR3HardenedStatic different from the VPoxRT ones.
...
typedef struct SUPLIBDATA
{
    ...
    bool                fUnrestricted;
#if   defined(RT_OS_DARWIN)
    /** The connection to the VPoxSupDrv service. */
...
#ifdef VPOX_INCLUDED_SRC_Support_SUPDrvIOC_h
...
#endif /* !VPOX_INCLUDED_SRC_Support_SUPLibInternal_h */
