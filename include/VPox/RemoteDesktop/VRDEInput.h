/** @file
 * VPox Remote Desktop Extension (VRDE) - Input interface.
 */
...
#ifndef VPOX_INCLUDED_RemoteDesktop_VRDEInput_h
#define VPOX_INCLUDED_RemoteDesktop_VRDEInput_h
...
#endif /* !VPOX_INCLUDED_RemoteDesktop_VRDEInput_h */
