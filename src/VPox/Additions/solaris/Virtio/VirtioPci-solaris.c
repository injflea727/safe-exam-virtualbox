...
/** @file
 * VirtualPox Guest Additions - Virtio Driver for Solaris, PCI Hypervisor Interface.
 */
...
static uint_t VirtioPciISR(caddr_t Arg)
{
    LogFlow((VIRTIOLOGNAME ":VPoxGuestSolarisISR\n"));
    cmn_err(CE_NOTE, "VPoxGuestSolarisISRd Arg=%p\n", Arg);
