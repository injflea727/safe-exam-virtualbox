                                              ...
                                              ComPtr<ICloudProvider> &aProvider)
{
    ...
    return setError(VPOX_E_OBJECT_NOT_FOUND, tr("Could not find a cloud provider with UUID {%RTuuid}"),
                    aProviderId.raw());
}
                                                     ...
                                                     ComPtr<ICloudProvider> &aProvider)
{
    ...
    return setError(VPOX_E_OBJECT_NOT_FOUND, tr("Could not find a cloud provider with short name '%s'"),
                    aProviderName.c_str());
}
                                                ...
                                                ComPtr<ICloudProvider> &aProvider)
{
    ...
    return setError(VPOX_E_OBJECT_NOT_FOUND, tr("Could not find a cloud provider with name '%s'"),
                    aProviderName.c_str());
}
