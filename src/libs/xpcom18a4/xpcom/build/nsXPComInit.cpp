...
NS_GetFrozenFunctions(XPCOMFunctions *functions, const char* libraryPath)
{
    ...
    GET_FUNC(init,                  InitFunc,                       "VPoxNsxpNS_InitXPCOM2");
    GET_FUNC(shutdown,              ShutdownFunc,                   "VPoxNsxpNS_ShutdownXPCOM");
    GET_FUNC(getServiceManager,     GetServiceManagerFunc,          "VPoxNsxpNS_GetServiceManager");
    GET_FUNC(getComponentManager,   GetComponentManagerFunc,        "VPoxNsxpNS_GetComponentManager");
    GET_FUNC(getComponentRegistrar, GetComponentRegistrarFunc,      "VPoxNsxpNS_GetComponentRegistrar");
    GET_FUNC(getMemoryManager,      GetMemoryManagerFunc,           "VPoxNsxpNS_GetMemoryManager");
    GET_FUNC(newLocalFile,          NewLocalFileFunc,               "VPoxNsxpNS_NewLocalFile");
    GET_FUNC(newNativeLocalFile,    NewNativeLocalFileFunc,         "VPoxNsxpNS_NewNativeLocalFile");
    GET_FUNC(registerExitRoutine,   RegisterXPCOMExitRoutineFunc,   "VPoxNsxpNS_RegisterXPCOMExitRoutine");
    GET_FUNC(unregisterExitRoutine, UnregisterXPCOMExitRoutineFunc, "VPoxNsxpNS_UnregisterXPCOMExitRoutine");
#else /* !VPOX_WITH_XPCOM_NAMESPACE_CLEANUP */
...
#ifdef VPOX_WITH_XPCOM_NAMESPACE_CLEANUP
        GET_FUNC(getDebug,          GetDebugFunc,                   "VPoxNsxpNS_GetDebug");
        GET_FUNC(getTraceRefcnt,    GetTraceRefcntFunc,             "VPoxNsxpNS_GetTraceRefcnt");
#else /* !VPOX_WITH_XPCOM_NAMESPACE_CLEANUP */
...
#ifdef VPOX_WITH_XPCOM_NAMESPACE_CLEANUP
        GET_FUNC(stringContainerInit,    StringContainerInitFunc,        "VPoxNsxpNS_StringContainerInit");
        GET_FUNC(stringContainerFinish,  StringContainerFinishFunc,      "VPoxNsxpNS_StringContainerFinish");
        GET_FUNC(stringGetData,          StringGetDataFunc,              "VPoxNsxpNS_StringGetData");
        GET_FUNC(stringSetData,          StringSetDataFunc,              "VPoxNsxpNS_StringSetData");
        GET_FUNC(stringSetDataRange,     StringSetDataRangeFunc,         "VPoxNsxpNS_StringSetDataRange");
        GET_FUNC(stringCopy,             StringCopyFunc,                 "VPoxNsxpNS_StringCopy");
        GET_FUNC(cstringContainerInit,   CStringContainerInitFunc,       "VPoxNsxpNS_CStringContainerInit");
        GET_FUNC(cstringContainerFinish, CStringContainerFinishFunc,     "VPoxNsxpNS_CStringContainerFinish");
        GET_FUNC(cstringGetData,         CStringGetDataFunc,             "VPoxNsxpNS_CStringGetData");
        GET_FUNC(cstringSetData,         CStringSetDataFunc,             "VPoxNsxpNS_CStringSetData");
        GET_FUNC(cstringSetDataRange,    CStringSetDataRangeFunc,        "VPoxNsxpNS_CStringSetDataRange");
        GET_FUNC(cstringCopy,            CStringCopyFunc,                "VPoxNsxpNS_CStringCopy");
        GET_FUNC(cstringToUTF16,         CStringToUTF16,                 "VPoxNsxpNS_CStringToUTF16");
        GET_FUNC(utf16ToCString,         UTF16ToCString,                 "VPoxNsxpNS_UTF16ToCString");
        GET_FUNC(stringCloneData,        StringCloneDataFunc,            "VPoxNsxpNS_StringCloneData");
        GET_FUNC(cstringCloneData,       CStringCloneDataFunc,           "VPoxNsxpNS_CStringCloneData");
#else /* !VPOX_WITH_XPCOM_NAMESPACE_CLEANUP */
