...
typedef std::map<VPoxLockingClass, RTLOCKVALCLASS> LockValidationClassesMap;
...
void InitAutoLockSystem()
{
    ...
    struct
    {
        VPoxLockingClass    cls;
        const char          *pcszDescription;
    } aClasses[] =
    {
        { LOCKCLASS_VIRTUALPOXOBJECT,   "2-VIRTUALPOXOBJECT" },
...
/*    WriteLockHandle critsect1(LOCKCLASS_VIRTUALPOXOBJECT);
    WriteLockHandle critsect2(LOCKCLASS_VIRTUALPOXLIST);
...
RWLockHandle::RWLockHandle(VPoxLockingClass lockClass)
{
    m = new Data();
...
WriteLockHandle::WriteLockHandle(VPoxLockingClass lockClass)
{
    m = new Data;
