...
#define PR_Yield VPoxNsprPR_Yield
#define PR_Select VPoxNsprPR_Select
#define PR_FD_ZERO VPoxNsprPR_FD_ZERO
#define PR_FD_SET VPoxNsprPR_FD_SET
#define PR_FD_CLR VPoxNsprPR_FD_CLR
#define PR_FD_ISSET VPoxNsprPR_FD_ISSET
#define PR_FD_NSET VPoxNsprPR_FD_NSET
#define PR_FD_NCLR VPoxNsprPR_FD_NCLR
#define PR_FD_NISSET VPoxNsprPR_FD_NISSET
#define PR_Stat VPoxNsprPR_Stat
