/* $Id: VPoxDD.cpp $ */
/** @file
 * VPoxDD - Built-in drivers & devices (part 1).
 */
...
*   Global Variables                                                                                                             *
*********************************************************************************************************************************/
const void *g_apvVPoxDDDependencies[] =
{
    NULL,
};
...
extern "C" DECLEXPORT(int) VPoxDriversRegister(PCPDMDRVREGCB pCallbacks, uint32_t u32Version)
{
    ...
    if (RT_FAILURE(rc))
        return rc;
#endif
#ifdef VPOX_WITH_USB_VIDEO_IMPL
    ...
    if (RT_FAILURE(rc))
        return rc;
#if defined(RT_OS_LINUX) || defined(VPOX_WITH_WIN_PARPORT_SUP)
 ...
 * @param   u32Version      VPox version number.
 */
extern "C" DECLEXPORT(int) VPoxUsbRegister(PCPDMUSBREGCB pCallbacks, uint32_t u32Version)
{
    int rc = VINF_SUCCESS;
