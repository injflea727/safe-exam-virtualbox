...
#ifndef VPOX_INCLUDED_SRC_SharedFolders_shflhandle_h
#define VPOX_INCLUDED_SRC_SharedFolders_shflhandle_h
...
#endif /* !VPOX_INCLUDED_SRC_SharedFolders_shflhandle_h */
