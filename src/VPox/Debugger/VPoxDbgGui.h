...
#ifndef DEBUGGER_INCLUDED_SRC_VPoxDbgGui_h
#define DEBUGGER_INCLUDED_SRC_VPoxDbgGui_h
 ...
 */
class VPoxDbgGui : public QObject
{
    Q_OBJECT;

public:
    /**
     * Create a default VPoxDbgGui object.
     */
    VPoxDbgGui();

    /**
     * Initializes a VPoxDbgGui object by ISession.
     *
     * @returns VPox status code.
     * @param   pSession    VPox Session object.
     */
    int init(ISession *pSession);

    /**
     * Initializes a VPoxDbgGui object by VM handle.
     *
     * @returns VPox status code.
    ...
    /**
     * Destroys the VPoxDbgGui object.
     */
    virtual ~VPoxDbgGui();
...
protected:
    ...
    VPoxDbgStats *m_pDbgStats;
    /** The debugger console (aka. command line). */
    VPoxDbgConsole *m_pDbgConsole;

    /** The VirtualPox session. */
    ISession *m_pSession;
    /** The VirtualPox console. */
    IConsole *m_pConsole;
    /** The VirtualPox Machine Debugger. */
    IMachineDebugger *m_pMachineDebugger;
    /** The VirtualPox Machine. */
    IMachine *m_pMachine;
    /** The VM instance. */
    PVM m_pVM;
...
#endif /* !DEBUGGER_INCLUDED_SRC_VPoxDbgGui_h */
