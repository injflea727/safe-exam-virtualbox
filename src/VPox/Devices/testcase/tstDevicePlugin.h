...
#ifndef VPOX_INCLUDED_SRC_testcase_tstDevicePlugin_h
#define VPOX_INCLUDED_SRC_testcase_tstDevicePlugin_h
...
#endif /* !VPOX_INCLUDED_SRC_testcase_tstDevicePlugin_h */
