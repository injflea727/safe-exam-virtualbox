...
#ifndef HAVE_ISINF
# undef isinf /* VPox: _MSC_VER >= RT_MSC_VER_VC120 has complicated macro implementation in math.h */
int isinf(double x);
#endif

#ifndef HAVE_ISNAN
# undef isnan /* VPox: _MSC_VER >= RT_MSC_VER_VC120 has complicated macro implementation in math.h */
int isnan(double x);
#endif
