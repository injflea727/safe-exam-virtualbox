...
#define NS_InitXPCOM2 VPoxNsxpNS_InitXPCOM2
#define NS_ShutdownXPCOM VPoxNsxpNS_ShutdownXPCOM
#define NS_NewNativeLocalFile VPoxNsxpNS_NewNativeLocalFile
#define NS_GetServiceManager VPoxNsxpNS_GetServiceManager
#define NS_GetComponentManager VPoxNsxpNS_GetComponentManager
#define NS_GetComponentRegistrar VPoxNsxpNS_GetComponentRegistrar
#define NS_GetDebug VPoxNsxpNS_GetDebug
#define NS_GetMemoryManager VPoxNsxpNS_GetMemoryManager
#define NS_GetTraceRefcnt VPoxNsxpNS_GetTraceRefcnt
#define NS_NewLocalFile VPoxNsxpNS_NewLocalFile
