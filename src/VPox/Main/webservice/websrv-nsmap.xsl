...
<!--
    ...
    websrv-nsmap.xsl:
        XSLT stylesheet that generates a vpoxweb.nsmap file from
        VirtualPox.xidl, which gets included from C++ client and
        server code.
 ...
 * Generator: src/VPox/Main/webservice/websrv-nsmap.xsl */
...
SOAP_NMAC struct Namespace namespaces[] =
{
  ...
  <xsl:value-of select="concat('    {&quot;vpox&quot;, &quot;', $G_targetNamespace, $G_targetNamespaceSeparator, '&quot;, NULL, NULL},')" />
