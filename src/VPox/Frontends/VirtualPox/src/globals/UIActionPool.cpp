/* $Id: UIActionPool.cpp $ */
/** @file
 * VPox Qt GUI - UIActionPool class implementation.
 */
...
protected:
    ...
    {
#ifdef VPOX_WS_MAC
        setName(QApplication::translate("UIActionPool", "&VirtualPox"));
#else
...
protected:
    ...
    virtual void retranslateUi() /* override */
    {
        setName(QApplication::translate("UIActionPool", "&VirtualPox Web Site..."));
        setStatusTip(QApplication::translate("UIActionPool", "Open the browser and go to the VirtualPox product web site"));
    }
};
...
protected:
    ...
    virtual void retranslateUi() /* override */
    {
        setName(QApplication::translate("UIActionPool", "&VirtualPox Bug Tracker..."));
        setStatusTip(QApplication::translate("UIActionPool", "Open the browser and go to the VirtualPox product bug tracker"));
    }
};
...
protected:
    ...
    virtual void retranslateUi() /* override */
    {
        setName(QApplication::translate("UIActionPool", "&VirtualPox Forums..."));
        setStatusTip(QApplication::translate("UIActionPool", "Open the browser and go to the VirtualPox product forums"));
    }
};
...
protected:
    ...
    virtual void retranslateUi() /* override */
    {
        ...
        setStatusTip(QApplication::translate("UIActionPool", "Check for a new VirtualPox version"));
    }
};
#endif /* VPOX_GUI_WITH_NETWORK_MANAGER */
...
protected:
    ...
    virtual void retranslateUi() /* override */
    {
        setName(QApplication::translate("UIActionPool", "&About VirtualPox..."));
