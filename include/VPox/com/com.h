...
#ifndef VPOX_INCLUDED_com_com_h
#define VPOX_INCLUDED_com_com_h
...
/** @name VPOX_COM_INIT_F_XXX - flags for com::Initialize().
 * @{ */
/** Windows: Caller is the GUI and needs a STA rather than MTA apartment. */
#define VPOX_COM_INIT_F_GUI             RT_BIT_32(0)
/** Windows: Auto registration updating, if privileged enough. */
#define VPOX_COM_INIT_F_AUTO_REG_UPDATE RT_BIT_32(1)
/** Windows: Opt-out of COM patching (client code should do this). */
#define VPOX_COM_INIT_F_NO_COM_PATCHING RT_BIT_32(2)
/** The default flags. */
#define VPOX_COM_INIT_F_DEFAULT         (VPOX_COM_INIT_F_AUTO_REG_UPDATE)
/** @} */
