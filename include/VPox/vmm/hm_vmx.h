...
#ifndef VPOX_INCLUDED_vmm_hm_vmx_h
#define VPOX_INCLUDED_vmm_hm_vmx_h
 ...
 * These are -not- specified by Intel but used internally by VirtualPox.
 * @{ */
 ...
 * In accordance with the VT-x spec.
 * Update g_apfnVMExitHandlers if new VM-exit reasons are added.
 * @{
 */
/** Invalid exit code */
...
/** The OR'd rvalues are from the VT-x spec (valid bit is VPox specific): */
...
#endif /* !VPOX_INCLUDED_vmm_hm_vmx_h */
