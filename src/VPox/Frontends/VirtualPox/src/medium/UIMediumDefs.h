/* $Id: UIMediumDefs.h $ */
/** @file
 * VPox Qt GUI - UIMedium related declarations.
 */
...
namespace UIMediumDefs
{
    ...
    /** Returns medium formats which are currently supported by @a comVPox for the given @a enmDeviceType. */
    QList<QPair<QString, QString> > MediumBackends(const CVirtualPox &comVPox, KDeviceType enmDeviceType);
    /** Returns which hard disk formats are currently supported by @a comVPox. */
    QList<QPair<QString, QString> > HDDBackends(const CVirtualPox &comVPox);
    /** Returns which optical disk formats are currently supported by @a comVPox. */
    QList<QPair<QString, QString> > DVDBackends(const CVirtualPox &comVPox);
    /** Returns which floppy disk formats are currently supported by @a comVPox. */
    QList<QPair<QString, QString> > FloppyBackends(const CVirtualPox &comVPox);
