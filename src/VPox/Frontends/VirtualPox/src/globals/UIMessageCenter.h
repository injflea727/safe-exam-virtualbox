...
/** @file
 * VPox Qt GUI - UIMessageCenter class declaration.
 */
...
public:
    ...
    void cannotCreateVirtualPoxClient(const CVirtualPoxClient &client) const;
    void cannotAcquireVirtualPox(const CVirtualPoxClient &client) const;
    ...
    void cannotFindMachineByName(const CVirtualPox &vpox, const QString &strName) const;
    void cannotFindMachineById(const CVirtualPox &vpox, const QUuid &uId) const;
    ...
    void cannotSetExtraData(const CVirtualPox &vpox, const QString &strKey, const QString &strValue);
    ...
    void cannotOpenMachine(const CVirtualPox &vpox, const QString &strMachinePath) const;
    ...
    void cannotOpenMedium(const CVirtualPox &comVPox, const QString &strLocation, QWidget *pParent = 0) const;
    ...
    void cannotCreateDHCPServer(const CVirtualPox &comVPox, const QString &strInterfaceName, QWidget *pParent = 0) const;
    void cannotRemoveDHCPServer(const CVirtualPox &comVPox, const QString &strInterfaceName, QWidget *pParent = 0) const;
    ...
    void cannotAcquireCloudProviderManager(const CVirtualPox &comVPox, QWidget *pParent = 0) const;
    ...
    void cannotCreateMachine(const CVirtualPox &vpox, QWidget *pParent = 0) const;
    void cannotRegisterMachine(const CVirtualPox &vpox, const QString &strMachineName, QWidget *pParent = 0) const;
    ...
    void cannotCreateHardDiskStorage(const CVirtualPox &vpox, const QString &strLocation,QWidget *pParent = 0) const;
    ...
    void cannotCreateMediumStorage(const CVirtualPox &comVPox, const QString &strLocation, QWidget *pParent = 0) const;
    ...
    void cannotCreateAppliance(const CVirtualPox &comVPox, QWidget *pParent = 0) const;
    ...
    void warnAboutVPoxSVCUnavailable() const;
    ...
    void askUserToDownloadExtensionPack(const QString &strExtPackName, const QString &strExtPackVersion, const QString &strVPoxVersion) const;
