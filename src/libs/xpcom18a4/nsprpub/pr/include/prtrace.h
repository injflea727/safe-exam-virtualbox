...
#define PR_CreateTrace VPoxNsprPR_CreateTrace
#define PR_DestroyTrace VPoxNsprPR_DestroyTrace
#define PR_Trace VPoxNsprPR_Trace
#define PR_SetTraceOption VPoxNsprPR_SetTraceOption
#define PR_GetTraceOption VPoxNsprPR_GetTraceOption
#define PR_GetTraceHandleFromName VPoxNsprPR_GetTraceHandleFromName
#define PR_GetTraceNameFromHandle VPoxNsprPR_GetTraceNameFromHandle
#define PR_FindNextTraceQname VPoxNsprPR_FindNextTraceQname
#define PR_FindNextTraceRname VPoxNsprPR_FindNextTraceRname
#define PR_RecordTraceEntries VPoxNsprPR_RecordTraceEntries
#define PR_GetTraceEntries VPoxNsprPR_GetTraceEntries
