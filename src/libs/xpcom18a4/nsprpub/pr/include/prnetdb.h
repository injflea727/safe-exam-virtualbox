...
#define PR_StringToNetAddr VPoxNsprPR_StringToNetAddr
#define PR_NetAddrToString VPoxNsprPR_NetAddrToString
#define PR_GetHostByName VPoxNsprPR_GetHostByName
#define PR_GetIPNodeByName VPoxNsprPR_GetIPNodeByName
#define PR_GetHostByAddr VPoxNsprPR_GetHostByAddr
#define PR_EnumerateHostEnt VPoxNsprPR_EnumerateHostEnt
#define PR_InitializeNetAddr VPoxNsprPR_InitializeNetAddr
#define PR_SetNetAddr VPoxNsprPR_SetNetAddr
#define PR_IsNetAddrType VPoxNsprPR_IsNetAddrType
#define PR_ConvertIPv4AddrToIPv6 VPoxNsprPR_ConvertIPv4AddrToIPv6
#define PR_GetProtoByName VPoxNsprPR_GetProtoByName
#define PR_GetProtoByNumber VPoxNsprPR_GetProtoByNumber
#define PR_GetAddrInfoByName VPoxNsprPR_GetAddrInfoByName
#define PR_FreeAddrInfo VPoxNsprPR_FreeAddrInfo
#define PR_EnumerateAddrInfo VPoxNsprPR_EnumerateAddrInfo
#define PR_GetCanonNameFromAddrInfo VPoxNsprPR_GetCanonNameFromAddrInfo
#define PR_htonl VPoxNsprPR_htonl
#define PR_htonll VPoxNsprPR_htonll
#define PR_htons VPoxNsprPR_htons
#define PR_ntohl VPoxNsprPR_ntohl
#define PR_ntohll VPoxNsprPR_ntohll
#define PR_ntohs VPoxNsprPR_ntohs
