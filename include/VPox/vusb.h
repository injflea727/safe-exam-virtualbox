...
#ifndef VPOX_INCLUDED_vusb_h
#define VPOX_INCLUDED_vusb_h
...
/** @defgroup grp_vusb  VPox USB API
 * @{
 */
...
/** Pointer to a VPox USB device interface. */
 ...
 * @param   rc      The VPox status code of the reset operation.
...
/** Pointer to a VPox USB port bitmap. */
...
/**
 * The VUSB RootHub connector interface provided by the VPox USB RootHub driver
 * (up).
...
typedef struct VUSBIROOTHUBCONNECTOR
{
     ...
     * @returns Other VPox status code.
     *
     * @param   pInterface  Pointer to this struct.
