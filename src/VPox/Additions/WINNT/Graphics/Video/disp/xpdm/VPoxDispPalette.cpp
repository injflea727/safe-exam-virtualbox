/* $Id: VPoxDispPalette.cpp $ */
/** @file
 * VPox XPDM Display driver, palette related functions
 */
...
int VPoxDispSetPalette8BPP(PVPOXDISPDEV pDev)
{
    ...
    return VPoxDispMPSetColorRegisters(pDev->hDriver, pClut, MAX_CLUT_SIZE);
}
...
BOOL APIENTRY VPoxDispDrvSetPalette(DHPDEV dhpdev, PALOBJ *ppalo, FLONG fl, ULONG iStart, ULONG cColors)
{
    ...
    rc =  VPoxDispMPSetColorRegisters(pDev->hDriver, pClut, MAX_CLUT_SIZE);
