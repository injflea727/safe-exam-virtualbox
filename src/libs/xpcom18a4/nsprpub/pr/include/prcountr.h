...
#define PR_CreateCounter VPoxNsprPR_CreateCounter
#define PR_DestroyCounter VPoxNsprPR_DestroyCounter
#define PR_GetCounterHandleFromName VPoxNsprPR_GetCounterHandleFromName
#define PR_GetCounterNameFromHandle VPoxNsprPR_GetCounterNameFromHandle
#define PR_IncrementCounter VPoxNsprPR_IncrementCounter
#define PR_DecrementCounter VPoxNsprPR_DecrementCounter
#define PR_AddToCounter VPoxNsprPR_AddToCounter
#define PR_SubtractFromCounter VPoxNsprPR_SubtractFromCounter
#define PR_GetCounter VPoxNsprPR_GetCounter
#define PR_SetCounter VPoxNsprPR_SetCounter
#define PR_FindNextCounterQname VPoxNsprPR_FindNextCounterQname
#define PR_FindNextCounterRname VPoxNsprPR_FindNextCounterRname
