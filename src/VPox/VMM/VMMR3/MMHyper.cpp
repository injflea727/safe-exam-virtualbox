                                 ...
                                 const char *pszDesc, PRTGCPTR pGCPtr)
{
    ...
    AssertReturn(cPages <= VPOX_MAX_ALLOC_PAGE_COUNT, VERR_PAGE_COUNT_OUT_OF_RANGE);
 ...
 * @remark  We assume the threading structure of VPox imposes natural
 ...
 *
 * @returns VPox status code (first failure).
 * @param   pVM                 The cross context VM structure.
