...
\begin{center}
\includegraphics[width=4cm]{images/vpoxlogo.png}
\end{center}%
\vspace{10mm}
...
\tableofcontents
  ...
  <xsl:template match="cmdsynopsis">
    ...
    <xsl:text>&#x0a;</xsl:text>
    <xsl:if test="parent::remark[@role='VPoxManage-overview']">
    ...
    <!-- Special overview trick for the current VPoxManage command overview. -->
    <xsl:if test="parent::remark[@role='VPoxManage-overview']">
