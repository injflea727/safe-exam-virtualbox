...
{
#ifdef VPOX_XPIDL_EMULATE_GENJIFACES_DIFF
    const char *basename;
    const char *ext;
#endif
...
#ifndef VPOX_XPIDL_EMULATE_GENJIFACES_DIFF
    /*
     * Last pass
     */
...
#endif /* VPOX_XPIDL_EMULATE_GENJIFACES */
...
#else  /* !VPOX_XPIDL_EMULATE_GENJIFACES */
