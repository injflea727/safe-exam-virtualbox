...
#define PL_ArenaAllocate VPoxNsplPL_ArenaAllocate
#define PL_ArenaFinish VPoxNsplPL_ArenaFinish
#define PL_ArenaGrow VPoxNsplPL_ArenaGrow
#define PL_ArenaRelease VPoxNsplPL_ArenaRelease
#define PL_CompactArenaPool VPoxNsplPL_CompactArenaPool
#define PL_FinishArenaPool VPoxNsplPL_FinishArenaPool
#define PL_FreeArenaPool VPoxNsplPL_FreeArenaPool
#define PL_InitArenaPool VPoxNsplPL_InitArenaPool
