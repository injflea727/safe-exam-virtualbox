...
#define PR_CreateThreadPool VPoxNsprPR_CreateThreadPool
#define PR_QueueJobPR_QueueJob_Read VPoxNsprPR_QueueJobPR_QueueJob_Read
#define PR_QueueJob VPoxNsprPR_QueueJob
#define PR_QueueJob_Read VPoxNsprPR_QueueJob_Read
#define PR_QueueJob_Write VPoxNsprPR_QueueJob_Write
#define PR_QueueJob_Accept VPoxNsprPR_QueueJob_Accept
#define PR_QueueJob_Connect VPoxNsprPR_QueueJob_Connect
#define PR_QueueJob_Timer VPoxNsprPR_QueueJob_Timer
#define PR_CancelJob VPoxNsprPR_CancelJob
#define PR_JoinJob VPoxNsprPR_JoinJob
#define PR_ShutdownThreadPool VPoxNsprPR_ShutdownThreadPool
#define PR_JoinThreadPool VPoxNsprPR_JoinThreadPool
