...
#ifndef VPOX_INCLUDED_SRC_Storage_VSCSI_VSCSIVpdPages_h
#define VPOX_INCLUDED_SRC_Storage_VSCSI_VSCSIVpdPages_h
...
#endif /* !VPOX_INCLUDED_SRC_Storage_VSCSI_VSCSIVpdPages_h */
