...
#ifndef MAIN_INCLUDED_VirtualPoxImpl_h
#define MAIN_INCLUDED_VirtualPoxImpl_h
...
//#ifdef DEBUG_bird
//# define VPOXSVC_WITH_CLIENT_WATCHER
//#endif
...
#if defined(VPOX_WITH_SDS) && !defined(VPOX_WITH_XPCOM)
class VirtualPoxClassFactory; /* See ../src-server/win/svcmain.cpp  */
#endif
...
class ATL_NO_VTABLE VirtualPox :
    public VirtualPoxWrap
#ifdef RT_OS_WINDOWS
     , public ATL::CComCoClass<VirtualPox, &CLSID_VirtualPox>
#endif
{
...
# ifdef VPOX_WITH_SDS
    DECLARE_CLASSFACTORY_EX(VirtualPoxClassFactory)
# else
    DECLARE_CLASSFACTORY_SINGLETON(VirtualPox)
# endif
#endif
    ...
    // Kind of redundant (VirtualPoxWrap declares itself not aggregatable and
    // CComCoClass<VirtualPox, &CLSID_VirtualPox> as aggregatable, the former
    ...
    DECLARE_NOT_AGGREGATABLE(VirtualPox)

    // to postpone generation of the default ctor/dtor
    DECLARE_EMPTY_CTOR_DTOR(VirtualPox)
    ...
    {
        return LOCKCLASS_VIRTUALPOXOBJECT;
    }
    ...
    /** Returns the VirtualPox home directory */
...
private:
   ...
   // wrapped IVirtualPox methods
    ...
    struct Data;            // opaque data structure, defined in VirtualPoxImpl.cpp

    Data *m;

    /* static variables (defined in VirtualPoxImpl.cpp) */
...
#endif /* !MAIN_INCLUDED_VirtualPoxImpl_h */
