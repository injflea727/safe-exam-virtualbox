...
#ifndef VPOX_INCLUDED_vmm_pdmnvram_h
#define VPOX_INCLUDED_vmm_pdmnvram_h
...
typedef struct PDMINVRAMCONNECTOR
{
     ...
     *
     * @returns VPox status code, @a rc on success.
     * @param   pInterface      Pointer to this interface structure.
     * @param   rc              The VPox status code for the whole store operation.
     */
...
#endif /* !VPOX_INCLUDED_vmm_pdmnvram_h */
