...
#ifndef VPOX_INCLUDED_GuestHost_clipboard_helper_h
#define VPOX_INCLUDED_GuestHost_clipboard_helper_h
 ...
 *
 * @returns VPox status code. Will return VERR_NO_DATA if no data was converted.
 * @param  pcwszSrc             UTF-16 string to convert.
...
#endif /* !VPOX_INCLUDED_GuestHost_clipboard_helper_h */
