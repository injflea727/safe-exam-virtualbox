...
/** @file
 * VPox Console COM Class implementation - Guest drag and drop source.
 */
...
{
#if !defined(VPOX_WITH_DRAG_AND_DROP) || !defined(VPOX_WITH_DRAG_AND_DROP_GH)
    ReturnComNotImplemented();
#else /* VPOX_WITH_DRAG_AND_DROP */
...
{
#if !defined(VPOX_WITH_DRAG_AND_DROP)
    ReturnComNotImplemented();
#else /* VPOX_WITH_DRAG_AND_DROP */
...
HRESULT GuestDnDSource::drop(const com::Utf8Str &aFormat, DnDAction_T aAction, ComPtr<IProgress> &aProgress)
{
    ...
    VPOXDNDACTION dndAction = GuestDnD::toHGCMAction(aAction);
 ...
 */
int GuestDnDSource::i_onReceiveDataHdr(GuestDnDRecvCtx *pCtx, PVPOXDNDSNDDATAHDR pDataHdr)
{
 ...
 */
int GuestDnDSource::i_onReceiveData(GuestDnDRecvCtx *pCtx, PVPOXDNDSNDDATA pSndData)
{
    AssertPtrReturn(pCtx,     VERR_INVALID_POINTER);
 ...
 *
 * @returns VPox status code. Will get sent back to the host service.
...
DECLCALLBACK(int) GuestDnDSource::i_receiveRawDataCallback(uint32_t uMsg, void *pvParms, size_t cbParms, void *pvUser)
{
    ...
    switch (uMsg)
    {
        ...
        {
            PVPOXDNDCBSNDDATAHDRDATA pCBData = reinterpret_cast<PVPOXDNDCBSNDDATAHDRDATA>(pvParms);
            AssertPtr(pCBData);
            AssertReturn(sizeof(VPOXDNDCBSNDDATAHDRDATA) == cbParms, VERR_INVALID_PARAMETER);
        ...
        {
            PVPOXDNDCBSNDDATADATA pCBData = reinterpret_cast<PVPOXDNDCBSNDDATADATA>(pvParms);
            AssertPtr(pCBData);
            AssertReturn(sizeof(VPOXDNDCBSNDDATADATA) == cbParms, VERR_INVALID_PARAMETER);
        ...
        {
            PVPOXDNDCBEVTERRORDATA pCBData = reinterpret_cast<PVPOXDNDCBEVTERRORDATA>(pvParms);
            AssertPtr(pCBData);
            AssertReturn(sizeof(VPOXDNDCBEVTERRORDATA) == cbParms, VERR_INVALID_PARAMETER);
...
DECLCALLBACK(int) GuestDnDSource::i_receiveTransferDataCallback(uint32_t uMsg, void *pvParms, size_t cbParms, void *pvUser)
{
    ...
    switch (uMsg)
    {
        ...
        {
            PVPOXDNDCBSNDDIRDATA pCBData = reinterpret_cast<PVPOXDNDCBSNDDIRDATA>(pvParms);
            AssertPtr(pCBData);
            AssertReturn(sizeof(VPOXDNDCBSNDDIRDATA) == cbParms, VERR_INVALID_PARAMETER);
        ...
        {
            PVPOXDNDCBSNDFILEHDRDATA pCBData = reinterpret_cast<PVPOXDNDCBSNDFILEHDRDATA>(pvParms);
            AssertPtr(pCBData);
            AssertReturn(sizeof(VPOXDNDCBSNDFILEHDRDATA) == cbParms, VERR_INVALID_PARAMETER);
        ...
        {
            PVPOXDNDCBSNDFILEDATADATA pCBData = reinterpret_cast<PVPOXDNDCBSNDFILEDATADATA>(pvParms);
            AssertPtr(pCBData);
            AssertReturn(sizeof(VPOXDNDCBSNDFILEDATADATA) == cbParms, VERR_INVALID_PARAMETER);
            ...
            {
                /**
                 * Notes for protocol v1 (< VPox 5.0):
