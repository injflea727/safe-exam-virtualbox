...
# if defined(_MSC_VER)                                       /* vpox */
#  ifdef __cplusplus                                         /* vpox */
#   define DECLARE_DEPRECATED(f)  __declspec(deprecated) f;  /* vpox */
#  else                                                      /* vpox */
#   define DECLARE_DEPRECATED(f)  f;                         /* vpox */
#  endif                                                     /* vpox */
# else
...
# else
#  error "Unknown/missing RT_ARCH_*." /* vpox: 64-bit (cannot safely use ARCH_BITS without including iprt/cdefs.h) */
# endif
#endif
