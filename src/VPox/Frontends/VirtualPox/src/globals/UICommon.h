/* $Id: UICommon.h $ */
/** @file
 * VPox Qt GUI - UICommon class declaration.
 */
...
signals:
     ...
     * @{ */
        ...
        /** Notifies listeners about the VPoxSVC availability change. */
        void sigVPoxSVCAvailabilityChange();
    /** @} */
...
public:
     ...
     * @{ */
        ...
        /** Returns VPox version string. */
        QString vpoxVersionString() const;
        /** Returns normalized VPox version string. */
        QString vpoxVersionStringNormalized() const;
        /** Returns whether VPox version string contains BETA word. */
        bool isBeta() const;
     ...
     * @{ */
        ...
        /** VPoxDbg module handle. */
        RTLDRMOD getDebuggerModule() const { return m_hVPoxDbg; }
#endif
     ...
     * @{ */
        ...
        /** Returns VPox language sub-directory. */
        static QString vpoxLanguageSubDirectory();
        /** Returns VPox language file-base. */
        static QString vpoxLanguageFileBase();
        /** Returns VPox language file-extension. */
        static QString vpoxLanguageFileExtension();
        /** Returns VPox language ID reg-exp. */
        static QString vpoxLanguageIdRegExp();
        /** Returns built in language name. */
        static QString vpoxBuiltInLanguageName();
     ...
     * @{ */
        ...
        /** Returns the copy of VirtualPox client wrapper. */
        CVirtualPoxClient virtualPoxClient() const { return m_comVPoxClient; }
        /** Returns the copy of VirtualPox object wrapper. */
        CVirtualPox virtualPox() const { return m_comVPox; }
        /** Returns the copy of VirtualPox host-object wrapper. */
        CHost host() const { return m_comHost; }
        /** Returns the symbolic VirtualPox home-folder representation. */
        QString homeFolder() const { return m_strHomeFolder; }

        /** Returns the VPoxSVC availability value. */
        bool isVPoxSVCAvailable() const { return m_fVPoxSVCAvailable; }
    /** @} */
...
protected slots:
    ...
    /** @name COM stuff.
     * @{ */
        /** Handles the VPoxSVC availability change. */
        void sltHandleVPoxSVCAvailabilityChange(bool fAvailable);
    /** @} */

private:

    /** Construcs global VirtualPox object of passed @a enmType. */
    UICommon(UIType enmType);

    /** Destrucs global VirtualPox object. */
     ...
     * @{ */
        ...
        /** Holds the VPox branding config file path. */
     ...
     * @{ */
        ...
        /** Holds the instance of VirtualPox client wrapper. */
        CVirtualPoxClient  m_comVPoxClient;
        /** Holds the copy of VirtualPox object wrapper. */
        CVirtualPox        m_comVPox;
        /** Holds the copy of VirtualPox host-object wrapper. */
        CHost              m_comHost;
        /** Holds the symbolic VirtualPox home-folder representation. */
        QString            m_strHomeFolder;

        /** Holds whether acquired COM wrappers are currently valid. */
        bool  m_fWrappersValid;
        /** Holds whether VPoxSVC is currently available. */
        bool  m_fVPoxSVCAvailable;
