...
/** @file
 *
 * VirtualPox object caller handling definitions
 */
 ...
 * callers of the given VirtualPoxBase object when an instance is constructed
 ...
 * the managed VirtualPoxBase object is not Ready, or in any other invalid
...
public:
     ...
     *                  rc() will return S_OK).
     */
    AutoCaller(VirtualPoxBase *aObj)
    {
        init(aObj, false);
    }
     ...
     */
    void attach(VirtualPoxBase *aObj)
    {
...
protected:
     ...
     *                  limited caller.
     */
    void init(VirtualPoxBase *aObj, bool aLimited)
    {
        mObj = aObj;
        mRC = S_OK;
        mLimited = aLimited;
 ...
 * the given VirtualPoxBase object when an instance is constructed and
...
public:
     ...
     *                  rc() will return S_OK).
     */
    AutoLimitedCaller(VirtualPoxBase *aObj)
    {
 ...
 * as the argument at the beginning of init() methods of VirtualPoxBase
 ...
 * VirtualPoxBase::uninit() method which is supposed to place the object
 ...
 *       VirtualPoxBase subclasses and never pass anything other than |this|
...
public:
    ...
    AutoInitSpan(VirtualPoxBase *aObj, Result aResult = Failed);
    ~AutoInitSpan();
     ...
     * VirtualPoxBase object to the Ready state.
     */
     ...
     * place the managed VirtualPoxBase object to the Limited state.
     */
     ...
     * initialization. The AutoInitSpan destructor will place the managed
     * VirtualPoxBase object to the InitFailed state and will automatically
 ...
 *
 * Instances must be created as a stack-based variable taking |this| pointer
 * as the argument at the beginning of methods of VirtualPoxBase
 ...
 * methods of VirtualPoxBase subclasses and never pass anything other than
...
public:
    ...
    AutoReinitSpan(VirtualPoxBase *aObj);
    ~AutoReinitSpan();
     ...
     * the managed VirtualPoxBase object to the Ready state.
     */
 ...
 *
 * Instances must be created as a stack-based variable taking |this| pointer
 * as the argument at the beginning of uninit() methods of VirtualPoxBase
 * subclasses. When this variable is created it automatically places the
...
public:
    ...
    AutoUninitSpan(VirtualPoxBase *aObj, bool fTry = false);
    ~AutoUninitSpan();
