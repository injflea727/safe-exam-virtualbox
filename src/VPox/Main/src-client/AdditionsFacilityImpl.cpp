...
/** @file
 * VirtualPox Main - Additions facility class.
 */
...
const AdditionsFacility::FacilityInfo AdditionsFacility::s_aFacilityInfo[8] =
{
    ...
    { "VirtualPox Base Driver",         AdditionsFacilityType_VPoxGuestDriver,  AdditionsFacilityClass_Driver },
    { "Auto Logon",                     AdditionsFacilityType_AutoLogon,        AdditionsFacilityClass_Feature },
    { "VirtualPox System Service",      AdditionsFacilityType_VPoxService,      AdditionsFacilityClass_Service },
    { "VirtualPox Desktop Integration", AdditionsFacilityType_VPoxTrayClient,   AdditionsFacilityClass_Program },
