...
/** @file
 * VPox Qt GUI - Extra-data related definitions.
 */
...
namespace UIExtraDataDefs
{
    ...
    /** @name VirtualPox Manager
      * @{ */
        ...
        /** Holds the last selected tool set of VirtualPox Manager. */
        ...
        /** Holds VirtualPox Manager Details-pane elements. */
        SHARED_LIBRARY_STUFF extern const char *GUI_Details_Elements;
        /** Holds VirtualPox Manager Details-pane / Preview element update interval. */
...
public:
    ...
    /** VirtualPox Manager UI: Details element: "General" option types. */
    ...
    /** VirtualPox Manager UI: Details element: "System" option types. */
    ...
    /** VirtualPox Manager UI: Details element: "Display" option types. */
    ...
    /** VirtualPox Manager UI: Details element: "Storage" option types. */
    ...
    /** VirtualPox Manager UI: Details element: "Audio" option types. */
    ...
    /** VirtualPox Manager UI: Details element: "Network" option types. */
    ...
    /** VirtualPox Manager UI: Details element: "Serial" option types. */
    ...
    /** VirtualPox Manager UI: Details element: "USB" option types. */
    ...
    /** VirtualPox Manager UI: Details element: "SharedFolders" option types. */
    ...
    /** VirtualPox Manager UI: Details element: "UserInterface" option types. */
    ...
    /** VirtualPox Manager UI: Details element: "Description" option types. */
