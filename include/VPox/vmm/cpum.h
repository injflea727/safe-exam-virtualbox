...
#ifndef VPOX_INCLUDED_vmm_cpum_h
#define VPOX_INCLUDED_vmm_cpum_h
 ...
 * @{ */
VMMDECL(void)           CPUMGetGuestGDTR(PCVMCPU pVCpu, PVPOXGDTR pGDTR);
...
#ifdef VPOX_INCLUDED_vmm_cpumctx_h
...
#ifdef VPOX_WITH_VMMR0_DISABLE_LAPIC_NMI
...
#endif /* !VPOX_INCLUDED_vmm_cpum_h */
