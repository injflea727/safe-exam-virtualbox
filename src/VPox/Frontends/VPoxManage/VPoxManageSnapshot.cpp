/* $Id: VPoxManageSnapshot.cpp $ */
/** @file
 * VPoxManage - The 'snapshot' command.
 */
...
/**
 * Helper function used with "VPoxManage snapshot ... dump". Gets called to find the
...
/**
 * Helper function used with "VPoxManage snapshot ... dump". Called from DumpSnapshot()
...
/**
 * Implementation for "VPoxManage snapshot ... dump". This goes thru the machine's
...
/**
 * Implementation for all VPoxManage snapshot ... subcommands.
 * @param a
 * @return
 */
 ...
 *
 * 'VPoxManage snapshot empty take --help' takes a snapshot rather than display
 ...
 */
    ...
    CHECK_ERROR(a->virtualPox, FindMachine(bstrMachine.raw(),
                                           pMachine.asOutParam()));
    if (!pMachine)
        return RTEXITCODE_FAILURE;
    ...
    do
    {
        ...
        else if (!strcmp(a->argv[1], "showvminfo"))
        {
            ...
            showVMInfo(a->virtualPox, pMachine2, NULL, VMINFO_NONE);
        }
