/* $Id: VPoxLogRelCreate.cpp $ */
/** @file
 * MS COM / XPCOM Abstraction Layer - VPoxLogRelCreate.
 */
...
static DECLCALLBACK(void) vpoxHeaderFooter(PRTLOGGER pReleaseLogger, RTLOGPHASE enmPhase, PFNRTLOGPHASEMSG pfnLog)
{
    ...
    switch (enmPhase)
    {
        case RTLOGPHASE_BEGIN:
        {
            ...
            pfnLog(pReleaseLogger,
                   "VirtualPox %s %s r%u %s (%s %s) release log\n"
#ifdef VPOX_BLEEDING_EDGE
                   "EXPERIMENTAL build " VPOX_BLEEDING_EDGE "\n"
#endif
                   "Log opened %s\n",
                   g_pszLogEntity, VPOX_VERSION_STRING, RTBldCfgRevision(),
...
int VPoxLogRelCreate(const char *pcszEntity, const char *pcszLogFile,
                     ...
                     PRTERRINFO pErrInfo)
{
    ...
    int vrc = RTLogCreateEx(&pReleaseLogger, fFlags, pcszGroupSettings, pcszEnvVarBase,
                            ...
                            vpoxHeaderFooter, cHistory, uHistoryFileSize, uHistoryFileTime,
