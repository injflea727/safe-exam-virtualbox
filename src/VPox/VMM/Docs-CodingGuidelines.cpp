 ...
 *
 * The guidelines extends the VPox coding guidelines (@ref pg_vpox_guideline)
 ...
 *     extension).
 *
 * (2) The VPox integer types are RTINT, RTUINT, RTGCINT, RTGCUINT,
 ...
 *
 * There are the general VPox guidelines, see @ref sec_vpox_guideline_optional.
