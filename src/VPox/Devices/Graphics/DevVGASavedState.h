...
#ifndef VPOX_INCLUDED_SRC_Graphics_DevVGASavedState_h
#define VPOX_INCLUDED_SRC_Graphics_DevVGASavedState_h
...
#endif /* !VPOX_INCLUDED_SRC_Graphics_DevVGASavedState_h */
