...
*   Global Variables                                                                                                             *
*********************************************************************************************************************************/
extern PVPOXHGCMSVCHELPERS g_pHelpers; /* service.cpp */
...
typedef struct SHFLMAPPINGSWAIT
{
    ...
    VPOXHGCMCALLHANDLE  hCall;      /**< The call handle to signal completion with. */
    PVPOXHGCMSVCPARM    pParm;      /**< The 32-bit unsigned parameter to stuff g_uFolderMappingsVersion into. */
} SHFLMAPPINGSWAIT;
 ...
 * documentation (or should it better be inline in include/VPox/shflsvc.h?) */
 ...
 * @since   VPox 6.0
 */
int vbsfMappingsWaitForChanges(PSHFLCLIENTDATA pClient, VPOXHGCMCALLHANDLE hCall, PVPOXHGCMSVCPARM pParm, bool fRestored)
{
    /*
