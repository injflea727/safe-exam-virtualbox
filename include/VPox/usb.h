...
#ifndef VPOX_INCLUDED_usb_h
#define VPOX_INCLUDED_usb_h
...
#ifdef VPOX_USB_H_INCL_DESCRIPTORS /* for the time being, since this may easily conflict with system headers */
...
#endif /* VPOX_USB_H_INCL_DESCRIPTORS */

/** @} */
RT_C_DECLS_END

#endif /* !VPOX_INCLUDED_usb_h */
