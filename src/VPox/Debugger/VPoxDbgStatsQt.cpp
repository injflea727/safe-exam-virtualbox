 ...
 */
class VPoxDbgStatsModel : public QAbstractItemModel
{
protected:
...
public:
     ...
     *                          docs for details.
     */
    VPoxDbgStatsModel(QObject *a_pParent);
 ...
 */
class VPoxDbgStatsModelVM : public VPoxDbgStatsModel, public VPoxDbgBase
{
public:
    /**
     * Constructor.
     ...
     */
    VPoxDbgStatsModelVM(VPoxDbgGui *a_pDbgGui, QString &a_rPatStr, QObject *a_pParent);

    /** Destructor */
    virtual ~VPoxDbgStatsModelVM();
...
VPoxDbgStatsModel::VPoxDbgStatsModel(QObject *a_pParent)
...
VPoxDbgStatsModel::~VPoxDbgStatsModel()
{
    destroyTree(m_pRoot);
    m_pRoot = NULL;
}
...
/*static*/ void
VPoxDbgStatsModel::destroyTree(PDBGGUISTATSNODE a_pRoot)
{
    if (!a_pRoot)
        return;
...
/* static*/ void
VPoxDbgStatsModel::destroyNode(PDBGGUISTATSNODE a_pNode)
{
...
VPoxDbgStatsModel::createRootNode(void)
{
...
/*static*/ PDBGGUISTATSNODE
VPoxDbgStatsModel::createAndInsertNode(PDBGGUISTATSNODE pParent, const char *pszName, size_t cchName, uint32_t iPosition)
{
    /*
     * Create it.
     */
...
PDBGGUISTATSNODE
VPoxDbgStatsModel::createAndInsert(PDBGGUISTATSNODE pParent, const char *pszName, size_t cchName, uint32_t iPosition)
{
    PDBGGUISTATSNODE pNode;
...
/*static*/ PDBGGUISTATSNODE
VPoxDbgStatsModel::removeNode(PDBGGUISTATSNODE pNode)
{
...
/*static*/ void
VPoxDbgStatsModel::removeAndDestroyNode(PDBGGUISTATSNODE pNode)
{
    removeNode(pNode);
    destroyNode(pNode);
}
...
void
VPoxDbgStatsModel::removeAndDestroy(PDBGGUISTATSNODE pNode)
{
    if (m_fUpdateInsertRemove)
...
/*static*/ void
VPoxDbgStatsModel::resetNode(PDBGGUISTATSNODE pNode)
{
...
/*static*/ int
VPoxDbgStatsModel::initNode(PDBGGUISTATSNODE pNode, STAMTYPE enmType, void *pvSample, STAMUNIT enmUnit, const char *pszDesc)
{
    /*
     * Copy the data.
     */
...
/*static*/ void
VPoxDbgStatsModel::updateNode(PDBGGUISTATSNODE pNode, STAMTYPE enmType, void *pvSample, STAMUNIT enmUnit, const char *pszDesc)
{
...
/*static*/ ssize_t
VPoxDbgStatsModel::getNodePath(PCDBGGUISTATSNODE pNode, char *psz, ssize_t cch)
{
    ssize_t off;
    if (!pNode->pParent)
    {
...
/*static*/ char *
VPoxDbgStatsModel::getNodePath2(PCDBGGUISTATSNODE pNode, char *psz, ssize_t cch)
{
    if (VPoxDbgStatsModel::getNodePath(pNode, psz, cch) < 0)
        return NULL;
    return psz;
}
...
/*static*/ bool
VPoxDbgStatsModel::isNodeAncestorOf(PCDBGGUISTATSNODE pAncestor, PCDBGGUISTATSNODE pDescendant)
{
    while (pDescendant)
    {
...
/*static*/ PDBGGUISTATSNODE
VPoxDbgStatsModel::nextNode(PDBGGUISTATSNODE pNode)
{
    if (!pNode)
        return NULL;
...
/*static*/ PDBGGUISTATSNODE
VPoxDbgStatsModel::nextDataNode(PDBGGUISTATSNODE pNode)
{
    do
...
/*static*/ PDBGGUISTATSNODE
VPoxDbgStatsModel::prevNode(PDBGGUISTATSNODE pNode)
{
    if (!pNode)
        return NULL;
    PDBGGUISTATSNODE pParent = pNode->pParent;
...
/*static*/ PDBGGUISTATSNODE
VPoxDbgStatsModel::prevDataNode(PDBGGUISTATSNODE pNode)
{
    do
...
#if 0
/*static*/ PDBGGUISTATSNODE
VPoxDbgStatsModel::createNewTree(IMachineDebugger *a_pIMachineDebugger)
{
    /** @todo  */
    return NULL;
}
...
#if 0
/*static*/ PDBGGUISTATSNODE
VPoxDbgStatsModel::createNewTree(const char *pszFilename)
{
    /** @todo  */
    return NULL;
}
...
#if 0
/*static*/ PDBGGUISTATSNODE
VPoxDbgStatsModel::createDiffTree(PDBGGUISTATSNODE pTree1, PDBGGUISTATSNODE pTree2)
{
    /** @todo  */
    return NULL;
}
...
PDBGGUISTATSNODE
VPoxDbgStatsModel::updateCallbackHandleOutOfOrder(const char *pszName)
{
...
PDBGGUISTATSNODE
VPoxDbgStatsModel::updateCallbackHandleTail(const char *pszName)
{
    /*
...
void
VPoxDbgStatsModel::updateCallbackAdvance(PDBGGUISTATSNODE pNode)
{
    /*
...
VPoxDbgStatsModel::updateCallback(const char *pszName, STAMTYPE enmType, void *pvSample, STAMUNIT enmUnit,
                                  STAMVISIBILITY enmVisibility, const char *pszDesc, void *pvUser)
{
    VPoxDbgStatsModelVM *pThis = (VPoxDbgStatsModelVM *)pvUser;
...
bool
VPoxDbgStatsModel::updatePrepare(void)
{
    /*
...
bool
VPoxDbgStatsModel::updateDone(bool a_fSuccess)
{
    /*
...
bool
VPoxDbgStatsModel::updateStatsByPattern(const QString &a_rPatStr)
{
    /* stub */
    NOREF(a_rPatStr);
    return false;
...
void
VPoxDbgStatsModel::updateStatsByIndex(QModelIndex const &a_rIndex)
{
...
void
VPoxDbgStatsModel::resetStatsByPattern(QString const &a_rPatStr)
{
    /* stub */
    NOREF(a_rPatStr);
}
...
void
VPoxDbgStatsModel::resetStatsByIndex(QModelIndex const &a_rIndex, bool fSubTree /*= true*/)
{
...
QModelIndex
VPoxDbgStatsModel::getRootIndex(void) const
{
    if (!m_pRoot)
        return QModelIndex();
...
void
VPoxDbgStatsModel::setRootNode(PDBGGUISTATSNODE a_pRoot)
{
...
Qt::ItemFlags
VPoxDbgStatsModel::flags(const QModelIndex &a_rIndex) const
{
...
int
VPoxDbgStatsModel::columnCount(const QModelIndex &a_rParent) const
{
    NOREF(a_rParent);
...
int
VPoxDbgStatsModel::rowCount(const QModelIndex &a_rParent) const
{
...
bool
VPoxDbgStatsModel::hasChildren(const QModelIndex &a_rParent) const
{
    PDBGGUISTATSNODE pParent = nodeFromIndex(a_rParent);
...
QModelIndex
VPoxDbgStatsModel::index(int iRow, int iColumn, const QModelIndex &a_rParent) const
{
    PDBGGUISTATSNODE pParent = nodeFromIndex(a_rParent);
    if (!pParent)
    {
...
QModelIndex
VPoxDbgStatsModel::parent(const QModelIndex &a_rChild) const
{
...
QVariant
VPoxDbgStatsModel::headerData(int a_iSection, Qt::Orientation a_eOrientation, int a_eRole) const
{
...
/*static*/ QString
VPoxDbgStatsModel::strUnit(PCDBGGUISTATSNODE pNode)
{
...
/*static*/ QString
VPoxDbgStatsModel::strValueTimes(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
/*static*/ QString
VPoxDbgStatsModel::strMinValue(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
/*static*/ QString
VPoxDbgStatsModel::strAvgValue(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
/*static*/ QString
VPoxDbgStatsModel::strMaxValue(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
/*static*/ QString
VPoxDbgStatsModel::strTotalValue(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
/*static*/ QString
VPoxDbgStatsModel::strDeltaValue(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
QVariant
VPoxDbgStatsModel::data(const QModelIndex &a_rIndex, int a_eRole) const
{
...
/*static*/ void
VPoxDbgStatsModel::stringifyNodeNoRecursion(PDBGGUISTATSNODE a_pNode, QString &a_rString)
{
    /*
...
/*static*/ void
VPoxDbgStatsModel::stringifyNode(PDBGGUISTATSNODE a_pNode, QString &a_rString)
{
...
void
VPoxDbgStatsModel::stringifyTree(QModelIndex &a_rRoot, QString &a_rString) const
{
...
void
VPoxDbgStatsModel::copyTreeToClipboard(QModelIndex &a_rRoot) const
{
    QString String;
...
/*static*/ void
VPoxDbgStatsModel::logNode(PDBGGUISTATSNODE a_pNode, bool a_fReleaseLog)
{
    /* this node (if it has data) */
    if (a_pNode->enmType != STAMTYPE_INVALID)
    {
...
void
VPoxDbgStatsModel::logTree(QModelIndex &a_rRoot, bool a_fReleaseLog) const
{
    PDBGGUISTATSNODE pRoot = a_rRoot.isValid() ? nodeFromIndex(a_rRoot) : m_pRoot;
    if (pRoot)
...
VPoxDbgStatsModelVM::VPoxDbgStatsModelVM(VPoxDbgGui *a_pDbgGui, QString &a_rPatStr, QObject *a_pParent)
    : VPoxDbgStatsModel(a_pParent), VPoxDbgBase(a_pDbgGui)
{
    /*
...
VPoxDbgStatsModelVM::~VPoxDbgStatsModelVM()
{
    /* nothing to do here. */
}
...
bool
VPoxDbgStatsModelVM::updateStatsByPattern(const QString &a_rPatStr)
{
...
void
VPoxDbgStatsModelVM::resetStatsByPattern(QString const &a_rPatStr)
{
    stamReset(a_rPatStr);
}
...
/*static*/ DECLCALLBACK(int)
VPoxDbgStatsModelVM::createNewTreeCallback(const char *pszName, STAMTYPE enmType, void *pvSample, STAMUNIT enmUnit,
                                           STAMVISIBILITY enmVisibility, const char *pszDesc, void *pvUser)
{
...
PDBGGUISTATSNODE
VPoxDbgStatsModelVM::createNewTree(QString &a_rPatStr)
{
...
VPoxDbgStatsView::VPoxDbgStatsView(VPoxDbgGui *a_pDbgGui, VPoxDbgStatsModel *a_pModel, VPoxDbgStats *a_pParent/* = NULL*/)
    : QTreeView(a_pParent), VPoxDbgBase(a_pDbgGui), m_pModel(a_pModel), m_PatStr(), m_pParent(a_pParent),
...
VPoxDbgStatsView::~VPoxDbgStatsView()
{
    m_pParent = NULL;
    m_pCurMenu = NULL;
...
void
VPoxDbgStatsView::updateStats(const QString &rPatStr)
{
    m_PatStr = rPatStr;
...
void
VPoxDbgStatsView::resizeColumnsToContent()
{
    for (int i = 0; i <= 8; i++)
    {
...
void
VPoxDbgStatsView::setSubTreeExpanded(QModelIndex const &a_rIndex, bool a_fExpanded)
{
...
void
VPoxDbgStatsView::contextMenuEvent(QContextMenuEvent *a_pEvt)
{
    /*
...
void
VPoxDbgStatsView::headerContextMenuRequested(const QPoint &a_rPos)
{
    /*
     * Show the view menu.
     */
...
void
VPoxDbgStatsView::actAdjColumns()
{
...
VPoxDbgStats::VPoxDbgStats(VPoxDbgGui *a_pDbgGui, const char *pszPat/* = NULL*/, unsigned uRefreshRate/* = 0*/, QWidget *pParent/* = NULL*/)
    : VPoxDbgBaseWindow(a_pDbgGui, pParent, "Statistics")
    , m_PatStr(pszPat), m_pPatCB(NULL), m_uRefreshRate(0), m_pTimer(NULL), m_pView(NULL)
{
     ...
     */
    VPoxDbgStatsModelVM *pModel = new VPoxDbgStatsModelVM(a_pDbgGui, m_PatStr, NULL);
    m_pView = new VPoxDbgStatsView(a_pDbgGui, pModel, this);
...
void
VPoxDbgStats::closeEvent(QCloseEvent *a_pCloseEvt)
{
    a_pCloseEvt->accept();
}
...
void
VPoxDbgStats::apply(const QString &Str)
{
    m_PatStr = Str;
    refresh();
}
...
void
VPoxDbgStats::setRefresh(int iRefresh)
{
