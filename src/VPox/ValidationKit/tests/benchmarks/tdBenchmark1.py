...
"""
VirtualPox Validation Kit - Test that runs various benchmarks.
"""
...
class tdBenchmark1(vpox.TestDriver):
    """
    Benchmark #1.
    """
    ...
    def __init__(self):
        ...
        oTestVm = vpoxtestvms.BootSectorTestVm(self.oTestVmSet, 'tst-bs-test1',
                                               os.path.join(self.sVPoxBootSectors, 'bootsector2-test1.img'));
