...
#define PR_GetDirectorySeparator VPoxNsprPR_GetDirectorySeparator
#define PR_GetDirectorySepartor VPoxNsprPR_GetDirectorySepartor
#define PR_GetPathSeparator VPoxNsprPR_GetPathSeparator
#define PR_GetSystemInfo VPoxNsprPR_GetSystemInfo
#define PR_GetPageSize VPoxNsprPR_GetPageSize
#define PR_GetPageShift VPoxNsprPR_GetPageShift
#define PR_GetNumberOfProcessors VPoxNsprPR_GetNumberOfProcessors
