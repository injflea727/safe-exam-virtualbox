/* $Id: VPoxManageGuestCtrlListener.cpp $ */
/** @file
 * VPoxManage - Guest control listener implementations.
 */
...
STDMETHODIMP GuestFileEventListener::HandleEvent(VPoxEventType_T aType, IEvent *aEvent)
{
    switch (aType)
    {
...
STDMETHODIMP GuestProcessEventListener::HandleEvent(VPoxEventType_T aType, IEvent *aEvent)
{
    switch (aType)
    {
...
STDMETHODIMP GuestSessionEventListener::HandleEvent(VPoxEventType_T aType, IEvent *aEvent)
{
    switch (aType)
    {
        case VPoxEventType_OnGuestFileRegistered:
        {
            HRESULT rc;
            do
            {
        ...
        case VPoxEventType_OnGuestProcessRegistered:
        {
            HRESULT rc;
            do
            {
...
STDMETHODIMP GuestEventListener::HandleEvent(VPoxEventType_T aType, IEvent *aEvent)
{
    switch (aType)
    {
        case VPoxEventType_OnGuestSessionRegistered:
        {
            HRESULT rc;
            do
            {
                ...
                if (fRegistered)
                {
                    ...
                    com::SafeArray<VPoxEventType_T> eventTypes;
                    eventTypes.push_back(VPoxEventType_OnGuestFileRegistered);
                    eventTypes.push_back(VPoxEventType_OnGuestProcessRegistered);
                    CHECK_ERROR_BREAK(es, RegisterListener(pListener, ComSafeArrayAsInParam(eventTypes),
                                                           true /* Active listener */));
