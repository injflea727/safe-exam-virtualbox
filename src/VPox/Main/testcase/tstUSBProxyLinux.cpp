...
} s_testEnvironment[] =
{
    ...
    { "sysfs", "/dev/bus/usb", "/dev/vpoxusb", false, "/proc/usb/bus", false, VINF_SUCCESS, "", true, VERR_NOT_FOUND },
    /* "sysfs" and no root in the environment */
    { "sysfs", NULL, "/dev/vpoxusb", true, NULL, false, VINF_SUCCESS, "/dev/vpoxusb", false, VINF_SUCCESS },
    ...
    { "usbfs", "/dev/bus/usb", "/dev/vpoxusb", false, "/proc/usb/bus", false, VINF_SUCCESS, "", true, VERR_NOT_FOUND },
    ...
    { "invalid", "/dev/bus/usb", "/dev/vpoxusb", true, NULL, false, VINF_SUCCESS, "/dev/vpoxusb", false, VINF_SUCCESS },
    ...
    { "invalid", "/dev/bus/usb", "/dev/vpoxusb", false, NULL, false, VINF_SUCCESS, "", true, VERR_VUSB_USB_DEVICE_PERMISSION },
    ...
    { NULL, NULL, "/dev/vpoxusb", false, "/proc/bus/usb", false, VERR_NO_MEMORY, "", true, VERR_VUSB_USB_DEVICE_PERMISSION },
    /* No environment, sysfs and usbfs available, access permissions for sysfs. */
    { NULL, NULL, "/dev/vpoxusb", true, "/proc/bus/usb", false, VINF_SUCCESS, "/dev/vpoxusb", false, VINF_SUCCESS },
    /* No environment, sysfs and usbfs available, access permissions for usbfs. */
    { NULL, NULL, "/dev/vpoxusb", false, "/proc/bus/usb", true, VINF_SUCCESS, "/proc/bus/usb", true, VINF_SUCCESS },
    /* No environment, sysfs available but without access permissions. */
    { NULL, NULL, "/dev/vpoxusb", false, NULL, false, VERR_NO_MEMORY, "", true, VERR_VUSB_USB_DEVICE_PERMISSION },
...
{
    /* /dev/vpoxusb accessible -> device nodes method available */
    { { NULL }, { "/dev/vpoxusb" }, "/dev/vpoxusb", true, true },
    /* /dev/vpoxusb present but not accessible -> device nodes method not
     * available */
    { { NULL }, { NULL }, "/dev/vpoxusb", true, false },
