...
#ifndef VPOX_INCLUDED_SRC_SharedClipboard_darwin_pasteboard_h
#define VPOX_INCLUDED_SRC_SharedClipboard_darwin_pasteboard_h
...
#endif /* !VPOX_INCLUDED_SRC_SharedClipboard_darwin_pasteboard_h */
