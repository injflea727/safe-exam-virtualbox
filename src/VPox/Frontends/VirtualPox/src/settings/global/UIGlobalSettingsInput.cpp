...
/** @file
 * VPox Qt GUI - UIGlobalSettingsInput class implementation.
 */
...
bool UIGlobalSettingsInput::validate(QList<UIValidationMessage> &messages)
{
    ...
    /* Check VirtualPox Manager page for unique shortcuts: */
...
void UIGlobalSettingsInput::retranslateUi()
{
    ...
    m_pTabWidget->setTabText(UIHotKeyTableIndex_Selector, tr("&VirtualPox Manager"));
