...
/** @file
 * VirtualPox Main - interface for VPox DHCP server
 */
...
int NetworkServiceRunner::start(bool aKillProcessOnStop)
{
     ...
     * ASSUME it is relative to the directory that holds VPoxSVC.
     */
...
int NetworkServiceRunner::stop()
{
    ...
    {
        /*
         * This is a VPoxSVC Main client. Do NOT kill it but assume it was shut
