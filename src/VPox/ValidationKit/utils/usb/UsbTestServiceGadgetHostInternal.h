...
#ifndef VPOX_INCLUDED_SRC_usb_UsbTestServiceGadgetHostInternal_h
#define VPOX_INCLUDED_SRC_usb_UsbTestServiceGadgetHostInternal_h
...
#endif /* !VPOX_INCLUDED_SRC_usb_UsbTestServiceGadgetHostInternal_h */
