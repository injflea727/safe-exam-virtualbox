...
#ifdef VPOX
static const char kDefaultSocketPrefix[] = "\\socket\\vpox-";
#else
...
#else
#ifdef VPOX
static const char kDefaultSocketPrefix[] = "/tmp/.vpox-";
#else
...
void IPC_GetDefaultSocketPath(char *buf, PRUint32 bufLen)
{
    ...
    logName = PR_GetEnv("VPOX_IPC_SOCKETID");
#if defined(VPOX) && defined(XP_UNIX)
