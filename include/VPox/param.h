/** @file
 * VirtualPox Parameter Definitions. (VMM,+)
 *
...
#ifndef VPOX_INCLUDED_param_h
#define VPOX_INCLUDED_param_h
...
/** @defgroup   grp_vpox_param  VPox Parameter Definition
 * @{
 */
...
#if ARCH_BITS == 64
# define VPOX_MAX_ALLOC_PAGE_COUNT   (_512M / PAGE_SIZE)
#else
# define VPOX_MAX_ALLOC_PAGE_COUNT   (_256M / PAGE_SIZE)
#endif

/** @def VPOX_WITH_PAGE_SHARING
...
# define VPOX_WITH_PAGE_SHARING     /* ASM-NOINC */
#endif                              /* ASM-NOINC */


/** @defgroup   grp_vpox_param_mm  Memory Monitor Parameters
 * @{
 */
...
/** @defgroup   grp_vpox_param_pgm  Page Manager Parameters
 * @{
 */
...
/** @defgroup   grp_vpox_param_vmm  VMM Parameters
 * @{
 */
/** VMM stack size. */
#ifdef RT_OS_DARWIN
 ...
 * @{ */
#define VPOX_VENDORID               VPOX_PCI_VENDORID   /**< @todo wonderful choice of name! Please squeeze a _VGA_ or something in there, please. */
#define VPOX_DEVICEID               (0xbeef)            /**< @todo ditto. */
#define VPOX_VESA_VENDORID          VPOX_PCI_VENDORID
#define VPOX_VESA_DEVICEID          (0xbeef)
/** @} */

/** @name VMMDev PCI card identifiers
 * @{ */
#define VMMDEV_VENDORID             VPOX_PCI_VENDORID
...
/** @defgroup grp_vpox_param_misc  Misc
 * @{ */
...
#define VPOX_MAX_GSO_SIZE           0xfff0
