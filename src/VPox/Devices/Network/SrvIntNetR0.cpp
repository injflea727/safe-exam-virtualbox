 ...
 * Retain an interface.
 *
 * @returns VPox status code, can assume success in most situations.
...
#if defined(RT_OS_DARWIN) && !defined(VPOXNETADP_DO_NOT_USE_NETFLT)
            pszName = "VPoxNetFlt";
#else /* VPOXNETADP_DO_NOT_USE_NETFLT */
            pszName = "VPoxNetAdp";
#endif /* VPOXNETADP_DO_NOT_USE_NETFLT */
            break;
#ifndef VPOX_WITH_NAT_SERVICE
        case kIntNetTrunkType_SrvNat:
            pszName = "VPoxSrvNat";
            break;
#endif
