...
/** @file
 * VirtualPox Main - Guest process handling implementation.
 */
...
public:
     ...
     * @{ */
    int i_callbackDispatcher(PVPOXGUESTCTRLHOSTCBCTX pCbCtx, PVPOXGUESTCTRLHOSTCALLBACK pSvcCb);
...
protected:
    ...
    int i_onGuestDisconnected(PVPOXGUESTCTRLHOSTCBCTX pCbCtx, PVPOXGUESTCTRLHOSTCALLBACK pSvcCbData);
    int i_onProcessInputStatus(PVPOXGUESTCTRLHOSTCBCTX pCbCtx, PVPOXGUESTCTRLHOSTCALLBACK pSvcCbData);
    int i_onProcessNotifyIO(PVPOXGUESTCTRLHOSTCBCTX pCbCtx, PVPOXGUESTCTRLHOSTCALLBACK pSvcCbData);
    int i_onProcessStatusChange(PVPOXGUESTCTRLHOSTCBCTX pCbCtx, PVPOXGUESTCTRLHOSTCALLBACK pSvcCbData);
    int i_onProcessOutput(PVPOXGUESTCTRLHOSTCBCTX pCbCtx, PVPOXGUESTCTRLHOSTCALLBACK pSvcCbData);
...
/**
 * Structure for keeping a VPoxService toolbox tool's error info around.
 */
...
/**
 * Internal class for handling the BusyBox-like tools built into VPoxService
 * on the guest side. It's also called the VPoxService Toolbox (tm).
 *
