...
#ifndef VPOX_INCLUDED_intnet_h
#define VPOX_INCLUDED_intnet_h
...
typedef struct INTNETTRUNKIFPORT
{
     ...
     * Transmit a frame.
     *
     * @return  VPox status code. Error generally means we'll drop the frame.
     * @param   pIfPort     Pointer to this structure.
     * @param   pvIfData    Pointer to the trunk's interface data (see
     *                      pfnConnectInterface).
 ...
 * interface filter (like VPoxNetFlt).
 */
