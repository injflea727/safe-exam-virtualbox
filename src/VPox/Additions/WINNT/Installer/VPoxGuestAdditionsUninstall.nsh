; $Id: VPoxGuestAdditionsUninstall.nsh $
;; @file
; VPoxGuestAdditionsUninstall.nsh - Guest Additions uninstallation.
;
...
Function ${un}UninstallCommon
  ...
  ; Remove common files
  Delete /REBOOTOK "$INSTDIR\VPoxDrvInst.exe"
...
!endif
  ...
  Delete /REBOOTOK "$INSTDIR\VPoxGINA.dll"
...
!if $%BUILD_TARGET_ARCH% == "x86"       ; 32-bit
  RMDir /REBOOTOK "$PROGRAMFILES32\$%VPOX_VENDOR_SHORT%"
!else   ; 64-bit
  RMDir /REBOOTOK "$PROGRAMFILES64\$%VPOX_VENDOR_SHORT%"
!endif
