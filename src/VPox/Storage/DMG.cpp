/* $Id: DMG.cpp $ */
/** @file
 * VPoxDMG - Interpreter for Apple Disk Images (DMG).
 */
...
/**
 * VirtualPox Apple Disk Image (DMG) interpreter instance data.
 */
                                 ...
                                 PRTVFSFSSTREAM phXarFss, PRTVFSFILE phDmgFileInXar)
{
     ...
     */
    RTVFSFILE hVfsFile;
#ifdef VPOX_WITH_DIRECT_XAR_ACCESS
