...
/** @file
 * VPox Qt GUI - UIVirtualMachineItem class declarations.
 */
...
public:
    ...
    /** @name VM access attributes.
      * @{ */
        ...
        const CVirtualPoxErrorInfo &accessError() const { return m_comAccessError; }
    /** @} */
...
protected:
    ...
    /** @name VM access attributes.
      * @{ */
        ...
        CVirtualPoxErrorInfo  m_comAccessError;
    /** @} */
