/* $Id: UITaskCloudAcquireInstances.h $ */
/** @file
 * VPox Qt GUI - UITaskCloudAcquireInstances class declaration.
 */
...
public:
    ...
    /** Returns error info. */
    CVirtualPoxErrorInfo errorInfo();
...
private:
    ...
    CVirtualPoxErrorInfo  m_comErrorInfo;
