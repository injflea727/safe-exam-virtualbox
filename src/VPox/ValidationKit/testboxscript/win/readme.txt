...
6b. While in the group policy editor, make sure that  "Computer Configuration"
   ...
   disabled so the vpox account can be created later one.
...
9. Create a user named "vpox" with password "password".  Must be an
   Administrator user!

10. Configure user "vpox" to log in automatically via "control userpasswords2".
...
13. Activate windows. "https://linserv.de.oracle.com/vpox/wiki/MSDN Volume License Keys"
