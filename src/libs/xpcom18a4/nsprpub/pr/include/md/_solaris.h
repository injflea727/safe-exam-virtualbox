...
#if defined(_LARGEFILE64_SOURCE)                                    /* vpox */
#define _PR_HAVE_OFF64_T                                            /* vpox */
#elif defined(_LP64) || _FILE_OFFSET_BITS == 32                     /* vpox */
#define _PR_HAVE_LARGE_OFF_T                                        /* vpox */
#else                                                               /* vpox */
#define _PR_NO_LARGE_FILES                                          /* vpox */
#endif                                                              /* vpox */
...
#if !defined(_XPG4_2) || defined(_XPG6) || defined(__EXTENSIONS__)  /* vpox */
#define _PR_INET6                                                   /* vpox */
#endif                                                              /* vpox */
#ifdef _PR_INET6
