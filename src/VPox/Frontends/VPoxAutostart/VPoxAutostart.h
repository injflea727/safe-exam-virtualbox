...
#ifndef VPOX_INCLUDED_SRC_VPoxAutostart_VPoxAutostart_h
#define VPOX_INCLUDED_SRC_VPoxAutostart_VPoxAutostart_h
...
#endif /* !VPOX_INCLUDED_SRC_VPoxAutostart_VPoxAutostart_h */
