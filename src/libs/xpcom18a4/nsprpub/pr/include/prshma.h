...
#define PR_OpenAnonFileMap VPoxNsprPR_OpenAnonFileMap
#define PR_ProcessAttrSetInheritableFileMap VPoxNsprPR_ProcessAttrSetInheritableFileMap
#define PR_GetInheritedFileMap VPoxNsprPR_GetInheritedFileMap
#define PR_ExportFileMapAsString VPoxNsprPR_ExportFileMapAsString
#define PR_ImportFileMapFromString VPoxNsprPR_ImportFileMapFromString
