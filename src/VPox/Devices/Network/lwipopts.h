...
#ifndef VPOX_INCLUDED_SRC_Network_lwipopts_h
#define VPOX_INCLUDED_SRC_Network_lwipopts_h
...
/* Align VPOX_STRICT and LWIP_NOASSERT. */
#ifndef VPOX_STRICT
...
#endif /* !VPOX_INCLUDED_SRC_Network_lwipopts_h */
