...
#define PR_NewSem VPoxNsprPR_NewSem
#define PR_DestroySem VPoxNsprPR_DestroySem
#define PR_WaitSem VPoxNsprPR_WaitSem
#define PR_PostSem VPoxNsprPR_PostSem
#define PR_GetValueSem VPoxNsprPR_GetValueSem
