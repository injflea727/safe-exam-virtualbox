...
#ifndef VPOX_INCLUDED_vmm_gmm_h
#define VPOX_INCLUDED_vmm_gmm_h
 ...
 */
#ifdef IN_GMM_R0
# define GMMR0DECL(type)    DECLEXPORT(type) VPOXCALL
#else
# define GMMR0DECL(type)    DECLIMPORT(type) VPOXCALL
#endif
 ...
 */
#ifdef IN_GMM_R3
# define GMMR3DECL(type)    DECLEXPORT(type) VPOXCALL
#else
# define GMMR3DECL(type)    DECLIMPORT(type) VPOXCALL
#endif
