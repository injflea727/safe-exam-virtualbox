...
/** @file
 * VPox Qt GUI - UICloudProfileManager class implementation.
 */
...
void UICloudProfileManagerWidget::sltApplyCloudProfileDetailsChanges()
{
    ...
    /* Get VirtualPox for further activities: */
    ...
    if (!comVPox.isOk())
        msgCenter().cannotAcquireCloudProviderManager(comVPox, this);
    else
    {
        /* Get provider item: */
...
void UICloudProfileManagerWidget::loadCloudStuff()
{
    ...
    /* Get CloudProviderManager for further activities: */
    const CCloudProviderManager comCloudProviderManager = comVPox.GetCloudProviderManager();
    /* Show error message if necessary: */
    if (!comVPox.isOk())
        msgCenter().cannotAcquireCloudProviderManager(comVPox, this);
    else
