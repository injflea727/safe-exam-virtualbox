...
#ifndef __VPOX_LWIP_LOG_H__
#define __VPOX_LWIP_LOG_H__
...
#  define LWIP_DEBUGF(_when, _args) \
     do { \
         const VPOXLOGGROUP _group = (_when) >> LWIP_DEBUGF_LOG_GROUP_SHIFT; \
