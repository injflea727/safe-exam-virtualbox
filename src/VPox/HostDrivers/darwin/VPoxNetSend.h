/* $Id: VPoxNetSend.h $ */
/** @file
 * A place to share code and definitions between VPoxNetAdp and VPoxNetFlt host drivers.
 */
...
/** @todo move this to src/VPox/HostDrivers/darwin as a .cpp file. */

#ifndef VPOX_INCLUDED_SRC_darwin_VPoxNetSend_h
#define VPOX_INCLUDED_SRC_darwin_VPoxNetSend_h
 ...
 *
 * Most of this function was copied from vpoxNetFltDarwinMBufFromSG().
 *
 ...
 */
DECLINLINE(int) VPoxNetSendDummy(ifnet_t pIfNet)
{
    int rc = VINF_SUCCESS;
...
#endif /* !VPOX_INCLUDED_SRC_darwin_VPoxNetSend_h */
