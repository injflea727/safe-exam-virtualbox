...
#define PR_OpenSemaphore VPoxNsprPR_OpenSemaphore
#define PR_WaitSemaphore VPoxNsprPR_WaitSemaphore
#define PR_PostSemaphore VPoxNsprPR_PostSemaphore
#define PR_CloseSemaphore VPoxNsprPR_CloseSemaphore
#define PR_DeleteSemaphore VPoxNsprPR_DeleteSemaphore
