 ...
 * already in the set.
 *
 * @returns VPox status code, see pgmRZDynMapGCPageCommon for details.
 * @param   pVM         The cross context VM structure.
 * @param   pVCpu       The cross context virtual CPU structure.
...
#endif
        AssertPtr(pTlbe->pv);
#if defined(IN_RING3) || (!defined(VPOX_WITH_2X_4GB_ADDR_SPACE_IN_R0) && !defined(VPOX_WITH_RAM_IN_KERNEL))
