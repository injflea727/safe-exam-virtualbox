...
#ifndef VPOX_INCLUDED_SRC_Graphics_HGSMI_HGSMIHost_h
#define VPOX_INCLUDED_SRC_Graphics_HGSMI_HGSMIHost_h
...
#endif /* !VPOX_INCLUDED_SRC_Graphics_HGSMI_HGSMIHost_h */
