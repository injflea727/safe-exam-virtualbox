...
#define PRP_DestroyNakedCondVar VPoxNsprPRP_DestroyNakedCondVar
#define PRP_NakedBroadcast VPoxNsprPRP_NakedBroadcast
#define PRP_NakedNotify VPoxNsprPRP_NakedNotify
#define PRP_NakedWait VPoxNsprPRP_NakedWait
#define PRP_NewNakedCondVar VPoxNsprPRP_NewNakedCondVar
#define PRP_TryLock VPoxNsprPRP_TryLock
