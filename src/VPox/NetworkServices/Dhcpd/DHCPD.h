...
#ifndef VPOX_INCLUDED_SRC_Dhcpd_DHCPD_h
#define VPOX_INCLUDED_SRC_Dhcpd_DHCPD_h
 ...
 *
 * This class is feed DhcpClientMessages that VPoxNetDhcpd has picked up from
 * the network.  After processing a message it returns the appropriate response
 * (if any) which VPoxNetDhcpd sends out.
 */
class DHCPD
{
...
#endif /* !VPOX_INCLUDED_SRC_Dhcpd_DHCPD_h */
