...
#ifndef VPOX_INCLUDED_SRC_usb_UsbTestServiceProtocol_h
#define VPOX_INCLUDED_SRC_usb_UsbTestServiceProtocol_h
...
#endif /* !VPOX_INCLUDED_SRC_usb_UsbTestServiceProtocol_h */
