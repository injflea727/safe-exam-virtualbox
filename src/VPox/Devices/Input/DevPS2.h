...
#ifndef VPOX_INCLUDED_SRC_Input_DevPS2_h
#define VPOX_INCLUDED_SRC_Input_DevPS2_h
 ...
 * @{ */
/** The highest USB usage code reported by VirtualPox. */
...
#endif /* !VPOX_INCLUDED_SRC_Input_DevPS2_h */
