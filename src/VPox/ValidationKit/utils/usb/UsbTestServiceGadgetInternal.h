...
#ifndef VPOX_INCLUDED_SRC_usb_UsbTestServiceGadgetInternal_h
#define VPOX_INCLUDED_SRC_usb_UsbTestServiceGadgetInternal_h
...
#endif /* !VPOX_INCLUDED_SRC_usb_UsbTestServiceGadgetInternal_h */
