...
/** @file
 * VPox Qt GUI - UIMachineLogicFullscreen class implementation.
 */
...
void UIMachineLogicFullscreen::nativeHandlerForApplicationActivation(const QMap<QString, QString> &userInfo)
{
    ...
    ourBundleIdentifiers << "org.virtualpox.app.VirtualPox";
    ourBundleIdentifiers << "org.virtualpox.app.VirtualPoxVM";
