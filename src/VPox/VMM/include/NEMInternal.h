...
#include <VPox/vmm/cpum.h> /* For CPUMCPUVENDOR. */
...
#if defined(VPOX_WITH_PGM_NEM_MODE) && !defined(VPOX_WITH_NATIVE_NEM)
# error "VPOX_WITH_PGM_NEM_MODE requires VPOX_WITH_NATIVE_NEM to be defined"
#endif
...
# endif
# if defined(VPOX_WITH_PGM_NEM_MODE) && defined(NEM_WIN_USE_HYPERCALLS_FOR_PAGES)
#  error "VPOX_WITH_PGM_NEM_MODE cannot be used together with NEM_WIN_USE_HYPERCALLS_FOR_PAGES"
# endif
