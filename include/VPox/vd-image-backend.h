...
#ifndef VPOX_INCLUDED_vd_image_backend_h
#define VPOX_INCLUDED_vd_image_backend_h
...
#include <VPox/vd-ifs-internal.h>


/** @name VPox HDD backend write flags
 * @{
 */
...
/** @name VPox HDD backend discard flags
 * @{
 */
...
/** @name VPox HDD backend metadata traverse flags
 * @{
 */
...
/**
 * Image format backend interface used by VPox HDD Container implementation.
 */
...
#endif /* !VPOX_INCLUDED_vd_image_backend_h */
