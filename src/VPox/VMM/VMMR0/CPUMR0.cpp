...
# endif
    ...
    else
    {
        ...
        SUPR0Printf("VPox/CPUM: Unsupported APIC version %#x (iCpu=%d)\n", uApicVersion, iCpu);
    }
}
...
# ifdef LOG_ENABLED
    /*
     * Log the result (pretty useless, requires enabling CPUM in VPoxDrv
     * and !VPOX_WITH_R0_LOGGING).
     */
    if (LogIsEnabled())
    {
        uint32_t cEnabled = 0;
...
#endif /* VPOX_WITH_VMMR0_DISABLE_LAPIC_NMI */
