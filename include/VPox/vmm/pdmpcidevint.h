...
#ifndef VPOX_INCLUDED_vmm_pdmpcidevint_h
#define VPOX_INCLUDED_vmm_pdmpcidevint_h
 ...
 */
typedef DECLCALLBACK(VPOXSTRICTRC) FNPCIBRIDGECONFIGREAD(PPDMDEVINSR3 pDevIns, uint8_t iBus, uint8_t iDevice,
 ...
 */
typedef DECLCALLBACK(VPOXSTRICTRC) FNPCIBRIDGECONFIGWRITE(PPDMDEVINSR3 pDevIns, uint8_t iBus, uint8_t iDevice,
...
typedef struct PDMPCIDEVINT
{
    ...
    /** I/O regions. */
    PCIIOREGION                     aIORegions[VPOX_PCI_NUM_REGIONS];
    /** @}  */
} PDMPCIDEVINT;
...
#endif /* !VPOX_INCLUDED_vmm_pdmpcidevint_h */
