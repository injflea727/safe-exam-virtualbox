 ...
 *          the old APIC code which is in VPoxDD2 and not in
 *          the VMM module.
 */
 ...
 * combined register set when the VPox debugger is actually using hardware BPs,
...
VMMDECL(uint32_t) CPUMGetGuestCPL(PVMCPU pVCpu)
{
     ...
     *         or not.  VPox or qemu bug must've lead to this misconception.
     *
