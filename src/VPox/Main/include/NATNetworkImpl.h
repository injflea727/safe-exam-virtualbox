/* $Id: NATNetworkImpl.h $ */
/** @file
 * INATNetwork implementation header, lives in VPoxSVC.
 */
...
#ifdef RT_OS_WINDOWS
# define NATSR_EXECUTABLE_NAME "VPoxNetNAT.exe"
#else
# define NATSR_EXECUTABLE_NAME "VPoxNetNAT"
#endif
...
public:
    ...
    HRESULT init(VirtualPox *aVirtualPox, com::Utf8Str aName);
