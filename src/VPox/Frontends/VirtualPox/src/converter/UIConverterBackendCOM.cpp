...
/** @file
 * VPox Qt GUI - UIConverterBackendCOM implementation.
 */
...
template<> QString toString(const KGraphicsControllerType &type)
{
    switch (type)
    {
        ...
        case KGraphicsControllerType_VPoxVGA:  return QApplication::translate("UICommon", "VPoxVGA",  "GraphicsControllerType");
        case KGraphicsControllerType_VMSVGA:   return QApplication::translate("UICommon", "VMSVGA",   "GraphicsControllerType");
        case KGraphicsControllerType_VPoxSVGA: return QApplication::translate("UICommon", "VPoxSVGA", "GraphicsControllerType");
        default: AssertMsgFailed(("No text for %d", type)); break;
    }
    return QString();
}
...
template<> KGraphicsControllerType fromString<KGraphicsControllerType>(const QString &strType)
{
    ...
    list.insert(QApplication::translate("UICommon", "VPoxVGA",  "GraphicsControllerType"), KGraphicsControllerType_VPoxVGA);
    list.insert(QApplication::translate("UICommon", "VMSVGA",   "GraphicsControllerType"), KGraphicsControllerType_VMSVGA);
    list.insert(QApplication::translate("UICommon", "VPoxSVGA", "GraphicsControllerType"), KGraphicsControllerType_VPoxSVGA);
