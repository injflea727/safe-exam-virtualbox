...
int main(int argc, char *argv[])
{
    ...
    static const char szPidFile[RTPATH_MAX] = "/var/run/VPoxDRMClient";
    RTFILE hPidFile;
    ...
    {
        VBClLogInfo("VPoxDRMClient: already running, exiting\n");
        return RTEXITCODE_SUCCESS;
    }
    else if (RT_FAILURE(rc))
    {
        VBClLogError("VPoxDRMClient: unable to lock PID file (%Rrc), exiting\n", rc);
    ...
    VBClLogInfo("VPoxDRMClient: releasing PID file lock\n");
