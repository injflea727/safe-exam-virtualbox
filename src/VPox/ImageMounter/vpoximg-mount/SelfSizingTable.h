...
#ifndef VPOX_INCLUDED_SRC_vpoximg_mount_SelfSizingTable_h
#define VPOX_INCLUDED_SRC_vpoximg_mount_SelfSizingTable_h
...
#endif /* !VPOX_INCLUDED_SRC_vpoximg_mount_SelfSizingTable_h */
