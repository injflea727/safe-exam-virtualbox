/* $Id: VPoxAcpi.cpp $ */
/** @file
 * VPoxAcpi - VirtualPox ACPI manipulation functionality.
 */
...
/* vpox.dsl - input to generate proper DSDT on the fly */
# include <vpoxdsl.hex>
#else
/* Statically compiled AML */
# include <vpoxaml.hex>
# include <vpoxssdt_standard.hex>
# include <vpoxssdt_cpuhotplug.hex>
#endif
