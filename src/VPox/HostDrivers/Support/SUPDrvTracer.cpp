/* $Id: SUPDrvTracer.cpp $ */
/** @file
 * VPoxDrv - The VirtualPox Support Driver - Tracer Interface.
 */
...
int VPOXCALL supdrvTracerInit(PSUPDRVDEVEXT pDevExt)
{
    ...
    if (RT_SUCCESS(rc))
    {
        ...
        rc = supdrvTracerRegisterVtgObj(pDevExt, &g_VTGObjHeader, NULL /*pImage*/, NULL /*pSession*/, NULL /*pUmod*/, "vpoxdrv");
        if (RT_SUCCESS(rc))
            return rc;
