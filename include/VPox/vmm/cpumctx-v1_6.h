...
#ifndef VPOX_INCLUDED_vmm_cpumctx_v1_6_h
#define VPOX_INCLUDED_vmm_cpumctx_v1_6_h
...
typedef struct VPOXIDTR_VER1_6
{
    /** Size of the IDT. */
    uint16_t    cbIdt;
    /** Address of the IDT. */
...
typedef struct VPOXGDTR_VER1_6
{
    /** Size of the GDT. */
    uint16_t    cbGdt;
    /** Address of the GDT. */
...
#endif /* !VPOX_INCLUDED_vmm_cpumctx_v1_6_h */
