...
# include <VPox/sup.h>
#endif
#if !defined(VPOX_WITH_HARDENING) || !defined(VPOX_RUNTIME_UI)
...
#endif
#if defined(VPOX_RUNTIME_UI) && defined(VPOX_WS_MAC)
# include <iprt/path.h>
#endif
...
QString g_QStrHintLinuxNoDriver = QApplication::tr(
    "The VirtualPox Linux kernel driver is either not loaded or not set "
    "up correctly. Please try setting it up again by executing<br/><br/>"
    "  <font color=blue>'/sbin/vpoxconfig'</font><br/><br/>"
    "as root.<br/><br/>"
    "If your system has EFI Secure Boot enabled you may also need to sign "
    "the kernel modules (vpoxdrv, vpoxnetflt, vpoxnetadp, vpoxpci) before "
    "you can load them. Please see your Linux system's documentation for "
    "more information."
    );

QString g_QStrHintOtherWrongDriverVersion = QApplication::tr(
    "The VirtualPox kernel modules do not match this version of "
    "VirtualPox. The installation of VirtualPox was apparently not "
...
QString g_QStrHintLinuxWrongDriverVersion = QApplication::tr(
    ...
    "of VirtualPox from different sources."
    );
...
QString g_QStrHintReinstall = QApplication::tr(
    "Please try reinstalling VirtualPox."
    );
...
static void ShowHelp()
{
    ...
    static const char s_szTitle[] = VPOX_PRODUCT " VM Selector";
#else
    static const char s_szTitle[] = VPOX_PRODUCT " VM Runner";
#endif
...
# ifdef VPOX_WITH_DEBUGGER_GUI
        ...
        "  VPOX_GUI_DBG_ENABLED (GUI/Dbg/Enabled)\n"
        "                             enable the GUI debug menu if set\n"
        "  VPOX_GUI_DBG_AUTO_SHOW (GUI/Dbg/AutoShow)\n"
        "                             show debug windows at VM startup\n"
        "  VPOX_GUI_NO_DEBUGGER\n"
        "                             disable the GUI debug menu and debug windows\n"
# endif /* VPOX_WITH_DEBUGGER_GUI */
#else
        "No special options.\n"
        "\n"
        "If you are looking for --startvm and related options, you need to use VirtualPoxVM.\n"
#endif
        ;
...
# if defined(RT_OS_DARWIN) && defined(VPOX_RUNTIME_UI)
/** Init runtime with the executable path pointing into the
 * VirtualPox.app/Contents/MacOS/ rather than
 * VirtualPox.app/Contents/Resource/VirtualPoxVM.app/Contents/MacOS/.
 *
...
DECL_NO_INLINE(static, int) initIprtForDarwinHelperApp(int cArgs, char ***ppapszArgs, uint32_t fFlags)
{
    ...
    if (psz)
    {
        ...
        if (pszFilename)
        {
            ...
            *pszFilename = '\0';
            RTPathStripTrailingSlash(szTmpPath); /* VirtualPox.app/Contents/Resources/VirtualPoxVM.app/Contents/MacOS */
            RTPathStripFilename(szTmpPath);      /* VirtualPox.app/Contents/Resources/VirtualPoxVM.app/Contents/ */
            RTPathStripFilename(szTmpPath);      /* VirtualPox.app/Contents/Resources/VirtualPoxVM.app */
            RTPathStripFilename(szTmpPath);      /* VirtualPox.app/Contents/Resources */
            RTPathStripFilename(szTmpPath);      /* VirtualPox.app/Contents */
...
# endif
        ...
        QString strTitle = QApplication::tr("VirtualPox - Runtime Error");
...
#endif /* !VPOX_WITH_HARDENING || !VPOX_RUNTIME_UI */
 ...
 * @param   rc          The VPox status code corresponding to the error.
...
# endif /* VPOX_WS_X11 */
    ...
    QMessageBox::critical(0, QApplication::tr("VirtualPox - Error In %1").arg(pszWhere), strText);
