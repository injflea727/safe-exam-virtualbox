/* $Id: VPoxVgaGraphicsOutput.c $ */
/** @file
 * VPoxVgaGraphicsOutput.c
 */
...
STATIC
EFI_STATUS
VPoxVgaCompleteModeData (
  IN  VPOX_VGA_PRIVATE_DATA    *Private,
...
EFI_STATUS
EFIAPI
VPoxVgaGraphicsOutputQueryMode (
...
--*/
{
  ...
  Private = VPOX_VGA_PRIVATE_DATA_FROM_GRAPHICS_OUTPUT_THIS (This);
...
--*/
{
  ...
  InitializeGraphicsMode (Private, &VPoxVgaVideoModes[ModeData->ModeNumber]);
  ...
  VPoxVgaCompleteModeData (Private, This->Mode);
  ...
  )
{
  ...
  GraphicsOutput->QueryMode = VPoxVgaGraphicsOutputQueryMode;
  GraphicsOutput->SetMode   = VPoxVgaGraphicsOutputSetMode;
  GraphicsOutput->Blt       = VPoxVgaGraphicsOutputBlt;
  ...
  //
  VPoxVgaGetVmVariable(EFI_INFO_INDEX_HORIZONTAL_RESOLUTION, (CHAR8 *)&HorizontalResolution,
                       sizeof(HorizontalResolution));
  VPoxVgaGetVmVariable(EFI_INFO_INDEX_VERTICAL_RESOLUTION, (CHAR8 *)&VerticalResolution,
  ...
  {
    VPoxVgaGetVmVariable(EFI_INFO_INDEX_GRAPHICS_MODE, (CHAR8 *)&Index, sizeof(Index));
