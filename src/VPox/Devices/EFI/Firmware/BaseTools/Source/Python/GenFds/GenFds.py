...
class GenFds(object):
    ...
    def DisplayFvSpaceInfo(FdfParserObject):
        ...
        GenFdsGlobalVariable.QuietLogger('\nFV Space Information') # VPox: We want this info in -quiet builds too.
        for FvSpaceInfo in FvSpaceInfoList:
            ...
            GenFdsGlobalVariable.QuietLogger(Name + ' ' + '[' + Percentage + '%Full] ' + str(TotalSizeValue) + ' total, ' + str(UsedSizeValue) + ' used, ' + str(FreeSizeValue) + ' free') # VPox: Same as above.
    ...
    def GenerateGuidXRefFile(BuildDb, ArchList, FdfParserObj):
       ...
       # Append GUIDs, Protocols, and PPIs to the Xref file
        ...
        if GuidXRefFile:
            ...
            GenFdsGlobalVariable.QuietLogger("\nGUID cross reference file can be found at %s" % GuidXRefFileName) # VPox: We want this info in -quiet builds too.
