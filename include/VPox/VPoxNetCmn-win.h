/* $Id: VPoxNetCmn-win.h $ */
/** @file
 * VPoxNetCmn-win.h - NDIS6 Networking Driver Common Definitions, Windows-specific code.
 */
...
#ifndef VPOX_INCLUDED_VPoxNetCmn_win_h
#define VPOX_INCLUDED_VPoxNetCmn_win_h
...
DECLHIDDEN(void) vpoxNetCmnWinDumpOidRequest(const char *pcszFunction, PNDIS_OID_REQUEST pRequest)
{
# ifdef LOG_ENABLED
    const char *pszType;
...
#endif /* !VPOX_INCLUDED_VPoxNetCmn_win_h */
