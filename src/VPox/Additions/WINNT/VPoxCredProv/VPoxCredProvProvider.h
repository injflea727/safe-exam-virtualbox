...
#ifndef GA_INCLUDED_SRC_WINNT_VPoxCredProv_VPoxCredProvProvider_h
#define GA_INCLUDED_SRC_WINNT_VPoxCredProv_VPoxCredProvProvider_h
...
class VPoxCredProvProvider : public ICredentialProvider
{
public:
    ...
    friend HRESULT VPoxCredProvProviderCreate(REFIID riid, __deref_out void **ppvInterface);

protected:

    VPoxCredProvProvider(void);
    virtual ~VPoxCredProvProvider(void);
...
private:
    ...
    VPoxCredProvCredential                  *m_pCred;
    /** Poller thread for credential lookup. */
    VPoxCredProvPoller                      *m_pPoller;
...
#endif /* !GA_INCLUDED_SRC_WINNT_VPoxCredProv_VPoxCredProvProvider_h */
