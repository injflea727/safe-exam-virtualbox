...
<xsl:template match="/idl">
  <xsl:comment>
    ...
    Generator : src/VPox/Installer/win/VirtualPox_Interfaces.xsl
...
<xsl:template match="library//module/class">
  <Class>
    ...
    <xsl:attribute name="Server">
      <xsl:choose>
        <xsl:when test="$a_sTarget = 'VPoxClient-x86' and ../@name = 'VPoxC'"><xsl:text>VPoxClient_x86</xsl:text></xsl:when>
...
<!--
  ...
  CInterfaceStubVtbl::header::DispatchTableCount with in VirtualPox_p.c!
  -->
