...
--- @file
-- VPox Test Manager Database - Adds an sRepository to Builds and creates a new VcsRepositories table.
--
...
CREATE TABLE NewBuildCategories (
    ...
    --- Product.
    -- The product name.  For instance 'VPox' or 'VPoxTestSuite'.
...
INSERT INTO NewBuildCategories (idBuildCategory, sProduct, sRepository, sBranch, sType, asOsArches)
    SELECT idBuildCategory, sProduct, 'vpox', sBranch, sType, asOsArches
