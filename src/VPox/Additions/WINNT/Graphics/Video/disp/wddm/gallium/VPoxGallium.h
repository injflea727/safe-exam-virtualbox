...
#ifndef GA_INCLUDED_SRC_WINNT_Graphics_Video_disp_wddm_gallium_VPoxGallium_h
#define GA_INCLUDED_SRC_WINNT_Graphics_Video_disp_wddm_gallium_VPoxGallium_h
...
HRESULT GaD3DResourceSynchMem(struct VPOXWDDMDISP_RESOURCE *pRc, bool fToBackend);

#endif /* !GA_INCLUDED_SRC_WINNT_Graphics_Video_disp_wddm_gallium_VPoxGallium_h */
