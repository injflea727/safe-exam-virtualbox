 ...
 *  provided or needed for calling the VirtualPox API. The header file also
 ...
 *
 *  Header file which provides C declarations for VirtualPox Main API
 ...
 *  Generator : src/VPox/Main/cbinding/capiidl.xsl
 *
...
#ifndef ___VirtualPox_CAPI_h
#define ___VirtualPox_CAPI_h
...
#ifdef WIN32
# ifdef IN_VPOXCAPI
#  define VPOXCAPI_DECL(type) extern __declspec(dllexport) type
# else /* !IN_VPOXCAPI */
#  define VPOXCAPI_DECL(type) __declspec(dllimport) type
# endif /* !IN_VPOXCAPI */
#endif /* WIN32 */

#ifdef __cplusplus
/* The C++ treatment in this file is not meant for SDK users, it only exists
 * so that this file can be used to produce the VPoxCAPI shared library which
...
#ifdef __GNUC__
# define VPOX_EXTERN_CONST(type, name) extern const type name __attribute__((nocommon))
#else /* !__GNUC__ */
# define VPOX_EXTERN_CONST(type, name) extern const type name
#endif /* !__GNUC__ */

/* Treat WIN32 completely separately, as on Windows VirtualPox uses COM, not
...
#ifdef IN_VPOXCAPI
# define VPOXCAPI_DECL(type) PR_EXPORT(type)
#else /* !IN_VPOXCAPI */
# define VPOXCAPI_DECL(type) PR_IMPORT(type)
#endif /* !IN_VPOXCAPI */
...
# define PR_IntervalNow VPoxNsprPR_IntervalNow
# define PR_TicksPerSecond VPoxNsprPR_TicksPerSecond
# define PR_SecondsToInterval VPoxNsprPR_SecondsToInterval
# define PR_MillisecondsToInterval VPoxNsprPR_MillisecondsToInterval
# define PR_MicrosecondsToInterval VPoxNsprPR_MicrosecondsToInterval
# define PR_IntervalToSeconds VPoxNsprPR_IntervalToSeconds
# define PR_IntervalToMilliseconds VPoxNsprPR_IntervalToMilliseconds
# define PR_IntervalToMicroseconds VPoxNsprPR_IntervalToMicroseconds
# define PR_EnterMonitor VPoxNsprPR_EnterMonitor
# define PR_ExitMonitor VPoxNsprPR_ExitMonitor
# define PR_Notify VPoxNsprPR_Notify
# define PR_NotifyAll VPoxNsprPR_NotifyAll
# define PR_Wait VPoxNsprPR_Wait
# define PR_NewMonitor VPoxNsprPR_NewMonitor
# define PR_DestroyMonitor VPoxNsprPR_DestroyMonitor
#endif /* VPOX_WITH_XPCOM_NAMESPACE_CLEANUP */
...
#ifdef VPOX_WITH_XPCOM_NAMESPACE_CLEANUP
# define PR_CreateThread VPoxNsprPR_CreateThread
# define PR_JoinThread VPoxNsprPR_JoinThread
# define PR_Sleep VPoxNsprPR_Sleep
# define PR_GetCurrentThread VPoxNsprPR_GetCurrentThread
# define PR_GetThreadState VPoxNsprPR_GetThreadState
# define PR_SetThreadPrivate VPoxNsprPR_SetThreadPrivate
# define PR_GetThreadPrivate VPoxNsprPR_GetThreadPrivate
# define PR_NewThreadPrivateIndex VPoxNsprPR_NewThreadPrivateIndex
# define PR_GetThreadPriority VPoxNsprPR_GetThreadPriority
# define PR_SetThreadPriority VPoxNsprPR_SetThreadPriority
# define PR_Interrupt VPoxNsprPR_Interrupt
# define PR_ClearInterrupt VPoxNsprPR_ClearInterrupt
# define PR_BlockInterrupt VPoxNsprPR_BlockInterrupt
# define PR_UnblockInterrupt VPoxNsprPR_UnblockInterrupt
# define PR_GetThreadScope VPoxNsprPR_GetThreadScope
# define PR_GetThreadType VPoxNsprPR_GetThreadType
#endif /* VPOX_WITH_XPCOM_NAMESPACE_CLEANUP */
...
#ifdef VPOX_WITH_XPCOM_NAMESPACE_CLEANUP
# define PR_DestroyLock VPoxNsprPR_DestroyLock
# define PR_Lock VPoxNsprPR_Lock
# define PR_NewLock VPoxNsprPR_NewLock
# define PR_Unlock VPoxNsprPR_Unlock
#endif /* VPOX_WITH_XPCOM_NAMESPACE_CLEANUP */
...
#ifdef VPOX_WITH_XPCOM_NAMESPACE_CLEANUP
# define PR_NewCondVar VPoxNsprPR_NewCondVar
# define PR_DestroyCondVar VPoxNsprPR_DestroyCondVar
# define PR_WaitCondVar VPoxNsprPR_WaitCondVar
# define PR_NotifyCondVar VPoxNsprPR_NotifyCondVar
# define PR_NotifyAllCondVar VPoxNsprPR_NotifyAllCondVar
#endif /* VPOX_WITH_XPCOM_NAMESPACE_CLEANUP */
...
#ifdef VPOX_WITH_XPCOM_NAMESPACE_CLEANUP
# define PL_DestroyEvent VPoxNsplPL_DestroyEvent
# define PL_HandleEvent VPoxNsplPL_HandleEvent
# define PL_InitEvent VPoxNsplPL_InitEvent
# define PL_CreateEventQueue VPoxNsplPL_CreateEventQueue
# define PL_CreateMonitoredEventQueue VPoxNsplPL_CreateMonitoredEventQueue
# define PL_CreateNativeEventQueue VPoxNsplPL_CreateNativeEventQueue
# define PL_DequeueEvent VPoxNsplPL_DequeueEvent
# define PL_DestroyEventQueue VPoxNsplPL_DestroyEventQueue
# define PL_EventAvailable VPoxNsplPL_EventAvailable
# define PL_EventLoop VPoxNsplPL_EventLoop
# define PL_GetEvent VPoxNsplPL_GetEvent
# define PL_GetEventOwner VPoxNsplPL_GetEventOwner
# define PL_GetEventQueueMonitor VPoxNsplPL_GetEventQueueMonitor
# define PL_GetEventQueueSelectFD VPoxNsplPL_GetEventQueueSelectFD
# define PL_MapEvents VPoxNsplPL_MapEvents
# define PL_PostEvent VPoxNsplPL_PostEvent
# define PL_PostSynchronousEvent VPoxNsplPL_PostSynchronousEvent
# define PL_ProcessEventsBeforeID VPoxNsplPL_ProcessEventsBeforeID
# define PL_ProcessPendingEvents VPoxNsplPL_ProcessPendingEvents
# define PL_RegisterEventIDFunc VPoxNsplPL_RegisterEventIDFunc
# define PL_RevokeEvents VPoxNsplPL_RevokeEvents
# define PL_UnregisterEventIDFunc VPoxNsplPL_UnregisterEventIDFunc
# define PL_WaitForEvent VPoxNsplPL_WaitForEvent
# define PL_IsQueueNative VPoxNsplPL_IsQueueNative
# define PL_IsQueueOnCurrentThread VPoxNsplPL_IsQueueOnCurrentThread
# define PL_FavorPerformanceHint VPoxNsplPL_FavorPerformanceHint
#endif /* VPOX_WITH_XPCOM_NAMESPACE_CLEANUP */
 ...
 * Use VPoxGetCAPIFunctions() to obtain the pointer to it.
 */
typedef struct VPOXCAPI
{
    ...
    /** Gets the VirtualPox version, major * 1000000 + minor * 1000 + patch. */
    unsigned int (*pfnGetVersion)(void);

    /** Gets the VirtualPox API version, major * 1000 + minor, e.g. 4003. */
     ...
     * multithreaded ones), and even VPoxSVC crashes can be detected and
     * processed appropriately by listening for events from the associated
     * event source in VirtualPoxClient. It is completely up to the client
     ...
     *
     * @param pszVirtualPoxClientIID    pass IVIRTUALPOXCLIENT_IID_STR
     * @param ppVirtualPoxClient        output parameter for VirtualPoxClient
     ...
     *
     * @param pszVirtualPoxIID      pass IVIRTUALPOX_IID_STR
     * @param ppVirtualPox          output parameter for VirtualPox reference,
     *          owned by C bindings
...
/** Pointer to a const VPOXCAPI function table. */
typedef VPOXCAPI const *PCVPOXCAPI;
#ifndef WIN32
/** Backwards compatibility: Pointer to a const VPOXCAPI function table.
 * Use PCVPOXCAPI instead. */
typedef VPOXCAPI const *PCVPOXXPCOM;
#endif /* !WIN32 */

#ifndef WIN32
/** Backwards compatibility: make sure old code using VPOXXPCOMC still compiles.
 * Use VPOXCAPI instead. */
#define VPOXXPCOMC VPOXCAPI
#endif /* !WIN32 */

/** Extract the C API style major version.
 * Useful for comparing the interface version in VPOXCAPI::uVersion. */
#define VPOX_CAPI_MAJOR(x) (((x) &amp; 0xffff0000U) &gt;&gt; 16)

/** Extract the C API style major version.
 * Useful for comparing the interface version in VPOXCAPI::uVersion. */
#define VPOX_CAPI_MINOR(x) ((x) &amp; 0x0000ffffU)

/** The current interface version.
 * For use with VPoxGetCAPIFunctions and to be found in VPOXCAPI::uVersion. */
#define VPOX_CAPI_VERSION 0x00040001U

#ifndef WIN32
/** Backwards compatibility: The current interface version.
 * Use VPOX_CAPI_VERSION instead. */
#define VPOX_XPCOMC_VERSION VPOX_CAPI_VERSION
#endif /* !WIN32 */

/** VPoxGetCAPIFunctions. */
VPOXCAPI_DECL(PCVPOXCAPI) VPoxGetCAPIFunctions(unsigned uVersion);
#ifndef WIN32
/** Backwards compatibility: VPoxGetXPCOMCFunctions.
 * Use VPoxGetCAPIFunctions instead. */
VPOXCAPI_DECL(PCVPOXCAPI) VPoxGetXPCOMCFunctions(unsigned uVersion);
#endif /* !WIN32 */

/** Typedef for VPoxGetCAPIFunctions. */
typedef PCVPOXCAPI (*PFNVPOXGETCAPIFUNCTIONS)(unsigned uVersion);
#ifndef WIN32
/** Backwards compatibility: Typedef for VPoxGetXPCOMCFunctions.
 * Use PFNVPOXGETCAPIFUNCTIONS instead. */
typedef PCVPOXCAPI (*PFNVPOXGETXPCOMCFUNCTIONS)(unsigned uVersion);
#endif /* !WIN32 */

/** The symbol name of VPoxGetCAPIFunctions. */
#ifdef __OS2__
# define VPOX_GET_CAPI_FUNCTIONS_SYMBOL_NAME "_VPoxGetCAPIFunctions"
#else /* !__OS2__ */
# define VPOX_GET_CAPI_FUNCTIONS_SYMBOL_NAME "VPoxGetCAPIFunctions"
#endif /* !__OS2__ */
#ifndef WIN32
/** Backwards compatibility: The symbol name of VPoxGetXPCOMCFunctions.
 * Use VPOX_GET_CAPI_FUNCTIONS_SYMBOL_NAME instead. */
# ifdef __OS2__
#  define VPOX_GET_XPCOMC_FUNCTIONS_SYMBOL_NAME "_VPoxGetXPCOMCFunctions"
# else /* !__OS2__ */
#  define VPOX_GET_XPCOMC_FUNCTIONS_SYMBOL_NAME "VPoxGetXPCOMCFunctions"
# endif /* !__OS2__ */
#endif /* !WIN32 */
...
<xsl:template match="interface">
  <xsl:if test="not(@internal='yes')">
    ...
    <xsl:text>VPOX_EXTERN_CONST(nsIID, IID_</xsl:text>
    <xsl:value-of select="$name"/>
    <xsl:text>);&#x0A;</xsl:text>
    <xsl:text>#ifndef VPOX_WITH_GLUE&#x0A;</xsl:text>
...
<xsl:template match="module/class">
  ...
  <xsl:text>/* COM compatibility */&#x0A;</xsl:text>
  <xsl:text>VPOX_EXTERN_CONST(nsCID, CLSID_</xsl:text>
  <xsl:value-of select="@name"/>
  <xsl:text>);&#x0A;</xsl:text>
  <xsl:text>&#x0A;&#x0A;</xsl:text>
</xsl:template>
