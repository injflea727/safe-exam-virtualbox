...
#ifndef VPOX_INCLUDED_vmm_pdmnetifs_h
#define VPOX_INCLUDED_vmm_pdmnetifs_h
 ...
 *
 * @todo Promote this to VPox/types.h, VPox/vmm/pdmcommon.h or some such place.
 */
...
typedef struct PDMINETWORKDOWN
{
     ...
     *
     * @returns VPox status code. VINF_SUCCESS means there is at least one receive descriptor available.
...
#endif /* !VPOX_INCLUDED_vmm_pdmnetifs_h */
