...
;*  Header Files                                                                                                                 *
;*********************************************************************************************************************************
%include "VPox/asmdefs.mac"
%include "VPox/err.mac"
...
%ifdef VPOX_SKIP_RESTORE_SEG
 %macro MYPUSHSEGS64 2
 %endmacro

 %macro MYPOPSEGS64 2
 %endmacro
%else       ; !VPOX_SKIP_RESTORE_SEG
 ; Trashes, rax, rdx & rcx.
 %macro MYPUSHSEGS64 2
...
%endif ; VPOX_WITH_KERNEL_USING_XMM
