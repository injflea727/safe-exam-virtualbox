/* $Id: VPoxServiceBalloon.cpp $ */
/** @file
 * VPoxService - Memory Ballooning.
 */
...
/** @page pg_vgsvc_memballoon VPoxService - Memory Ballooning
 *
 * The Memory Ballooning subservice works with VPoxGuest, PGM and GMM to
 ...
 * VPoxGuest allocates kernel memory and donates it to the host, or this service
 * allocates process memory which VPoxGuest then locks down and donates to the
