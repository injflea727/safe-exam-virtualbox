...
public:
    ...
    bool i_is64Bit() const { return !!(mOSHint & VPOXOSHINT_64BIT); }
    bool i_recommendedIOAPIC() const { return !!(mOSHint & VPOXOSHINT_IOAPIC); }
    bool i_recommendedX2APIC() const { return !!(mOSHint & VPOXOSHINT_X2APIC); }
    bool i_recommendedVirtEx() const { return !!(mOSHint & VPOXOSHINT_HWVIRTEX); }
    bool i_recommendedEFI() const { return !!(mOSHint & VPOXOSHINT_EFI); }
