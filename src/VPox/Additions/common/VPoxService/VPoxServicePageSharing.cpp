/* $Id: VPoxServicePageSharing.cpp $ */
/** @file
 * VPoxService - Guest page sharing.
 */
...
/** @page pg_vgsvc_pagesharing VPoxService - Page Sharing
 *
 * The Page Sharing subservice is responsible for finding memory mappings
 * suitable page fusions.
 *
 * It is the driving force behind the Page Fusion feature in VirtualPox.
 ...
 * and therefore not actually callable for other VPoxService code (may crash).
 *
...
/**
 * This gets control when VPoxService is launched with "pagefusion" by
...
static DECLCALLBACK(int) vgsvcPageSharingWorkerProcess(bool volatile *pfShutdown)
{
    ...
    for (;;)
    {
        ...
        /*
         * Start a 2nd VPoxService process to deal with page fusion as we do
