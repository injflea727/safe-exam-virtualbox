...
Setup:
    ...
    The following example injects the trace driver right before every instance of the "Host Serial" driver:
        ...
        VPoxManage setextradata <VM name> "VPoxInternal/PDM/DriverTransformations/SerialTrace/AboveDriver"                         "Host Serial"
        VPoxManage setextradata <VM name> "VPoxInternal/PDM/DriverTransformations/SerialTrace/AttachedDriver/Config/TraceFilePath" "<trace/log/file/path>"
        VPoxManage setextradata <VM name> "VPoxInternal/PDM/DriverTransformations/SerialTrace/AttachedDriver/Driver"               "IfTrace"/>
