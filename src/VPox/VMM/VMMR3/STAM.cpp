 ...
 *
 * PS. The VirtualPox Debugger GUI has a viewer for inspecting the statistics
 ...
 *
 * @returns VPox status code. (Basically, it cannot fail.)
 ...
 *
 * @returns VPox status code, but it's interpreted as 0 == success / !0 == failure by enmR3Enum.
