...
#define PR_SetLibraryPath VPoxNsprPR_SetLibraryPath
#define PR_GetLibraryPath VPoxNsprPR_GetLibraryPath
#define PR_GetLibraryName VPoxNsprPR_GetLibraryName
#define PR_FreeLibraryName VPoxNsprPR_FreeLibraryName
#define PR_LoadLibrary VPoxNsprPR_LoadLibrary
#define PR_LoadLibraryWithFlags VPoxNsprPR_LoadLibraryWithFlags
#define PR_UnloadLibrary VPoxNsprPR_UnloadLibrary
#define PR_FindSymbol VPoxNsprPR_FindSymbol
#define PR_FindFunctionSymbol VPoxNsprPR_FindFunctionSymbol
#define PR_FindSymbolAndLibrary VPoxNsprPR_FindSymbolAndLibrary
#define PR_FindFunctionSymbolAndLibrary VPoxNsprPR_FindFunctionSymbolAndLibrary
#define PR_LoadStaticLibrary VPoxNsprPR_LoadStaticLibrary
#define PR_GetLibraryFilePathname VPoxNsprPR_GetLibraryFilePathname
