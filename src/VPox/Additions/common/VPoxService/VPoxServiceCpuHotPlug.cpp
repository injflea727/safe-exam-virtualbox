/* $Id: VPoxServiceCpuHotPlug.cpp $ */
/** @file
 * VPoxService - Guest Additions CPU Hot-Plugging Service.
 */
...
/** @page pg_vgsvc_cpuhotplug VPoxService - CPU Hot-Plugging
 *
