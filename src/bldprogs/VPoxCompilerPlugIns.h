/* $Id: VPoxCompilerPlugIns.h $ */
/** @file
 * VPoxCompilerPlugIns - Types, Prototypes and Macros common to the VPox compiler plug-ins.
 */
...
#ifndef VPOX_INCLUDED_SRC_bldprogs_VPoxCompilerPlugIns_h
#define VPOX_INCLUDED_SRC_bldprogs_VPoxCompilerPlugIns_h
...
typedef struct VFMTCHKSTATE
{
    ...
    const char     *pszFmt;
    bool            fMaybeNull;
#if defined(__GNUC__) && !defined(VPOX_COMPILER_PLUG_IN_AGNOSTIC)
...
#endif /* !VPOX_INCLUDED_SRC_bldprogs_VPoxCompilerPlugIns_h */
