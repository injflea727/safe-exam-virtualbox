 ...
 * @param pVirtualPox VirtualPox instance.
               ...
               std::list<Guid> &llMachinesCreated)
{
    ...
    HRESULT rc = pVirtualPox->CreateAppliance(pAppl.asOutParam());
         ...
         ++u)
    {
             ...
             ++u2)
        {
            ...
            RTPrintf("  vsys %2u item %2u: type %2d (%s), ovf: \"%ls\", vpox: \"%ls\", extra: \"%ls\"\n",
                     u, u2, t, pcszType,
                     aOvfValues[u2],
                     aVPoxValues[u2],
...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        if (FAILED(rc)) throw MyError(rc, "failed to create the VirtualPox object!\n");
        ...
        importOVF("joomla-0.9", pVirtualPox, "ovf-testcases/ovf-joomla-0.9/joomla-1.1.4-ovf.ovf", llMachinesCreated);

        // testcase 2: import ovf-winxp-vpox-sharedfolders/winxp.ovf
        copyDummyDiskImage("winxp-vpox-sharedfolders", llFiles2Delete, "ovf-testcases/ovf-winxp-vpox-sharedfolders/Windows 5.1 XP 1 merged.vmdk");
        copyDummyDiskImage("winxp-vpox-sharedfolders", llFiles2Delete, "ovf-testcases/ovf-winxp-vpox-sharedfolders/smallvdi.vmdk");
        importOVF("winxp-vpox-sharedfolders", pVirtualPox, "ovf-testcases/ovf-winxp-vpox-sharedfolders/winxp.ovf", llMachinesCreated);

        // testcase 3: import ovf-winxp-vpox-sharedfolders/winxp.ovf
        importOVF("winhost-audio-nodisks", pVirtualPox, "ovf-testcases/ovf-winhost-audio-nodisks/WinXP.ovf", llMachinesCreated);
    ...
    try
    {
             ...
             ++it)
        {
            ...
            rc = pVirtualPox->FindMachine(bstrUUID.raw(), pMachine.asOutParam());
            if (FAILED(rc)) throw MyError(rc, "VirtualPox::FindMachine() failed\n");
