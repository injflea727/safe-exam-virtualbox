/* $Id: VMMDevHGCM.h $ */
/** @file
 * VPoxDev - HGCM - Host-Guest Communication Manager, internal header.
 */
...
#ifndef VPOX_INCLUDED_SRC_VMMDev_VMMDevHGCM_h
#define VPOX_INCLUDED_SRC_VMMDev_VMMDevHGCM_h
...
DECLCALLBACK(int)  hgcmR3Completed(PPDMIHGCMPORT pInterface, int32_t result, PVPOXHGCMCMD pCmdPtr);
...
#endif /* !VPOX_INCLUDED_SRC_VMMDev_VMMDevHGCM_h */
