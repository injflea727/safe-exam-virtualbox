 ...
 * environment. For instance, a guest OS which interfaces to VirtualPox through
 ...
 */
static DECLCALLBACK(VPOXSTRICTRC) gimR3Mmio2WriteHandler(PVM pVM, PVMCPU pVCpu, RTGCPHYS GCPhys, void *pvPhys, void *pvBuf,
