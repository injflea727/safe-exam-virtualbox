...
/** @file
 * VPox Qt GUI - UIWizardNewVMPageBasic1 class implementation.
 */
 ...
 * VirtualPox-settings-common.xsd in Main. The list is sorted by priority. The
...
static const osTypePattern gs_OSTypePattern[] =
{
    ...
    { QRegExp("bs[23]{0,1}-",         Qt::CaseInsensitive), "VPoxBS_64" }, /* bootsector tests */
...
void UIWizardNewVMPage1::composeMachineFilePath()
{
    ...
    m_strMachineFilePath = vpox.ComposeMachineFilename(m_pNameAndSystemEditor->name(),
                                                       m_strGroup,
                                                       QString(),
...
void UIWizardNewVMPageBasic1::retranslateUi()
{
    ...
    m_pLabel->setText(UIWizardNewVM::tr("Please choose a descriptive name and destination folder for the new virtual machine "
                                        ...
                                        "The name you choose will be used throughout VirtualPox "
