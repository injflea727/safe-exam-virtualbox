...
*   Header Files                                                                                                                 *
*********************************************************************************************************************************/
#define VPOX_DEVICE_STRUCT_TESTCASE
#define VPOX_WITH_HGCM                  /* grumble */

/* Check that important preprocessor macros does not get redefined: */
#include <VPox/cdefs.h>
#include <VPox/log.h>
#ifdef DEBUG
# define VPOX_DEVICE_STRUCT_TESTCASE_CHECK_DEBUG
#else
# undef  VPOX_DEVICE_STRUCT_TESTCASE_CHECK_DEBUG
#endif
#ifdef LOG_ENABLED
# define VPOX_DEVICE_STRUCT_TESTCASE_CHECK_LOG_ENABLED
#else
# undef  VPOX_DEVICE_STRUCT_TESTCASE_CHECK_LOG_ENABLED
#endif
#ifdef VPOX_STRICT
# define VPOX_DEVICE_STRUCT_TESTCASE_CHECK_VPOX_STRICT
#else
# undef  VPOX_DEVICE_STRUCT_TESTCASE_CHECK_VPOX_STRICT
#endif
#ifdef RT_STRICT
# define VPOX_DEVICE_STRUCT_TESTCASE_CHECK_RT_STRICT
#else
# undef  VPOX_DEVICE_STRUCT_TESTCASE_CHECK_RT_STRICT
#endif
...
# ifdef VPOX_WITH_EHCI_IMPL
#  undef LOG_GROUP
#  include "../USB/DevEHCI.cpp"
# endif
# ifdef VPOX_WITH_XHCI_IMPL
#  undef LOG_GROUP
...
#ifdef VPOX_WITH_NVME_IMPL
# undef LOG_GROUP
# include "../Storage/DevNVMe.cpp"
#endif

/* Check that important preprocessor macros didn't get redefined: */
#if defined(DEBUG)       != defined(VPOX_DEVICE_STRUCT_TESTCASE_CHECK_DEBUG)
# error "DEBUG was modified!  This may throw off structure tests."
#endif
#if defined(LOG_ENABLED) != defined(VPOX_DEVICE_STRUCT_TESTCASE_CHECK_LOG_ENABLED)
# error "LOG_ENABLED was modified!  This may throw off structure tests."
#endif
#if defined(RT_STRICT)   != defined(VPOX_DEVICE_STRUCT_TESTCASE_CHECK_RT_STRICT)
# error "RT_STRICT was modified!  This may throw off structure tests."
#endif
#if defined(VPOX_STRICT) != defined(VPOX_DEVICE_STRUCT_TESTCASE_CHECK_VPOX_STRICT)
# error "VPOX_STRICT was modified!  This may throw off structure tests."
#endif
...
int main()
{
    ...
    GEN_CHECK_OFF(PDMPCIDEV, Int.s.aIORegions[VPOX_PCI_NUM_REGIONS - 1]);
...
# endif /* VNET_TX_DELAY */
    ...
    GEN_CHECK_SIZE(VPOXSCSI);
    GEN_CHECK_OFF(VPOXSCSI, regIdentify);
    GEN_CHECK_OFF(VPOXSCSI, uTargetDevice);
    GEN_CHECK_OFF(VPOXSCSI, uTxDir);
    GEN_CHECK_OFF(VPOXSCSI, cbCDB);
    GEN_CHECK_OFF(VPOXSCSI, abCDB);
    GEN_CHECK_OFF(VPOXSCSI, abCDB[11]);
    GEN_CHECK_OFF(VPOXSCSI, iCDB);
    GEN_CHECK_OFF(VPOXSCSI, pbBuf);
    GEN_CHECK_OFF(VPOXSCSI, cbBuf);
    GEN_CHECK_OFF(VPOXSCSI, iBuf);
    GEN_CHECK_OFF(VPOXSCSI, fBusy);
    GEN_CHECK_OFF(VPOXSCSI, enmState);
#endif
    ...
    GEN_CHECK_OFF(BUSLOGIC, VPoxSCSI);
...
# endif
    ...
    GEN_CHECK_OFF(LSILOGICSCSI, VPoxSCSI);
...
#ifdef VPOX_WITH_STATISTICS
# ifndef VPOX_WITH_AUDIO_CALLBACKS
