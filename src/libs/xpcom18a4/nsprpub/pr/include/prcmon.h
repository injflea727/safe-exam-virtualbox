...
#define PR_CEnterMonitor VPoxNsprPR_CEnterMonitor
#define PR_CExitMonitor VPoxNsprPR_CExitMonitor
#define PR_CNotify VPoxNsprPR_CNotify
#define PR_CWait VPoxNsprPR_CWait
#define PR_CNotifyAll VPoxNsprPR_CNotifyAll
#define PR_CSetOnMonitorRecycle VPoxNsprPR_CSetOnMonitorRecycle
