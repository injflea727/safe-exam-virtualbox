/* $Id: VPoxAppleSim.c $ */
/** @file
 * VPoxAppleSim.c - VirtualPox Apple Firmware simulation support
 */
 ...
 */
EFI_STATUS EFIAPI
VPoxInitAppleSim(IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable)
{
    EFI_STATUS          rc;
    UINT64              FSBFrequency;
    UINT64              TSCFrequency;
...
EFI_STATUS EFIAPI
VPoxDeinitAppleSim(IN EFI_HANDLE         ImageHandle)
{
    return EFI_SUCCESS;
}
