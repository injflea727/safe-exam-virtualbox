 ...
 */
static DECLCALLBACK(VPOXSTRICTRC) dbgfR3BpEnableInt3OnCpu(PVM pVM, PVMCPU pVCpu, void *pvUser)
{
    /*
     * Validate input.
     */
 ...
 * @callback_method_impl{FNVMMEMTRENDEZVOUS}
 */
static DECLCALLBACK(VPOXSTRICTRC) dbgfR3BpSetInt3OnCpu(PVM pVM, PVMCPU pVCpu, void *pvUser)
{
    /*
     * Validate input.
     */
    ...
    if (pVCpu->idCpu == pBpArgs->idSrcCpu)
    {
        ...
        if (pBp)
        {
            ...
            if (RT_SUCCESS(rc))
            {
                ...
                /*
                 * Returning VINF_DBGF_BP_ALREADY_EXIST here causes a VPOXSTRICTRC out-of-range assertion
 ...
 * @callback_method_impl{FNVMMEMTRENDEZVOUS}
 */
static DECLCALLBACK(VPOXSTRICTRC) dbgfR3BpDisableInt3OnCpu(PVM pVM, PVMCPU pVCpu, void *pvUser)
{
    /*
     * Validate input.
     */
 ...
 * @callback_method_impl{FNVMMEMTRENDEZVOUS}
 */
static DECLCALLBACK(VPOXSTRICTRC) dbgfR3BpRegRecalcOnCpu(PVM pVM, PVMCPU pVCpu, void *pvUser)
{
