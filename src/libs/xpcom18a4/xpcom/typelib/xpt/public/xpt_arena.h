...
#define XPT_NewArena VPoxNsxpXPT_NewArena
#define XPT_ArenaMalloc VPoxNsxpXPT_ArenaMalloc
#define XPT_DestroyArena VPoxNsxpXPT_DestroyArena
#define XPT_ArenaFree VPoxNsxpXPT_ArenaFree
#define XPT_DestroyArena VPoxNsxpXPT_DestroyArena
#define XPT_DumpStats VPoxNsxpXPT_DumpStats
#define XPT_NotifyDoneLoading VPoxNsxpXPT_NotifyDoneLoading
#define XPT_ArenaStrDup VPoxNsxpXPT_ArenaStrDup
#define XPT_AssertFailed VPoxNsxpXPT_AssertFailed
