...
#define PR_GetFileMethods VPoxNsprPR_GetFileMethods
#define PR_GetTCPMethods VPoxNsprPR_GetTCPMethods
#define PR_GetUDPMethods VPoxNsprPR_GetUDPMethods
#define PR_GetPipeMethods VPoxNsprPR_GetPipeMethods
#define PR_FileDesc2NativeHandle VPoxNsprPR_FileDesc2NativeHandle
#define PR_ChangeFileDescNativeHandle VPoxNsprPR_ChangeFileDescNativeHandle
#define PR_AllocFileDesc VPoxNsprPR_AllocFileDesc
#define PR_FreeFileDesc VPoxNsprPR_FreeFileDesc
#define PR_ImportFile VPoxNsprPR_ImportFile
#define PR_ImportPipe VPoxNsprPR_ImportPipe
#define PR_ImportTCPSocket VPoxNsprPR_ImportTCPSocket
#define PR_ImportUDPSocket VPoxNsprPR_ImportUDPSocket
#define PR_CreateSocketPollFd VPoxNsprPR_CreateSocketPollFd
#define PR_DestroySocketPollFd VPoxNsprPR_DestroySocketPollFd
#define PR_Socket VPoxNsprPR_Socket
#define PR_LockFile VPoxNsprPR_LockFile
#define PR_TLockFile VPoxNsprPR_TLockFile
#define PR_UnlockFile VPoxNsprPR_UnlockFile
#define PR_EmulateAcceptRead VPoxNsprPR_EmulateAcceptRead
#define PR_EmulateSendFile VPoxNsprPR_EmulateSendFile
#define PR_NTFast_AcceptRead VPoxNsprPR_NTFast_AcceptRead
#define PR_NTFast_AcceptRead_WithTimeoutCallback VPoxNsprPR_NTFast_AcceptRead_WithTimeoutCallback
#define PR_NTFast_Accept VPoxNsprPR_NTFast_Accept
#define PR_NTFast_UpdateAcceptContext VPoxNsprPR_NTFast_UpdateAcceptContext
#define PR_NT_CancelIo VPoxNsprPR_NT_CancelIo
#define PR_Init_Log VPoxNsprPR_Init_Log
