...
/** @def VPOX_WITH_RC_RELEASE_LOGGING
 * Enables RC release logging. */
#define VPOX_WITH_RC_RELEASE_LOGGING

/** @def VPOX_WITH_R0_LOGGING
 ...
 * \#if, or by adding VPOX_WITH_R0_LOGGING to your LocalConfig.kmk.
 */
#if defined(DEBUG_sandervl) || defined(DEBUG_frank) || defined(DEBUG_ramshankar) || defined(DOXYGEN_RUNNING)
# define VPOX_WITH_R0_LOGGING
#endif

/** @def VPOX_STRICT_VMM_STACK
 * Enables VMM stack guard pages to catch stack over- and underruns. */
#if defined(VPOX_STRICT) || defined(DOXYGEN_RUNNING)
# define VPOX_STRICT_VMM_STACK
#endif
