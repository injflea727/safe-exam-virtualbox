/* $Id: MachineImpl.h $ */
/** @file
 * Implementation of IMachine in VPoxSVC - Header.
 */
...
public:
    ...
    struct Data
    {
        ...
        /* Note: These are guarded by VirtualPoxBase::stateLockHandle() */
    ...
    HRESULT init(VirtualPox *aParent,
    ...
    HRESULT initFromSettings(VirtualPox *aParent,
                             const Utf8Str &strConfigFile,
                             const Guid *aId);
...
public:
    ...
    /**
     * Returns the VirtualPox object this machine belongs to.
     *
     ...
     */
    VirtualPox* i_getVirtualPox() const { return mParent; }
...
{
public:
    VIRTUALPOXBASE_ADD_ERRORINFO_SUPPORT(SessionMachine, IMachine)
    ...
    BEGIN_COM_MAP(SessionMachine)
        ...
        VPOX_TWEAK_INTERFACE_ENTRY(IMachine)
    END_COM_MAP()
...
{
public:
    VIRTUALPOXBASE_ADD_ERRORINFO_SUPPORT(SnapshotMachine, IMachine)
