...
/** @file
 * VPox Qt GUI - UICocoaApplication class declaration.
 */
...
typedef bool (*PFNVPOXCACALLBACK)(const void *pvCocoaEvent, const void *pvCarbonEvent, void *pvUser);
...
public:
    ...
    void registerForNativeEvents(uint32_t fMask, PFNVPOXCACALLBACK pfnCallback, void *pvUser);
    /** Unregister native @a pfnCallback of the @a pvUser taking event @a fMask into account. */
    void unregisterForNativeEvents(uint32_t fMask, PFNVPOXCACALLBACK pfnCallback, void *pvUser);
