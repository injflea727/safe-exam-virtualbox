 ...
 * copied from the raw XML data. This was all new with VirtualPox 3.1 and allows us
 * to finally make the XML reader version-independent and read VirtualPox XML files
 * from earlier and even newer (future) versions without requiring complicated,
 * tedious and error-prone XSLT conversions.
 *
 * It is this file that defines all structures that map VirtualPox global and
...
#ifndef VPOX_INCLUDED_settings_h
#define VPOX_INCLUDED_settings_h
...
/**
 * A media registry. Starting with VirtualPox 3.3, this can appear in both the
 * VirtualPox.xml file as well as machine XML files with settings version 1.11
...
struct BIOSSettings
{
    ...
    APICMode_T      apicMode;           // requires settings version 1.16 (VirtualPox 5.1)
...
struct RecordingScreenSettings
{
    ...
    bool                   fEnabled;   // requires settings version 1.14 (VirtualPox 4.3)
    ...
    uint32_t               ulMaxTimeS; // requires settings version 1.14 (VirtualPox 4.3)
    /** Options string for hidden / advanced / experimental features.
     *  Use RecordingScreenSettings::getDefaultOptions(). */
    com::Utf8Str           strOptions; // new since VirtualPox 5.2.
    ...
    struct Video
    {
        ...
        uint32_t              ulWidth;   // requires settings version 1.14 (VirtualPox 4.3)
        /** Target frame height in pixels (Y). */
        uint32_t              ulHeight;  // requires settings version 1.14 (VirtualPox 4.3)
        /** Encoding rate. */
        uint32_t              ulRate;    // requires settings version 1.14 (VirtualPox 4.3)
        /** Frames per second (FPS). */
        uint32_t              ulFPS;     // requires settings version 1.14 (VirtualPox 4.3)
    } Video;
    ...
    struct File
    {
        ...
        uint32_t     ulMaxSizeMB; // requires settings version 1.14 (VirtualPox 4.3)
        /** Absolute file name path to use for recording.
         *  When empty, this is considered as being the default setting. */
        com::Utf8Str strName;     // requires settings version 1.14 (VirtualPox 4.3)
    } File;
};
...
struct GraphicsAdapter
{
    ...
    uint32_t            cMonitors;
    bool                fAccelerate3D,
                        fAccelerate2DVideo;     // requires settings version 1.8 (VirtualPox 3.1)
};
...
struct NetworkAdapter
{
    ...
    com::Utf8Str                        strBandwidthGroup; // requires settings version 1.13 (VirtualPox 4.2)
};
...
struct Hardware
{
    ...
    bool                fHardwareVirt,
                        ...
                        fTripleFaultReset,
                        fPAE,
                        fAPIC,                  // requires settings version 1.16 (VirtualPox 5.1)
                        fX2APIC;                // requires settings version 1.16 (VirtualPox 5.1)
    ...
    bool                fNestedHWVirt;          //< requires settings version 1.17 (VirtualPox 6.0)
    typedef enum LongModeType { LongMode_Enabled, LongMode_Disabled, LongMode_Legacy } LongModeType;
    LongModeType        enmLongMode;
    uint32_t            cCPUs;
    bool                fCpuHotPlug;            // requires settings version 1.10 (VirtualPox 3.2)
    CpuList             llCpus;                 // requires settings version 1.10 (VirtualPox 3.2)
    bool                fHPETEnabled;           // requires settings version 1.10 (VirtualPox 3.2)
    uint32_t            ulCpuExecutionCap;      // requires settings version 1.11 (VirtualPox 3.3)
    uint32_t            uCpuIdPortabilityLevel; // requires settings version 1.15 (VirtualPox 5.0)
    com::Utf8Str        strCpuProfile;          // requires settings version 1.16 (VirtualPox 5.1)
    ...
    FirmwareType_T      firmwareType;           // requires settings version 1.9 (VirtualPox 3.1)

    PointingHIDType_T   pointingHIDType;        // requires settings version 1.10 (VirtualPox 3.2)
    KeyboardHIDType_T   keyboardHIDType;        // requires settings version 1.10 (VirtualPox 3.2)

    ChipsetType_T       chipsetType;            // requires settings version 1.11 (VirtualPox 4.0)
    ParavirtProvider_T  paravirtProvider;       // requires settings version 1.15 (VirtualPox 4.4)
    com::Utf8Str        strParavirtDebug;       // requires settings version 1.16 (VirtualPox 5.1)

    bool                fEmulatedUSBCardReader; // 1.12 (VirtualPox 4.1)
    ...
    IOSettings          ioSettings;             // requires settings version 1.10 (VirtualPox 3.2)
    HostPCIDeviceAttachmentList pciAttachments; // requires settings version 1.12 (VirtualPox 4.1)

    com::Utf8Str        strDefaultFrontend;     // requires settings version 1.14 (VirtualPox 4.3)
};
...
public:
    ...
    enum
    {
        ...
        BuildMachineXML_WriteVPoxVersionAttribute = 0x02,
...
#endif /* !VPOX_INCLUDED_settings_h */
