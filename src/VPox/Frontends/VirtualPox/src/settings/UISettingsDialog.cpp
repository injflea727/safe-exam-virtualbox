...
/** @file
 * VPox Qt GUI - UISettingsDialog class implementation.
 */
...
#ifndef VPOX_GUI_WITH_TOOLBAR_SETTINGS
...
#else /* !VPOX_GUI_WITH_TOOLBAR_SETTINGS */
...
#endif /* !VPOX_GUI_WITH_TOOLBAR_SETTINGS */
