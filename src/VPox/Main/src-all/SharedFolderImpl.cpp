 ...
 *
 *  @param aVirtualPox  VirtualPox parent object
 *  @param aName        logical name of the shared folder
 *  @param aHostPath    full path to the shared folder on the host
 *  @param aWritable    writable if true, readonly otherwise
 *  @param aAutoMountPoint Where the guest should try auto mount it.
 ...
 *  @return          COM result indicator
 */
HRESULT SharedFolder::init(VirtualPox *aVirtualPox,
                           const Utf8Str &aName,
                           const Utf8Str &aHostPath,
                           bool aWritable,
                           bool aAutoMount,
                           ...
                           bool fFailOnError)
{
    ...
    HRESULT rc = protectedInit(aVirtualPox, aName, aHostPath, aWritable, aAutoMount, aAutoMountPoint, fFailOnError);
 ...
 */
HRESULT SharedFolder::i_protectedInit(VirtualPoxBase *aParent,
                                      const Utf8Str &aName,
                                      const Utf8Str &aHostPath,
                                      bool aWritable,
                                      bool aAutoMount,
