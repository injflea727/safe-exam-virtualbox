...
*********************************************************************************************************************************/
/** The IOClass key of the service (see VPoxUSB.cpp / Info.plist). */
#define IOCLASS_NAME    "org_virtualpox_VPoxUSB"
...
USBLIB_DECL(int) USBLibInit(void)
{
    ...
    /*
     * Open the service.
     * This will cause the user client class in VPoxUSB.cpp to be instantiated.
     */
    kr = IOServiceOpen(ServiceObject, mach_task_self(), VPOXUSB_DARWIN_IOSERVICE_COOKIE, &g_Connection);
...
{
    VPOXUSBADDFILTEROUT Out = { 0, VERR_WRONG_ORDER };
