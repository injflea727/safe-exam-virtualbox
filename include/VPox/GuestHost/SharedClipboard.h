...
#ifndef VPOX_INCLUDED_GuestHost_SharedClipboard_h
#define VPOX_INCLUDED_GuestHost_SharedClipboard_h
...
/** A single Shared Clipboard format (VPOX_SHCL_FMT_XXX). */
typedef uint32_t SHCLFORMAT;
/** Pointer to a single Shared Clipboard format (VPOX_SHCL_FMT_XXX). */
typedef SHCLFORMAT *PSHCLFORMAT;

/** Bit map (flags) of Shared Clipboard formats (VPOX_SHCL_FMT_XXX). */
typedef uint32_t SHCLFORMATS;
/** Pointer to a bit map of Shared Clipboard formats (VPOX_SHCL_FMT_XXX). */
...
/** Opaque data structure for the X11/VPox frontend/glue code.
 * @{ */
struct SHCLCONTEXT;
typedef struct SHCLCONTEXT SHCLCONTEXT;
/** @} */
/** Pointer to opaque data structure the X11/VPox frontend/glue code. */
...
#endif /* !VPOX_INCLUDED_GuestHost_SharedClipboard_h */
