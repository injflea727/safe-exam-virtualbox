/* $Id: solaris.h $ */
/** @file
 * VPoxGuest - Guest Additions Driver for Solaris - testcase stubs.
 */
...
#define _init vpoxguestSolarisInit
extern int vpoxguestSolarisInit(void);
#define _fini vpoxguestSolarisFini
extern int vpoxguestSolarisFini(void);
#define _info vpoxguestSolarisInfo
extern int vpoxguestSolarisInfo(struct modinfo *pModInfo);
...
#if 0
#define VPoxGuestCreateKernelSession(...) VINF_SUCCESS
#define VPoxGuestCreateUserSession(...) VINF_SUCCESS
#define VPoxGuestCloseSession(...) do {} while(0)
#define VPoxGuestInitDevExt(...) VINF_SUCCESS
#define VPoxGuestDeleteDevExt(...) do {} while(0)
#define VPoxGuestCommonIOCtl(...) VINF_SUCCESS
#define VPoxGuestCommonISR(...) true
