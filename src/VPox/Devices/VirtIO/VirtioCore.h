...
#ifndef VPOX_INCLUDED_SRC_VirtIO_VirtioCore_h
#define VPOX_INCLUDED_SRC_VirtIO_VirtioCore_h
 ...
 *
 * This can be invoked when running the VirtualPox debugger, or from the command line
 * using the command: "VpoxManage debugvm <VM name or id> info <device name> [args]"
 *
 * Example:  VPoxManage debugvm myVnetVm info "virtio-net" help
 *
...
#endif /* !VPOX_INCLUDED_SRC_VirtIO_VirtioCore_h */
