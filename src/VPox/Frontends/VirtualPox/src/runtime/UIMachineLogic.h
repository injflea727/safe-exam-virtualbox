/* $Id: UIMachineLogic.h $ */
/** @file
 * VPox Qt GUI - UIMachineLogic class declaration.
 */
...
protected slots:
    ...
    void sltHandleVPoxSVCAvailabilityChange();
    ...
    virtual void sltUSBDeviceStateChange(const CUSBDevice &device, bool fIsAttached, const CVirtualPoxErrorInfo &error);
