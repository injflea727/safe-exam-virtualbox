...
#ifndef VPOX_INCLUDED_vmm_pdmcommon_h
#define VPOX_INCLUDED_vmm_pdmcommon_h
 ...
 *
 * @returns VPox status code. PDMDevHlpCallR0 will return this.
 ...
 * The ring-0 driver request handler.
 *
 * @returns VPox status code. PDMDrvHlpCallR0 will return this.
...
#endif /* !VPOX_INCLUDED_vmm_pdmcommon_h */
