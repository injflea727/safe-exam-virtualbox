...
"""
VirtualPox Validation Kit - OS/2 install tests.
"""
...
class tdGuestOsInstOs2(vpox.TestDriver):
    """
    ...
    def actionConfig(self):
        ...
        if sController == self.ksSataController:
            fRc = oSession.setStorageControllerType(vpoxcon.StorageControllerType_IntelAhci, sController)
        ...
        fRc = fRc and oSession.setBootOrder(2, vpoxcon.DeviceType_Floppy)
        ...
        return vpox.TestDriver.actionConfig(self)
