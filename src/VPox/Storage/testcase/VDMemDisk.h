/** @file
 *
 * VPox HDD container test utility, memory disk/file.
 */
...
#ifndef VPOX_INCLUDED_SRC_testcase_VDMemDisk_h
#define VPOX_INCLUDED_SRC_testcase_VDMemDisk_h
...
#endif /* !VPOX_INCLUDED_SRC_testcase_VDMemDisk_h */
