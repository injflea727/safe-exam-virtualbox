...
#ifndef VPOX_INCLUDED_vmm_nem_h
#define VPOX_INCLUDED_vmm_nem_h
...
VMMR3_INT_DECL(VPOXSTRICTRC) NEMR3RunGC(PVM pVM, PVMCPU pVCpu);
...
VMMR0_INT_DECL(VPOXSTRICTRC) NEMR0RunGuestCode(PGVM pGVM, VMCPUID idCpu);
