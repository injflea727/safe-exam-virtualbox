...
#ifndef VPOX_INCLUDED_SRC_Audio_DevHdaStream_h
#define VPOX_INCLUDED_SRC_Audio_DevHdaStream_h
...
VPOXSTRICTRC        hdaStreamMaybeDoOnAccessDmaOutput(PPDMDEVINS pDevIns, PHDASTATE pThis,
...
#endif /* IN_RING3 */
#endif /* !VPOX_INCLUDED_SRC_Audio_DevHdaStream_h */
