 ...
 */
//cmd: kmk VPoxRT && kmk_redirect -E VPOX_LOG_DEST="nofile stderr" -E VPOX_LOG="rt_fs=~0" -E VPOX_LOG_FLAGS="unbuffered enabled" -- e:\vpox\svn\trunk\out\win.amd64\debug\bin\tools\RTLs.exe :iprtvfs:file(open,d:\Downloads\en_windows_10_enterprise_version_1703_updated_march_2017_x64_dvd_10189290.iso,r):vfs(isofs):/ -la
