...
#ifndef VPOX_INCLUDED_vmm_pdmaudioinline_h
#define VPOX_INCLUDED_vmm_pdmaudioinline_h
...
DECLINLINE(int) PDMAudioStrmCfgCopy(PPDMAUDIOSTREAMCFG pDstCfg, PCPDMAUDIOSTREAMCFG pSrcCfg)
{
    ...
    /* This used to be VPOX_STRICT only and return VERR_INVALID_PARAMETER, but
...
#endif /* !VPOX_INCLUDED_vmm_pdmaudioinline_h */
