...
#ifndef VPOX_INCLUDED_com_listeners_h
#define VPOX_INCLUDED_com_listeners_h
...
#ifdef VPOX_WITH_XPCOM
# define VPOX_LISTENER_DECLARE(klazz) NS_DECL_CLASSINFO(klazz)
#else
# define VPOX_LISTENER_DECLARE(klazz)
#endif

/** @} */
#endif /* !VPOX_INCLUDED_com_listeners_h */
