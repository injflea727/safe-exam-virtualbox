...
int main(int argc, char *argv[])
{
    ...
    printf("VirtualPox DirectFB GUI built %s %s\n"
           "(C) 2004-" VPOX_C_YEAR " " VPOX_VENDOR "\n"
     ...
     */
    {
        ...
        rc = virtualPox->OpenSession(session, NS_ConvertUTF8toUTF16(uuid).get());
        if (NS_FAILED(rc))
        {
        ...
        frameBuffer = new VPoxDirectFB(dfb, surface);
