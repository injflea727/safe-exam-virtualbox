...
/** @file
 * VPox storage filter driver sample.
 */
 ...
 */
extern "C" DECLEXPORT(int) VPoxDriversRegister(PPDMDRVREGCB pCallbacks, uint32_t u32Version)
{
    LogFlow(("VPoxSampleDriver::VPoxDriversRegister: u32Version=%#x pCallbacks->u32Version=%#x\n",
