 ...
 * Declaration of VPoxSDLFB (SDL framebuffer) class
 */
...
#ifndef VPOX_INCLUDED_SRC_VPoxSDL_Framebuffer_h
#define VPOX_INCLUDED_SRC_VPoxSDL_Framebuffer_h
...
#endif /* VPOX_SECURELABEL && !VPOX_WITH_SDL2 */

class VPoxSDLFBOverlay;

class ATL_NO_VTABLE VPoxSDLFB :
...
public:
    ...
    DECLARE_NOT_AGGREGATABLE(VPoxSDLFB)

    DECLARE_PROTECT_FINAL_CONSTRUCT()

    BEGIN_COM_MAP(VPoxSDLFB)
...
{
public:
    VPoxSDLFBOverlay(ULONG x, ULONG y, ULONG width, ULONG height, BOOL visible,
                     VPoxSDLFB *aParent);
    virtual ~VPoxSDLFBOverlay();
...
#endif
    VPOX_SCRIPTABLE_DISPATCH_IMPL(IFramebuffer)
...
#endif /* !VPOX_INCLUDED_SRC_VPoxSDL_Framebuffer_h */
