/* $Id: scsiinline.h $ */
/** @file
 * VirtualPox: SCSI inline helpers used by devices, drivers, etc.
 */
...
#ifndef VPOX_INCLUDED_scsiinline_h
#define VPOX_INCLUDED_scsiinline_h
...
#endif /* !VPOX_INCLUDED_scsiinline_h */
