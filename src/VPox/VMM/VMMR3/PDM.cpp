 ...
 *
 * VirtualPox is designed to be very configurable, i.e. the ability to select
 ...
 * will call the entry point 'VPoxDevicesRegister' when loading a device module.
 ...
 * The typical VPox configuration construct (ConsoleImpl2.cpp) will do explict
 ...
 *
 * VPox 6.1 changes the PDM interface for devices and they have to be converted
 ...
 *   GCPhys to off and really treat it as an offset.   Return status is VPOXSTRICTRC,
 ...
 *   VPOXSTRICTRC, which should be propagated to worker functions as far as possible.
 *
 ...
 *   for VPoxVMM and VMMR0 function you forgot to convert to device help calls
 ...
 * varies.  The registration entry point is 'VPoxUsbRegister', the device
 ...
 * 'VPoxDriversRegister' with a callback table.
 *
 * @see grp_pdm_driver
 *
 *
...
VMMR3_INT_DECL(void) PDMR3Relocate(PVM pVM, RTGCINTPTR offDelta)
{
     ...
     * Devices & Drivers.
     */
#ifdef VPOX_WITH_RAW_MODE_KEEP /* needs fixing */
    int rc;
