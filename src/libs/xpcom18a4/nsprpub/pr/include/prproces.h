...
#define PR_CreateProcessDetached VPoxNsprPR_CreateProcessDetached
#define PR_ProcessAttrSetInheritableFD VPoxNsprPR_ProcessAttrSetInheritableFD
#define PR_DestroyProcessAttr VPoxNsprPR_DestroyProcessAttr
#define PR_NewProcessAttr VPoxNsprPR_NewProcessAttr
#define PR_ResetProcessAttr VPoxNsprPR_ResetProcessAttr
#define PR_ProcessAttrSetStdioRedirect VPoxNsprPR_ProcessAttrSetStdioRedirect
#define PR_SetStdioRedirect VPoxNsprPR_SetStdioRedirect
#define PR_ProcessAttrSetCurrentDirectory VPoxNsprPR_ProcessAttrSetCurrentDirectory
#define PR_CreateProcess VPoxNsprPR_CreateProcess
#define PR_DetachProcess VPoxNsprPR_DetachProcess
#define PR_WaitProcess VPoxNsprPR_WaitProcess
#define PR_KillProcess VPoxNsprPR_KillProcess
