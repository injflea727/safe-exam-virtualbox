/* $Id: vscsi.h $ */
/** @file
 * VPox storage drivers - Virtual SCSI driver
 */
...
#ifndef VPOX_INCLUDED_vscsi_h
#define VPOX_INCLUDED_vscsi_h
...
#ifdef IN_RING0
# error "There are no VPox VSCSI APIs available in Ring-0 Host Context!"
#endif
...
typedef struct VSCSILUNIOCALLBACKS
{
     ...
     *
     * @returns VPox status status code.
     * @param   hVScsiLun       Virtual SCSI LUN handle.
     * @param   pvScsiLunUser   Opaque user data which may be used to identify the
     *                          medium.
 ...
 */
VPOXDDU_DECL(int) VSCSIDeviceCreate(PVSCSIDEVICE phVScsiDevice,
 ...
 */
VPOXDDU_DECL(int) VSCSIDeviceDestroy(VSCSIDEVICE hVScsiDevice);
 ...
 */
VPOXDDU_DECL(int) VSCSIDeviceLunAttach(VSCSIDEVICE hVScsiDevice, VSCSILUN hVScsiLun, uint32_t iLun);
 ...
 */
VPOXDDU_DECL(int) VSCSIDeviceLunDetach(VSCSIDEVICE hVScsiDevice, uint32_t iLun,
 ...
 */
VPOXDDU_DECL(int) VSCSIDeviceLunQueryType(VSCSIDEVICE hVScsiDevice, uint32_t iLun,
 ...
 */
VPOXDDU_DECL(int) VSCSIDeviceReqEnqueue(VSCSIDEVICE hVScsiDevice, VSCSIREQ hVScsiReq);
 ...
 */
VPOXDDU_DECL(int) VSCSIDeviceReqCreate(VSCSIDEVICE hVScsiDevice, PVSCSIREQ phVScsiReq,
 ...
 */
VPOXDDU_DECL(int) VSCSILunCreate(PVSCSILUN phVScsiLun, VSCSILUNTYPE enmLunType,
 ...
 */
VPOXDDU_DECL(int) VSCSILunDestroy(VSCSILUN hVScsiLun);
 ...
 * @param   hVScsiLun               The virtual SCSI LUN handle to destroy.
 */
VPOXDDU_DECL(int) VSCSILunMountNotify(VSCSILUN hVScsiLun);
 ...
 * @param   hVScsiLun               The virtual SCSI LUN handle to destroy.
 */
VPOXDDU_DECL(int) VSCSILunUnmountNotify(VSCSILUN hVScsiLun);
 ...
 */
VPOXDDU_DECL(int) VSCSIIoReqCompleted(VSCSIIOREQ hVScsiIoReq, int rcIoReq, bool fRedoPossible);
 ...
 */
VPOXDDU_DECL(VSCSIIOREQTXDIR) VSCSIIoReqTxDirGet(VSCSIIOREQ hVScsiIoReq);
 ...
 */
VPOXDDU_DECL(int) VSCSIIoReqParamsGet(VSCSIIOREQ hVScsiIoReq, uint64_t *puOffset,
 ...
 */
VPOXDDU_DECL(int) VSCSIIoReqUnmapParamsGet(VSCSIIOREQ hVScsiIoReq, PCRTRANGE *ppaRanges,
                                           unsigned *pcRanges);

/** @}  */
RT_C_DECLS_END

#endif /* !VPOX_INCLUDED_vscsi_h */
