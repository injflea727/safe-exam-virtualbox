...
## @file
# VirtualPox Validation Kit - TestBoxScript Service Setup on Mac OS X (darwin).
#
...
MY_CONFIG_FILE=/Library/LaunchDaemons/org.virtualpox.testboxscript.plist
...
<plist version="1.0">
<dict>
  <key>Label</key>            <string>org.virtualpox.testboxscript</string>
...
os_add_user() {
    ...
    dscl . -create "/Users/${TESTBOXSCRIPT_USER}" RealName          "VPox Test User"
    dscl . -create "/Users/${TESTBOXSCRIPT_USER}" UniqueID          ${NEWUID}
    dscl . -create "/Users/${TESTBOXSCRIPT_USER}" PrimaryGroupID    80
    dscl . -create "/Users/${TESTBOXSCRIPT_USER}" NFSHomeDirectory  "/Users/vpox"
...
Additional things to do:"
    ...
    3. In the 'Sharing' panel enable (VPox/Oracle):
    ...
    5. Configure NTP to the nearest local time source. For VPox/Oracle this
       means wei01-time.de.oracle.com:
          $ systemsetup -setnetworktimeserver wei01-time.de.oracle.com
    6. Configure the vpox (pw:password) account for automatic login.
