 ...
 * @param   fAppend             Whether to append or prepend the message to the queue.
 */
int DnDManager::AddMsg(uint32_t uMsg, uint32_t cParms, VPOXHGCMSVCPARM paParms[], bool fAppend /* = true */)
{
    int rc;
 ...
 */
int DnDManager::GetNextMsg(uint32_t uMsg, uint32_t cParms, VPOXHGCMSVCPARM paParms[])
{
