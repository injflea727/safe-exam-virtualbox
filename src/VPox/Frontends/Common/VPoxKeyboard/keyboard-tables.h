...
/** @file
 * VPox/Frontends/Common - X11 keyboard driver translation tables.
 */
...
#ifndef ___VPox_keyboard_tables_h
# define ___VPox_keyboard_tables_h
...
#endif /* !___VPox_keyboard_tables_h */
