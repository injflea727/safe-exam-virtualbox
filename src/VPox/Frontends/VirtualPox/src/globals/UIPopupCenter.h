/* $Id: UIPopupCenter.h $ */
/** @file
 * VPox Qt GUI - UIPopupCenter class declaration.
 */
...
public:
    ...
    void cannotAttachUSBDevice(QWidget *pParent, const CVirtualPoxErrorInfo &comErrorInfo,
    ...
    void cannotDetachUSBDevice(QWidget *pParent, const CVirtualPoxErrorInfo &comErrorInfo,
                               const QString &strDevice, const QString &strMachineName);
    ...
    void cannotOpenMedium(QWidget *pParent, const CVirtualPox &comVPox, UIMediumDeviceType enmType, const QString &strLocation);
