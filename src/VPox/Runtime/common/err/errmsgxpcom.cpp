...
#define MY_ERR(_def, _desc, _val) { _desc, _def, _val }
    ...
    MY_ERR("E_ACCESSDENIED",                        "Access denied",                                UINT32_C(0x80070005)), /* VirtualPox addition */
...
#if defined(VPOX) && !defined(IN_GUEST) && !defined(DOXYGEN_RUNNING)
# include "errmsgvpoxcomdata.h"
#endif
