...
#ifndef VPOX_INCLUDED_SRC_SharedFolders_vbsf_h
#define VPOX_INCLUDED_SRC_SharedFolders_vbsf_h
...
int vbsfReadPages(SHFLCLIENTDATA *pClient, SHFLROOT idRoot, SHFLHANDLE hFile, uint64_t offFile,
                  uint32_t *pcbBuffer, PVPOXHGCMSVCPARMPAGES pPages);
...
#endif /* !VPOX_INCLUDED_SRC_SharedFolders_vbsf_h */
