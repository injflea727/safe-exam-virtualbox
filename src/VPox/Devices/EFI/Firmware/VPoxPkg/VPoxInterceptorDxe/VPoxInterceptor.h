/* $Id: VPoxInterceptor.h $ */
/** @file
 * VPoxInterceptor.h - Helpful macrodefinitions used in the interceptor.
 */
...
#ifndef __VPOXINTERCEPTOR_H__
#define __VPOXINTERCEPTOR_H__
#include <Uefi.h>
...
#define VPOXINTERCEPTOR VPoxInterceptor
...
static void EFIAPI CONCAT(VPOXINTERCEPTOR,func_name)(PARAMETER(nparams)params)  \
{                                                                               \
...
static return_type EFIAPI CONCAT(VPOXINTERCEPTOR,func_name)(PARAMETER(nparams)params)  \
{                                                                               \
    return_type r;                                                              \
    UINT32 off = (UINT32)(uintptr_t)&(((typeof(gThis))0)->CONCAT(SERVICE,Orig).func_name); \
    DEBUG((DEBUG_INFO, "%a%a[%x] enter " PRNT_PARAMETERS(nparams)params "\n",   \
...
} VPOXINTERCEPTOR, *PVPOXINTERCEPTOR;

PVPOXINTERCEPTOR gThis;
