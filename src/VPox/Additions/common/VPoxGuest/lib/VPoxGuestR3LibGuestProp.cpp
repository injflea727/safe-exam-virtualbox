/* $Id: VPoxGuestR3LibGuestProp.cpp $ */
/** @file
 * VPoxGuestR3Lib - Ring-3 Support Library for VirtualPox guest additions, guest properties.
 */
...
#if defined(VPOX_VBGLR3_XFREE86) || defined(VPOX_VBGLR3_XORG)
 ...
 * properties.
 *
 * @remarks typedef in VPoxGuestLib.h.
 */
...
{
    int rc = VbglR3HGCMConnect("VPoxGuestPropSvc", pidClient);
 ...
 *
 * @returns VPox status code. Stops on first failure.
