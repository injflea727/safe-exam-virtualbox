...
/** @file
 * VPox Qt GUI - UIStatusBarEditorWindow class implementation.
 */
...
/* static */
const QString UIStatusBarEditorButton::MimeType = QString("application/virtualpox;value=IndicatorType");
