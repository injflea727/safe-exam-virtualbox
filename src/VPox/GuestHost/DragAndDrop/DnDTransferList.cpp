 ...
 *
 * @returns VPox status code. VERR_NOT_SUPPORTED if the path is not supported.
 ...
 *
 * @returns VPox status code. Will return VERR_INVALID_PARAMETER if a common root path could not be found.
