...
#ifndef VPOX_INCLUDED_log_h
#define VPOX_INCLUDED_log_h
...
/** @defgroup grp_rt_vpox_log    VPox Logging
 * @ingroup grp_rt_vpox
 * @{
 */
 ...
 */
typedef enum VPOXLOGGROUP
{
    /** The default VPox group. */
    ...
    /** VPoxHDD media driver group. */
    LOG_GROUP_DRV_VPOXHDD,
    /** VPox HDD container media driver group. */
    LOG_GROUP_DRV_VD,
    ...
    /** Main group, IVPoxSVC. */
    LOG_GROUP_MAIN_VPOXSVC,
    /** Main group, IVetoEvent. */
    LOG_GROUP_MAIN_VETOEVENT,
    /** Main group, IVFSExplorer. */
    LOG_GROUP_MAIN_VFSEXPLORER,
    /** Main group, IVirtualPox. */
    LOG_GROUP_MAIN_VIRTUALPOX,
    /** Main group, IVirtualPoxClient. */
    LOG_GROUP_MAIN_VIRTUALPOXCLIENT,
    /** Main group, IVirtualPoxSDS. */
    LOG_GROUP_MAIN_VIRTUALPOXSDS,
    ...
    LOG_GROUP_VD_VMDK,
    /** VPox Guest Additions Driver (VPoxGuest). */
    LOG_GROUP_VGDRV,
    /** VM group. */
    LOG_GROUP_VM,
    /** VMM group. */
...
/** @def VPOX_LOGGROUP_NAMES
 * VirtualPox Logging group names.
 *
