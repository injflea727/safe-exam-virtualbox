/* $Id: SUPSvc-win.cpp $ */
/** @file
 * VirtualPox Support Service - Windows Specific Code.
 */
...
*********************************************************************************************************************************/
/** The service name. */
#define SUPSVC_SERVICE_NAME             "VPoxSupSvc"
/** The service display name. */
#define SUPSVC_SERVICE_DISPLAY_NAME     "VirtualPox Support Service"
...
{
    HANDLE hEventLog = RegisterEventSource(NULL /* local computer */, "VPoxSupSvc");
...
{
    RTPrintf("VPoxSupSvc: The \"interrogate\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("VPoxSupSvc: The \"stop\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("VPoxSupSvc: The \"continue\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("VPoxSupSvc: The \"pause\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("VPoxSupSvc: The \"start\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("VPoxSupSvc: The \"qdescription\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("VPoxSupSvc: The \"qconfig\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("VPoxSupSvc: The \"disable\" action is not implemented.\n");
    return 1;
}

static int supSvcWinEnable(int argc, char **argv)
{
    RTPrintf("VPoxSupSvc: The \"enable\" action is not implemented.\n");
    return 1;
}
...
static int supSvcWinShowVersion(int argc, char **argv)
{
    ...
    if (fBrief)
        ...
        RTPrintf("VirtualPox System Service Version %s\n"
...
static int supSvcWinShowHelp(void)
{
    ...
    RTPrintf("Usage:\n"
             ...
             "VPoxSupSvc\n"
             "      Runs the service.\n"
             "VPoxSupSvc <version|-v|--version> [-brief]\n"
             "      Displays the version.\n"
             "VPoxSupSvc <help|-?|-h|--help> [...]\n"
             "      Displays this help screen.\n"
             "\n"
             "VPoxSupSvc <install|/RegServer|/i>\n"
             "      Installs the service.\n"
             "VPoxSupSvc <install|delete|/UnregServer|/u>\n"
...
/**
 * VPoxSUPSvc main(), Windows edition.
 *
 *
...
int main(int argc, char **argv)
{
     ...
     */
#ifdef DEBUG_bird
    RTEnvSet("VPOX_LOG", "sup=~0");
    RTEnvSet("VPOX_LOG_DEST", "file=E:\\temp\\VPoxSupSvc.log");
    RTEnvSet("VPOX_LOG_FLAGS", "unbuffered thread msprog");
#endif
