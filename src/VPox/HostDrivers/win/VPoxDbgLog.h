...
#ifndef VPOX_INCLUDED_SRC_win_VPoxDbgLog_h
#define VPOX_INCLUDED_SRC_win_VPoxDbgLog_h
#ifndef RT_WITHOUT_PRAGMA_ONCE
# pragma once
#endif

#ifndef VPOX_DBG_LOG_NAME
# error VPOX_DBG_LOG_NAME should be defined!
#endif

/* Uncomment to show file/line info in the log */
/*#define VPOX_DBG_LOG_SHOWLINEINFO*/

#define VPOX_DBG_LOG_PREFIX_FMT VPOX_DBG_LOG_NAME"::"LOG_FN_FMT": "
#define VPOX_DBG_LOG_PREFIX_PARMS __PRETTY_FUNCTION__

#ifdef VPOX_DBG_LOG_SHOWLINEINFO
# define VPOX_DBG_LOG_SUFFIX_FMT " (%s:%d)\n"
# define VPOX_DBG_LOG_SUFFIX_PARMS ,__FILE__, __LINE__
#else
# define VPOX_DBG_LOG_SUFFIX_FMT "\n"
# define VPOX_DBG_LOG_SUFFIX_PARMS
#endif
...
#define _LOGMSG(_logger, _a)                                                \
    do                                                                      \
    {                                                                       \
        _logger((VPOX_DBG_LOG_PREFIX_FMT, VPOX_DBG_LOG_PREFIX_PARMS));  \
        _logger(_a);                                                        \
        _logger((VPOX_DBG_LOG_SUFFIX_FMT  VPOX_DBG_LOG_SUFFIX_PARMS));  \
    } while (0)
...
#define WARN_NOBP(_a)                                                          \
    do                                                                            \
    {                                                                             \
        Log((VPOX_DBG_LOG_PREFIX_FMT"WARNING! ", VPOX_DBG_LOG_PREFIX_PARMS)); \
        Log(_a);                                                                  \
        Log((VPOX_DBG_LOG_SUFFIX_FMT VPOX_DBG_LOG_SUFFIX_PARMS));             \
    } while (0)
...
#endif /* !VPOX_INCLUDED_SRC_win_VPoxDbgLog_h */
