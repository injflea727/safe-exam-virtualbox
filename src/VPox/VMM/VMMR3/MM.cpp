...
00000000a051e000-00000000a0522000 00002aaab36f5000 LOCKED  autofree         VPoxDD2RC.rc
00000000a051d000-00000000a051e000                  DYNAMIC                  fence
00000000a04eb000-00000000a051d000 00002aaab36c3000 LOCKED  autofree         VPoxDDRC.rc
 ...
 * and exposed thru STAM when VPOX_WITH_STATISTICS is defined.
 *
 *
 ...
 * VPOX_WITH_STATISTICS is defined.
 *
 *
 ...
 * GMM.
 *
 * The locking of memory is something doing in cooperation with the VirtualPox
 * support driver, SUPDrv (aka. VPoxDrv), thru the support library API,
 * SUPR3 (aka. SUPLib).
 *
 *
 ...
 *
 * @returns VPox status code - see GMMR0UpdateReservation.
 * @param   pVM             The cross context VM structure.
 */
 ...
 *
 * @returns VPox status code. Will set VM error on failure.
 * @param   pVM             The cross context VM structure.
