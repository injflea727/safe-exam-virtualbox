/** @file
 * VPox Remote Desktop Extension (VRDE) - Image updates interface.
 */
...
#ifndef VPOX_INCLUDED_RemoteDesktop_VRDEImage_h
#define VPOX_INCLUDED_RemoteDesktop_VRDEImage_h
...
#endif /* !VPOX_INCLUDED_RemoteDesktop_VRDEImage_h */
