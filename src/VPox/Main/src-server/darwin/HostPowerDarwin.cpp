...
/** @file
 * VirtualPox interface to host's power notification service, darwin specifics.
 */
...
HostPowerServiceDarwin::HostPowerServiceDarwin(VirtualPox *aVirtualPox)
  : HostPowerService(aVirtualPox)
  , mThread(NULL)
