...
<!--
    ...
    constants-python.xsl:
        XSLT stylesheet that generates VirtualPox_constants.py from
        VirtualPox.xidl.
...
"""
VirtualPox COM/XPCOM constants.
...
class VirtualPoxReflectionInfo:
    """
    ...
    # iprt/err.h + VPox/err.h constants:
    __dVPoxStatuses = {</xsl:text>
