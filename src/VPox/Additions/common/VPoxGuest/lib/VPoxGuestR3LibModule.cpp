/* $Id: VPoxGuestR3LibModule.cpp $ */
/** @file
 * VPoxGuestR3Lib - Ring-3 Support Library for VirtualPox guest additions, Shared modules.
 */
...
#ifdef RT_OS_WINDOWS
# if ARCH_BITS == 32
    pReq->enmGuestOS    = VPOXOSFAMILY_Windows32;
# else
    pReq->enmGuestOS    = VPOXOSFAMILY_Windows64;
# endif
#else
    /** @todo */
    pReq->enmGuestOS    = VPOXOSFAMILY_Unknown;
#endif
