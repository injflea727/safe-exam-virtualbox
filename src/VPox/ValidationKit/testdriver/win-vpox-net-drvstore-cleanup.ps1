# $Id: win-vpox-net-drvstore-cleanup.ps1 $
## @file
...
$result = AskForConfirmation "Clean up the driver store" `
        "Do you want to delete all VirtualPox drivers from the driver store?" `
        "Deletes all VirtualPox drivers from the driver store." `
