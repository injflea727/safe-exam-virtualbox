...
#ifndef VPOX_INCLUDED_vmm_dbgfcorefmt_h
#define VPOX_INCLUDED_vmm_dbgfcorefmt_h
...
typedef struct DBGFCOREDESCRIPTOR
{
    ...
    uint32_t                cbSelf;
    /** VirtualPox version. */
    uint32_t                u32VPoxVersion;
    /** VirtualPox revision. */
    uint32_t                u32VPoxRevision;
    /** Number of CPUs. */
    uint32_t                cCpus;
} DBGFCOREDESCRIPTOR;
...
#endif /* !VPOX_INCLUDED_vmm_dbgfcorefmt_h */
