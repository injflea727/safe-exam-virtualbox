/* $Id: VPoxAutostart-win.cpp $ */
/** @file
 * VirtualPox Autostart Service - Windows Specific Code.
 */
...
*********************************************************************************************************************************/
/** The service name. */
#define AUTOSTART_SERVICE_NAME             "VPoxAutostartSvc"
/** The service display name. */
#define AUTOSTART_SERVICE_DISPLAY_NAME     "VirtualPox Autostart Service"

ComPtr<IVirtualPoxClient> g_pVirtualPoxClient = NULL;
...
{
    HANDLE hEventLog = RegisterEventSourceA(NULL /* local computer */, "VPoxAutostartSvc");
    AssertReturnVoid(hEventLog != NULL);
    WORD wType = 0;
    const char *apsz[2];
    apsz[0] = "VPoxAutostartSvc";
    apsz[1] = pszMsg;
...
{
    RT_NOREF(argc, argv);
    RTPrintf("VPoxAutostartSvc: The \"interrogate\" action is not implemented.\n");
...
{
    RT_NOREF(argc, argv);
    RTPrintf("VPoxAutostartSvc: The \"stop\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
{
    RT_NOREF(argc, argv);
    RTPrintf("VPoxAutostartSvc: The \"continue\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
{
    RT_NOREF(argc, argv);
    RTPrintf("VPoxAutostartSvc: The \"pause\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
{
    RT_NOREF(argc, argv);
    RTPrintf("VPoxAutostartSvc: The \"start\" action is not implemented.\n");
...
{
    RT_NOREF(argc, argv);
    RTPrintf("VPoxAutostartSvc: The \"qdescription\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
{
    RT_NOREF(argc, argv);
    RTPrintf("VPoxAutostartSvc: The \"qconfig\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
{
    RT_NOREF(argc, argv);
    RTPrintf("VPoxAutostartSvc: The \"disable\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
{
    RT_NOREF(argc, argv);
    RTPrintf("VPoxAutostartSvc: The \"enable\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
static RTEXITCODE autostartStartVMs()
{
    ...
    const char *pszConfigFile = RTEnvGet("VPOXAUTOSTART_CONFIG");
    if (!pszConfigFile)
        return autostartSvcLogError("Starting VMs failed. VPOXAUTOSTART_CONFIG environment variable is not defined.\n");
    bool fAllow = false;
...
static RTEXITCODE autostartSvcWinShowVersion(int argc, char **argv)
{
    ...
    if (fBrief)
        ...
        RTPrintf("VirtualPox Autostart Service Version %s\n"
...
static RTEXITCODE autostartSvcWinShowHelp(void)
{
    ...
    RTPrintf("Usage:\n"
             ...
             "VPoxAutostartSvc\n"
             "      Runs the service.\n"
             "VPoxAutostartSvc <version|-v|--version> [-brief]\n"
             "      Displays the version.\n"
             "VPoxAutostartSvc <help|-?|-h|--help> [...]\n"
             "      Displays this help screen.\n"
             "\n"
             "VPoxAutostartSvc <install|/RegServer|/i>\n"
             "      Installs the service.\n"
             "VPoxAutostartSvc <uninstall|delete|/UnregServer|/u>\n"
...
/**
 * VPoxAutostart main(), Windows edition.
 *
 *
