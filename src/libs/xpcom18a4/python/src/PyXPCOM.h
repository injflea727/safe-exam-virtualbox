...
# ifdef _XOPEN_SOURCE
#  define VPOX_XOPEN_SOURCE_DEFINED _XOPEN_SOURCE
#  undef _XOPEN_SOURCE
# endif
...
# if !defined(_XOPEN_SOURCE) && defined(VPOX_XOPEN_SOURCE_DEFINED)
#  define _XOPEN_SOURCE VPOX_XOPEN_SOURCE_DEFINED
# endif
# undef VPOX_XOPEN_SOURCE_DEFINED
