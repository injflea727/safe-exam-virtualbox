...
#ifndef DEBUGGER_INCLUDED_SRC_VPoxDbgBase_h
#define DEBUGGER_INCLUDED_SRC_VPoxDbgBase_h
...
public:
     ...
     */
    VPoxDbgBase(VPoxDbgGui *a_pDbgGui);
...
/**
 * VPox Debugger GUI Base Window Class.
 *
 * This is just a combination of QWidget and VPoxDbgBase with some additional
 * functionality for window management. This class is not intended for control
 * widgets, only normal top-level windows.
 */
class VPoxDbgBaseWindow : public QWidget, public VPoxDbgBase
{
public:
    /**
     * Construct the object.
     ...
     */
    VPoxDbgBaseWindow(VPoxDbgGui *a_pDbgGui, QWidget *a_pParent, const char *a_pszTitle);

    /**
     * Destructor.
     */
    virtual ~VPoxDbgBaseWindow();
...
#endif /* !DEBUGGER_INCLUDED_SRC_VPoxDbgBase_h */
