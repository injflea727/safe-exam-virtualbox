 ...
 */
int initTable(VPOXHGCMSVCFNTABLE *pTable, VPOXHGCMSVCHELPERS *pHelpers)
{
 ...
 */
static int testHostCmd(const VPOXHGCMSVCFNTABLE *pTable, const PCMDHOST pCmd, uint32_t uNumTests)
{
    int rc = VINF_SUCCESS;
...
static int testHost(const VPOXHGCMSVCFNTABLE *pTable)
{
...
static int testClient(const VPOXHGCMSVCFNTABLE *pTable)
{
...
int main()
{
    ...
    do
    {
        RTTESTI_CHECK_RC_BREAK(VPoxHGCMSvcLoad(&svcTable), VINF_SUCCESS);
