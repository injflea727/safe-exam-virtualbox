...
/** @file
 * VPox Qt GUI - UIToolPaneMachine class declaration.
 */
...
signals:
    ...
    /** Redirects signal from UIVirtualPoxManager to UIDetails. */
    void sigToggleStarted();
    /** Redirects signal from UIVirtualPoxManager to UIDetails. */
    void sigToggleFinished();
    /** Redirects signal from UIDetails to UIVirtualPoxManager. */
