...
#ifndef VPOX_INCLUDED_SRC_Dhcpd_Config_h
#define VPOX_INCLUDED_SRC_Dhcpd_Config_h
...
class Config
{
    ...
    RTCString       m_strHome;          /**< path of ~/.VirtualPox or equivalent, */
...
#endif /* !VPOX_INCLUDED_SRC_Dhcpd_Config_h */
