...
"""
VirtualPox Validation Kit - Serial port testing #1.
"""
...
class tdSerial1(vpox.TestDriver):
    """
    VPox serial port testing #1.
    """
    ...
    def actionConfig(self):
        ...
        return self.oTestVmSet.actionConfig(self, sDvdImage = self.sVPoxValidationKitIso);
    ...
    def setupSerialMode(self, oSession, oTestVm, sMode):
        ...
        if sMode == 'RawFile':
            ...
            sLocation = self._generateRawPortFilename(self, oTestVm, '-com1-', '.out');
            ePortMode = vpoxcon.PortMode_HostPipe;
            ...
            ePortMode = vpoxcon.PortMode_HostDevice;
        else:
    ...
    def testOneVmConfig(self, oVM, oTestVm):
        ...
        for sUart in self.asUarts:
            ...
            if oSession is not None:
                ...
                fRc = fRc and oSession.setExtraData("VPoxInternal/Devices/serial/0/Config/UartType", "string:" + sUart);
