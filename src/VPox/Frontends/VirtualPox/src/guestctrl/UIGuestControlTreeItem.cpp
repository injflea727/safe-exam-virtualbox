...
/** @file
 * VPox Qt GUI - UIGuestSessionTreeItem class implementation.
 */
...
void UIGuestControlTreeItem::prepareListener(CEventSource comEventSource, QVector<KVPoxEventType>& eventTypes)
{
...
void UIGuestSessionTreeItem::prepareListener()
{
    ...
    eventTypes << KVPoxEventType_OnGuestSessionStateChanged
               << KVPoxEventType_OnGuestProcessRegistered;
...
void UIGuestSessionTreeItem::sltGuestSessionUpdated(const CGuestSessionStateChangedEvent& cEvent)
{
    ...
    {
        CVirtualPoxErrorInfo cErrorInfo = cEvent.GetError();
...
{
    QVector<KVPoxEventType> eventTypes;
    eventTypes  << KVPoxEventType_OnGuestProcessStateChanged
                << KVPoxEventType_OnGuestProcessInputNotify
                << KVPoxEventType_OnGuestProcessOutput;
